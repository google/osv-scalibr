...
func TestEnrich(t *testing.T) {
	...
	var (
		goVuln1 = osvpb.Vulnerability{
			...
			Severity:      []*osvpb.Severity{{Type: osvpb.Severity_CVSS_V3, Score: "CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:L/A:N"}},
			References: []*osvpb.Reference{
				{Type: osvpb.Reference_ADVISORY, Url: "https://nvd.nist.gov/vuln/detail/CVE-2023-29401"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/gin-gonic/gin/issues/3555"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/gin-gonic/gin/pull/3556"},
				{Type: osvpb.Reference_PACKAGE, Url: "https://github.com/gin-gonic/gin"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/gin-gonic/gin/releases/tag/v1.9.1"},
				{Type: osvpb.Reference_WEB, Url: "https://pkg.go.dev/vuln/GO-2023-1737"},
			},
			...
			Affected: []*osvpb.Affected{
				{
					...
					Ranges: []*osvpb.Range{
						{Type: osvpb.Range_SEMVER, Events: []*osvpb.Event{{Introduced: "1.3.1-0.20190301021747-ccb9e902956d"}, {Fixed: "1.9.1"}}},
					},
					DatabaseSpecific: &structpb.Struct{
						Fields: map[string]*structpb.Value{
		...
		goVuln2 = osvpb.Vulnerability{
			...
			Severity:      []*osvpb.Severity{{Type: osvpb.Severity_CVSS_V3, Score: "CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:L/A:L"}},
			...
			Affected: []*osvpb.Affected{
				{
					...
					Ranges: []*osvpb.Range{
						{Type: osvpb.Range_SEMVER, Events: []*osvpb.Event{{Introduced: "0"}, {Fixed: "1.9.0"}}},
					},
					DatabaseSpecific: &structpb.Struct{
						Fields: map[string]*structpb.Value{
			...
			References: []*osvpb.Reference{
				{Type: osvpb.Reference_ADVISORY, Url: "https://nvd.nist.gov/vuln/detail/CVE-2023-26125"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/gin-gonic/gin/pull/3500"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/gin-gonic/gin/pull/3503"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/t0rchwo0d/gin/commit/fd9f98e70fb4107ee68c783482d231d35e60507b"},
				{Type: osvpb.Reference_PACKAGE, Url: "https://github.com/gin-gonic/gin"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/gin-gonic/gin/releases/tag/v1.9.0"},
				{Type: osvpb.Reference_WEB, Url: "https://security.snyk.io/vuln/SNYK-GOLANG-GITHUBCOMGINGONICGIN-3324285"},
			},
			DatabaseSpecific: &structpb.Struct{
				Fields: map[string]*structpb.Value{
					"cwe_ids": {Kind: &structpb.Value_ListValue{ListValue: &structpb.ListValue{Values: []*structpb.Value{
		...
		goVuln3 = osvpb.Vulnerability{
			...
			Credits:   []*osvpb.Credit{{Name: "motoyasu-saburi"}},
			References: []*osvpb.Reference{
				{Type: osvpb.Reference_REPORT, Url: "https://github.com/gin-gonic/gin/issues/3555"},
				{Type: osvpb.Reference_FIX, Url: "https://github.com/gin-gonic/gin/pull/3556"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/gin-gonic/gin/releases/tag/v1.9.1"},
			},
		}

		jsVuln1 = osvpb.Vulnerability{
			SchemaVersion: "1.7.0",
			...
			Severity: []*osvpb.Severity{
				{Type: osvpb.Severity_CVSS_V3, Score: "CVSS:3.1/AV:N/AC:H/PR:N/UI:R/S:U/C:L/I:L/A:L"},
				{Type: osvpb.Severity_CVSS_V4, Score: "CVSS:4.0/AV:N/AC:L/AT:P/PR:N/UI:P/VC:N/VI:N/VA:N/SC:L/SI:L/SA:L"},
			},
			Affected: []*osvpb.Affected{
				{
					Package: &osvpb.Package{Ecosystem: "npm", Name: "express", Purl: "pkg:npm/express"},
					Ranges: []*osvpb.Range{
						{Type: osvpb.Range_SEMVER, Events: []*osvpb.Event{{Introduced: "0"}, {Fixed: "4.20.0"}}},
					},
					DatabaseSpecific: &structpb.Struct{
						Fields: map[string]*structpb.Value{
				...
				},
				{
					Package: &osvpb.Package{Ecosystem: "npm", Name: "express", Purl: "pkg:npm/express"},
					Ranges: []*osvpb.Range{
						{Type: osvpb.Range_SEMVER, Events: []*osvpb.Event{{Introduced: "5.0.0-alpha.1"}, {Fixed: "5.0.0"}}},
					},
					DatabaseSpecific: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							"source": {Kind: &structpb.Value_StringValue{StringValue: "https://github.com/github/advisory-database/blob/main/advisories/github-reviewed/2024/09/GHSA-qw6h-vgh9-j6wx/GHSA-qw6h-vgh9-j6wx.json"}},
			...
			References: []*osvpb.Reference{
				{Type: osvpb.Reference_WEB, Url: "https://github.com/expressjs/express/security/advisories/GHSA-qw6h-vgh9-j6wx"},
				{Type: osvpb.Reference_ADVISORY, Url: "https://nvd.nist.gov/vuln/detail/CVE-2024-43796"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/expressjs/express/commit/54271f69b511fea198471e6ff3400ab805d6b553"},
				{Type: osvpb.Reference_PACKAGE, Url: "https://github.com/expressjs/express"},
			},
			DatabaseSpecific: &structpb.Struct{
				Fields: map[string]*structpb.Value{
					"cwe_ids": {Kind: &structpb.Value_ListValue{ListValue: &structpb.ListValue{Values: []*structpb.Value{
		...
		jsVuln1Local = osvpb.Vulnerability{
			SchemaVersion: "1.7.0",
			Id:            "GHSA-qw6h-vgh9-j6wx",
			Modified:      timestamppb.New(time.Date(2024, 11, 18, 16, 27, 11, 0, time.UTC)),
			Published:     timestamppb.New(time.Date(2024, 9, 10, 19, 41, 4, 0, time.UTC)),
		...
		jsVuln2 = osvpb.Vulnerability{
			...
			Severity:      []*osvpb.Severity{{Type: osvpb.Severity_CVSS_V3, Score: "CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N"}},
			Affected: []*osvpb.Affected{
				{
					Package: &osvpb.Package{Ecosystem: "npm", Name: "express", Purl: "pkg:npm/express"},
					Ranges:  []*osvpb.Range{{Type: osvpb.Range_SEMVER, Events: []*osvpb.Event{{Introduced: "0"}, {Fixed: "4.19.2"}}}},
					DatabaseSpecific: &structpb.Struct{
						Fields: map[string]*structpb.Value{
				...
				{
					Package: &osvpb.Package{Ecosystem: "npm", Name: "express", Purl: "pkg:npm/express"},
					Ranges:  []*osvpb.Range{{Type: osvpb.Range_SEMVER, Events: []*osvpb.Event{{Introduced: "5.0.0-alpha.1"}, {Fixed: "5.0.0-beta.3"}}}},
					DatabaseSpecific: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							"source": {Kind: &structpb.Value_StringValue{StringValue: "https://github.com/github/advisory-database/blob/main/advisories/github-reviewed/2024/03/GHSA-rv95-896h-c2vc/GHSA-rv95-896h-c2vc.json"}},
						},
			...
			References: []*osvpb.Reference{
				{Type: osvpb.Reference_WEB, Url: "https://github.com/expressjs/express/security/advisories/GHSA-rv95-896h-c2vc"},
				{Type: osvpb.Reference_ADVISORY, Url: "https://nvd.nist.gov/vuln/detail/CVE-2024-29041"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/koajs/koa/issues/1800"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/expressjs/express/pull/5539"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/expressjs/express/commit/0867302ddbde0e9463d0564fea5861feb708c2dd"},
				{Type: osvpb.Reference_WEB, Url: "https://github.com/expressjs/express/commit/0b746953c4bd8e377123527db11f9cd866e39f94"},
				{Type: osvpb.Reference_WEB, Url: "https://expressjs.com/en/4x/api.html#res.location"},
				{Type: osvpb.Reference_PACKAGE, Url: "https://github.com/expressjs/express"},
			},
			DatabaseSpecific: &structpb.Struct{
				Fields: map[string]*structpb.Value{
		...
		fzfVulnLocal = osvpb.Vulnerability{
			Id: "mockID",
			Affected: inventory.PackageToAffected(fzfPkg, "3002.1", &osvpb.Severity{
				Type:  osvpb.Severity_CVSS_V3,
				Score: "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H",
			}),
		}

		pyPkgSameVulnAsFzf = osvpb.Vulnerability{
			Id: "mockID",
			Affected: inventory.PackageToAffected(pyPkg, "3.002.1", &osvpb.Severity{
				Type:  osvpb.Severity_CVSS_V3,
				Score: "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H",
			}),
		}
