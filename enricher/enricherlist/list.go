...
var (
	...
	SecretsValidate = initMapFromVelesPlugins([]velesPlugin{
		...
		fromVeles(mongodbatlasaccesstoken.NewAccessTokenValidator(), "secrets/mongodbatlasaccesstokenvalidate", 0),
		fromVeles(mongodbatlasrefreshtoken.NewRefreshTokenValidator(), "secrets/mongodbatlasrefreshtokenvalidate", 0),
