...
const validatorTestKey = "oy2kf3hbijh34oizqgexq6xesob4yypfpflvxq4dli2s3e"
...
// mockNuGetServer creates a mock NuGet.org API server for testing
...
func TestValidator(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			key := nugetorgapikey.NuGetOrgAPIKey{Key: tc.key}
...
func TestValidator_ContextCancellation(t *testing.T) {
	...
	key := nugetorgapikey.NuGetOrgAPIKey{Key: validatorTestKey}
