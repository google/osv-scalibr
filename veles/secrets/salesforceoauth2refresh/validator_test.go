...
const (
	validatorTestClientID       = "3MVG123456789.AB_CDEF.ABC123456789ABC123456789ABC1"
	validatorTestClientSecret   = "123456789ABCDEFABC1234567895123456789ABCDEFABC1234567895"
...
func TestValidator(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			cred := salesforceoauth2refresh.Credentials{
				ID:      tt.id,
				Secret:  tt.secret,
				Refresh: tt.refresh,
			}
