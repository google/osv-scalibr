...
func NewAppS2STokenValidator(opts ...ValidatorOption) *Validator {
	v := &Validator{
...
func (v *Validator) Validate(ctx context.Context, key AppServerToServerToken) (veles.ValidationStatus, error) {
