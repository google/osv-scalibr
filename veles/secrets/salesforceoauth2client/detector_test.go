...
func TestDetector_Detect(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:  "invalid URL format - wrong domain",
			input: "123456789012.my.example.com",
			want:  nil,
		},
		{
		...
		// --- Only client ID or Secret or URL ---
		{
			name:  "client ID but no client secret and URL",
...
`,
			want: []veles.Secret{
				salesforceoauth2client.Credentials{
					...
					URL:    "yuvrajapp.my.salesforce.com",
				},
			},
		},
		{
