...
`, resolve.NPM)
	...
	groups := map[manifest.RequirementKey][]string{
		npm.RequirementKey{PackageKey: resolve.PackageKey{System: resolve.NPM, Name: "c"}, KnownAs: ""}: {"dev"},
		npm.RequirementKey{PackageKey: resolve.PackageKey{System: resolve.NPM, Name: "d"}, KnownAs: ""}: {"dev"},
	}
