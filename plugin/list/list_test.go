...
func TestFromNames(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			wantNames: []string{"python/pdmlock", "python/pipfile", "python/pipfilelock", "python/poetrylock", "python/pylock", "python/condameta", "python/ipythoninstall", "python/uvlock", "python/wheelegg", "python/pyprojecttoml", "python/requirements", "python/setup", "windows/dismpatch", "cis/generic-linux/etcpasswdpermissions", "baseimage"},
		},
		{
			desc:      "Remove_duplicates",
			names:     []string{"python", "python"},
			wantNames: []string{"python/pdmlock", "python/pipfile", "python/pipfilelock", "python/poetrylock", "python/pylock", "python/condameta", "python/ipythoninstall", "python/uvlock", "python/wheelegg", "python/pyprojecttoml", "python/requirements", "python/setup"},
		},
		{
