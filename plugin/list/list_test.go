...
func TestFromNames(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			wantNames: []string{"python/pdmlock", "python/pipfilelock", "python/poetrylock", "python/pylock", "python/condameta", "python/uvlock", "python/wheelegg", "python/requirements", "python/setup", "python/pep723", "windows/dismpatch", "cis/generic-linux/etcpasswdpermissions", "baseimage"},
		},
		{
			desc:      "Remove_duplicates",
			names:     []string{"python", "python"},
			wantNames: []string{"python/pdmlock", "python/pipfilelock", "python/poetrylock", "python/pylock", "python/condameta", "python/uvlock", "python/wheelegg", "python/requirements", "python/setup", "python/pep723"},
		},
		{
