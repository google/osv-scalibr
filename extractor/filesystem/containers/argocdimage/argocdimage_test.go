...
func TestExtract(t *testing.T) {
	tests := []struct {
		...
		{
			name: "comprehensive_application_with_multi_source_and_kustomize",
			...
			wantPackages: []*extractor.Package{
				...
				{
					Name:     "https://github.com/my-org/my-repo.git/overlays/production",
					Version:  "main",
					Location: extractor.LocationFromPath("testdata/comprehensive-application.yaml"),
					PURLType: purl.TypeOCI,
				},
				...
				{
					Name:     "newregistry.io/newapp",
					Version:  "v1.5.0",
					Location: extractor.LocationFromPath("testdata/comprehensive-application.yaml"),
					PURLType: purl.TypeOCI,
				},
				{
					Name:     "myregistry.io/sidecar",
