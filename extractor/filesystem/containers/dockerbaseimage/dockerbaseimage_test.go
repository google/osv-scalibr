			...
			wantPackages: []*extractor.Package{
				{
					Name:     "nginx",
					Version:  "1.27.4",
					Location: extractor.LocationFromPath("testdata/dockerfile.single-stage"),
			...
			wantPackages: []*extractor.Package{
				{
					Name:     "nginx",
					Version:  "1.27.4",
					Location: extractor.LocationFromPath("testdata/dockerfile.multi-stage"),
					PURLType: purl.TypeDocker,
				},
				{
					Name:     "ubuntu",
			...
			wantPackages: []*extractor.Package{
				{
					Name:     "nginx",
					Version:  "1.27.4",
					Location: extractor.LocationFromPath("testdata/dockerfile.parameterized"),
					PURLType: purl.TypeDocker,
				},
				{
					Name:     "ubuntu",
			...
			wantPackages: []*extractor.Package{
				{
					Name:     "nginx",
					Version:  "latest",
					Location: extractor.LocationFromPath("testdata/dockerfile.no-version"),
					PURLType: purl.TypeDocker,
				},
			},
		},
			...
			wantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPath("testdata/dockerfile.hash"),
					PURLType: purl.TypeDocker,
				},
			},
		},
