...
func TestExtract(t *testing.T) {
	tests := []struct {
		...
		{
			name: "comprehensive_workflow_with_sidecars_and_init_containers",
		...
		{
			name: "cronworkflow_with_nested_templates",
			path: "testdata/cronworkflow.yaml",
			wantPackages: []*extractor.Package{
				{
					Name:     "busybox",
					Version:  "1.36",
					Location: extractor.LocationFromPath("testdata/cronworkflow.yaml"),
					PURLType: purl.TypeOCI,
				},
				{
					Name:     "python",
