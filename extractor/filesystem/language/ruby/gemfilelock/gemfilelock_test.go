			...
			WantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPath("testdata/one-gem.lock"),
				},
			},
		},
		{
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "2.4.2",
					PURLType: purl.TypeGem,
					Location: extractor.LocationFromPath("testdata/source-section-at-end.lock"),
				},
			},
		},
		{
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "1.1.3",
					PURLType: purl.TypeGem,
					Location: extractor.LocationFromPath("testdata/some-gems.lock"),
				},
				{
					Name:     "method_source",
					Version:  "1.0.0",
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "0.9.0.1",
					PURLType: purl.TypeGem,
					Location: extractor.LocationFromPath("testdata/multiple-gems.lock"),
				},
				{
					Name:     "coderay",
					Version:  "1.1.3",
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "7.0.2.2",
					PURLType: purl.TypeGem,
					Location: extractor.LocationFromPath("testdata/rails.lock"),
				},
				{
					Name:     "actionmailbox",
					Version:  "7.0.2.2",
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "2.4.2",
					PURLType: purl.TypeGem,
					Location: extractor.LocationFromPath("testdata/rubocop.lock"),
				},
				{
					Name:     "parallel",
					Version:  "1.21.0",
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "1.2.0.0",
					PURLType: purl.TypeGem,
					Location: extractor.LocationFromPath("testdata/has-local-gem.lock"),
				},
				{
					Name:     "actionpack",
					Version:  "7.0.2.2",
			...
			WantPackages: []*extractor.Package{
				{
					...
					PURLType: purl.TypeGem,
					Location: extractor.LocationFromPath("testdata/has-git-gem.lock"),
