...
func TestExtract(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantInventory: createInventoriesWithMain(append(BinaryWithModuleReplacementPackages, Toolchain), "testdata/binary_with_module_replacement-darwin-amd64"),
		},
		{
			name:          "binary_with_module_replacement-darwin-arm64",
			path:          "testdata/binary_with_module_replacement-darwin-arm64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModuleReplacementPackages, Toolchain), "testdata/binary_with_module_replacement-darwin-arm64"),
		},
		{
			name:          "binary_with_module_replacement-linux-386",
			path:          "testdata/binary_with_module_replacement-linux-386",
			wantInventory: createInventoriesWithMain(append(BinaryWithModuleReplacementPackages, Toolchain), "testdata/binary_with_module_replacement-linux-386"),
		},
		{
			name:          "binary_with_module_replacement-linux-amd64",
			path:          "testdata/binary_with_module_replacement-linux-amd64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModuleReplacementPackages, Toolchain), "testdata/binary_with_module_replacement-linux-amd64"),
		},
		{
			name:          "binary_with_module_replacement-linux-arm64",
			path:          "testdata/binary_with_module_replacement-linux-arm64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModuleReplacementPackages, Toolchain), "testdata/binary_with_module_replacement-linux-arm64"),
		},
		{
			name:          "binary_with_module_replacement-windows-386",
			path:          "testdata/binary_with_module_replacement-windows-386",
			wantInventory: createInventoriesWithMain(append(BinaryWithModuleReplacementPackages, Toolchain), "testdata/binary_with_module_replacement-windows-386"),
		},
		{
			name:          "binary_with_module_replacement-windows-amd64",
			path:          "testdata/binary_with_module_replacement-windows-amd64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModuleReplacementPackages, Toolchain), "testdata/binary_with_module_replacement-windows-amd64"),
		},
		{
			name:          "binary_with_module_replacement-windows-arm64",
			path:          "testdata/binary_with_module_replacement-windows-arm64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModuleReplacementPackages, Toolchain), "testdata/binary_with_module_replacement-windows-arm64"),
		},
		{
			name:          "binary_with_modules-darwin-amd64",
			path:          "testdata/binary_with_modules-darwin-amd64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModulesPackages, Toolchain), "testdata/binary_with_modules-darwin-amd64"),
		},
		{
			name:          "binary_with_modules-darwin-arm64",
			path:          "testdata/binary_with_modules-darwin-arm64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModulesPackages, Toolchain), "testdata/binary_with_modules-darwin-arm64"),
		},
		{
			name:          "binary_with_modules-linux-386",
			path:          "testdata/binary_with_modules-linux-386",
			wantInventory: createInventoriesWithMain(append(BinaryWithModulesPackages, Toolchain), "testdata/binary_with_modules-linux-386"),
		},
		{
			name:          "binary_with_modules-linux-amd64",
			path:          "testdata/binary_with_modules-linux-amd64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModulesPackages, Toolchain), "testdata/binary_with_modules-linux-amd64"),
		},
		{
			name:          "binary_with_modules-linux-arm64",
			path:          "testdata/binary_with_modules-linux-arm64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModulesPackages, Toolchain), "testdata/binary_with_modules-linux-arm64"),
		},
		{
			name:          "binary_with_modules-windows-386",
			path:          "testdata/binary_with_modules-windows-386",
			wantInventory: createInventoriesWithMain(append(BinaryWithModulesPackagesWindows, Toolchain), "testdata/binary_with_modules-windows-386"),
		},
		{
			name:          "binary_with_modules-windows-amd64",
			path:          "testdata/binary_with_modules-windows-amd64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModulesPackagesWindows, Toolchain), "testdata/binary_with_modules-windows-amd64"),
		},
		{
			name:          "binary_with_modules-windows-arm64",
			path:          "testdata/binary_with_modules-windows-arm64",
			wantInventory: createInventoriesWithMain(append(BinaryWithModulesPackagesWindows, Toolchain), "testdata/binary_with_modules-windows-arm64"),
		},
		{
			name:          "nginx-ingress-controller with version from content off",
			path:          "testdata/nginx-ingress-controller",
			wantInventory: createInventories(append(BinaryWithModulesPackagesNginx, goPackage("k8s.io/ingress-nginx", "(devel)")), "testdata/nginx-ingress-controller"),
		},
		{
			...
			wantInventory: createInventories(append(BinaryWithModulesPackagesNginx, goPackage("k8s.io/ingress-nginx", "1.11.4")), "testdata/nginx-ingress-controller"),
		},
		{
...
var (
	...
	BinaryWithModulesPackagesNginx = []*extractor.Inventory{
...
func createInventoriesWithMain(invs []*extractor.Inventory, location string) []*extractor.Inventory {
	res := createInventories(invs, location)
	// Main package
