			...
			WantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPath("testdata/one-package.v1.revisions.json"),
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "1.2.11",
					PURLType: purl.TypeConan,
					Location: extractor.LocationFromPath("testdata/no-name.v1.revisions.json"),
					Metadata: &osv.DepGroupMetadata{
						DepGroupVals: []string{},
					},
				},
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "1.2.11",
					PURLType: purl.TypeConan,
					Location: extractor.LocationFromPath("testdata/two-packages.v1.revisions.json"),
					Metadata: &osv.DepGroupMetadata{
						DepGroupVals: []string{},
					},
				},
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "1.2.13",
					PURLType: purl.TypeConan,
					Location: extractor.LocationFromPath("testdata/nested-dependencies.v1.revisions.json"),
					Metadata: &osv.DepGroupMetadata{
						DepGroupVals: []string{},
					},
				},
			...
			WantPackages: []*extractor.Package{
				{
					...
					Version:  "1.11.1",
					PURLType: purl.TypeConan,
					Location: extractor.LocationFromPath("testdata/one-package-dev.v1.revisions.json"),
					Metadata: &osv.DepGroupMetadata{
						DepGroupVals: []string{},
					},
				},
