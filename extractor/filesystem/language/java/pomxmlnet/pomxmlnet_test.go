			...
			WantInventory: []*extractor.Inventory{
				{
					...
					Metadata:  javalockfile.Metadata{IsDirect: true, DepGroupVals: []string{}},
				},
			},
		},
		{
			...
			WantInventory: []*extractor.Inventory{
				{
					...
					Metadata:  javalockfile.Metadata{IsDirect: true, DepGroupVals: []string{"runtime"}},
				},
			},
		},
		{
			...
			WantInventory: []*extractor.Inventory{
				...
				},
				{
					...
					Version:   "1.1.1",
					Locations: []string{"testdata/maven/transitive.xml"},
					Metadata:  javalockfile.Metadata{IsDirect: false, DepGroupVals: []string{}},
				},
				{
