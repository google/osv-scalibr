...
// NewConfig returns the configuration given the URL of the Maven registry to fetch metadata. If disableGoogleAuth is true, Google Application Default Credentials will not be initialized.
