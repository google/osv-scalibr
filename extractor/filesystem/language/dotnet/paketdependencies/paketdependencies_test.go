...
func TestExtract(t *testing.T) {
	tests := []extracttest.TestTableEntry{
			...
			WantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 3),
				},
				{
					Name:     "FSharp.Core",
					Version:  "4.0.0",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 4),
				},
				{
					Name:     "Newtonsoft.Json",
					Version:  "12.0.3",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 5),
				},
				{
					Name:     "System.Text.Json",
					Version:  "8.0.5",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 8),
				},
				{
					Name:     "Microsoft.NETFramework.ReferenceAssemblies",
					Version:  "1.0.0",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 9),
				},
				{
					Name:     "Microsoft.Extensions.Logging",
					Version:  "",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 6),
				},
				{
					Name:     "FAKE",
					Version:  "",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 24),
				},
				{
					Name:     "Paket",
					Version:  "",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 25),
				},
				{
					Name:     "fsprojects/Paket",
					Version:  "",
					PURLType: purl.TypeGithub,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 11),
				...
				},
				{
					...
					Version:  "5.20.4",
					PURLType: purl.TypeGithub,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 12),
					SourceCode: &extractor.SourceCodeIdentifier{
				...
				},
				{
					...
					Version:  "",
					PURLType: purl.TypeGithub,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 15),
					SourceCode: &extractor.SourceCodeIdentifier{
				...
				},
				{
					...
					Version:  "2.13.5",
					PURLType: purl.TypeGithub,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 18),
					SourceCode: &extractor.SourceCodeIdentifier{
						Repo: "https://github.com/tpetricek/FSharp.Formatting",
					},
				},
				{
					...
					Version:  "",
					PURLType: purl.TypeGithub,
					Location: extractor.LocationFromPathAndLine("testdata/paket.dependencies", 21),
					SourceCode: &extractor.SourceCodeIdentifier{
						Repo:   "https://github.com/tpetricek/FSharp.Formatting",
		...
		{
			Name: "duplicate package declarations",
			InputConfig: extracttest.ScanInputMockConfig{
				Path: "testdata/duplicate/paket.dependencies",
			},
			WantPackages: []*extractor.Package{
				{
					Name:     "NUnit",
					Version:  "",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/duplicate/paket.dependencies", 2),
				},
				{
					Name:     "NUnit",
					Version:  "",
					PURLType: purl.TypeNuget,
					Location: extractor.LocationFromPathAndLine("testdata/duplicate/paket.dependencies", 5),
				},
			},
		},
	}
