			...
			wantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPath("testdata/new.build.zig.zon"),
				},
			},
		},
		{
			...
			wantPackages: []*extractor.Package{
				{
					...
					Version:  "0.0.1",
					PURLType: purl.TypeZig,
					Location: extractor.LocationFromPath("testdata/old.build.zig.zon"),
				},
			},
		},
		{
			...
			wantPackages: []*extractor.Package{
				{
					...
					Version:  "0.0.0",
					PURLType: purl.TypeZig,
					Location: extractor.LocationFromPath("testdata/new.build.commentedbraces.zig.zon"),
				},
			},
		},
		{
			...
			wantPackages: []*extractor.Package{
				{
					...
					Version:  "1.0.0",
					PURLType: purl.TypeZig,
					Location: extractor.LocationFromPath("testdata/one.dep.build.zig.zon"),
				},
			},
		},
		{
			...
			wantPackages: []*extractor.Package{
				{
					...
					Version:  "0.0.0",
					PURLType: purl.TypeZig,
					Location: extractor.LocationFromPath("testdata/multiple.dep.build.zig.zon"),
				},
				{
					Name:     "zbor",
					Version:  "0.18.0",
