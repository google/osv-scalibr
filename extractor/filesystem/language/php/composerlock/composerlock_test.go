...
func TestExtractor_Extract(t *testing.T) {
	tests := []extracttest.TestTableEntry{
		...
		// When there are duplicate packages, both will be extracted and resolved
		// with different line numbers.
		// Since composer.lock files define packages as a list, we should be able to disambiguate
		// packages by order.
		{
			...
			WantPackages: []*extractor.Package{
				...
				},
				{
					...
					Version:  "2.0.5",
					PURLType: purl.TypeComposer,
					Location: extractor.LocationFromPathAndLine("testdata/duplicate-packages.json", 17),
					SourceCode: &extractor.SourceCodeIdentifier{
						Commit: "4c115873c86ad5bd0ac6d962db70ca53bf8fb874",
					},
					Metadata: &osv.DepGroupMetadata{
				...
				},
				{
					...
					Version:  "3.0.0-dev",
					PURLType: purl.TypeComposer,
					Location: extractor.LocationFromPathAndLine("testdata/duplicate-packages.json", 26),
					SourceCode: &extractor.SourceCodeIdentifier{
						Commit: "4c115873c86ad5bd0ac6d962db70ca53bf8fb874",
					},
					Metadata: &osv.DepGroupMetadata{
