...
// ToProto converts the Metadata struct to a FlatpakPackageMetadata proto.
func ToProto(m *Metadata) *pb.FlatpakPackageMetadata {
	return &pb.FlatpakPackageMetadata{
