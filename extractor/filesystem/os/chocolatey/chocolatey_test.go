			...
			wantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPath("testdata/atom.nuspec"),
				},
			},
		},
		{
			...
			wantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPath("testdata/atom.install.nuspec"),
				},
			},
		},
		{
			...
			wantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPath("testdata/cmake.nuspec"),
				},
			},
		},
		{
			...
			wantPackages: []*extractor.Package{
				{
					...
					Location: extractor.LocationFromPath("testdata/atom_withoutversion.nuspec"),
				},
			},
		},
		{
