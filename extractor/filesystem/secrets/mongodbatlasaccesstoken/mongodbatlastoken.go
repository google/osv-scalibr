...
// Package mongodbatlasaccesstoken extends the veles mongodbatlasaccesstoken.Detector to search inside
...
const (
	...
	Name = "secrets/mongodbatlasaccesstoken"
...
// New returns a filesystem.Extractor which extracts MongoDB Atlas Access Tokens using the mongodbatlasaccesstoken.Detector
func New(_ *cpb.PluginConfig) (filesystem.Extractor, error) {
	return convert.FromVelesDetectorWithRequire(
		mongodbatlasaccesstoken.NewDetector(), Name, Version, FileRequired,
	), nil
}
