...
func TestExtractorsFromName(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			name:     "python",
			wantExts: []string{"python/pdmlock", "python/pipfilelock", "python/poetrylock", "python/pylock", "python/condameta", "python/ipythoninstall", "python/uvlock", "python/wheelegg", "python/requirements", "python/setup"},
		},
		{
