...
// IsProtoable signals that this struct is a metadata struct.
func (m *UnknownBinaryMetadata) IsProtoable() {}

func init() {
	metadata.Register(ToStruct, (*UnknownBinaryMetadata).ToProto)
}
