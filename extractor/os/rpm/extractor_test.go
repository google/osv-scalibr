...
func TestExtract(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// docker run --rm --entrypoint cat opensuse/leap:15.5 /var/lib/rpm/Packages.db > third_party/scalibr/extractor/os/rpm/testdata/Packages.db
		...
		},
		{
			...
			// docker run --rm --entrypoint cat centos:centos7.9.2009 /var/lib/rpm/Packages > third_party/scalibr/extractor/os/rpm/testdata/Packages
		...
		},
		{
			...
			// docker run --rm --entrypoint cat rockylinux:9.2.20230513 /var/lib/rpm/rpmdb.sqlite > third_party/scalibr/extractor/os/rpm/testdata/rpmdb.sqlite
