...
func TestUsername(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "UserV can't read username returns error",
...
func TestEnabled(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "Returns true when user is enabled",
			userV: nil,
			userF: NewUserF([]byte(strings.Repeat("A", 56)+"\x00"), "irrelevant"),
			want:  true,
		},
		{
			name:  "Returns false when user is disabled",
			userV: nil,
			userF: NewUserF([]byte(strings.Repeat("A", 56)+"\x01"), "irrelevant"),
			want:  false,
		},
		{
			name:    "Returns error when userF has errors",
			userV:   nil,
...
func TestHashes(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "Valid RC4 hash combination",
			rid:         "000003E9",
		...
		{
			name:        "Valid AES hash combination",
			rid:         "000003EA",
		...
		{
			name:        "UserV fails to read hashes returns error",
			rid:         "000001F4",
		...
		{
			name:        "Decryption failure is treated as error",
			rid:         "",
			userVBuffer: []byte(""),
			wantErr:     true,
