...
// Appends adds the contents of another Inventory to the current one.
func (i *Inventory) Append(other Inventory) {
	i.Packages = append(i.Packages, other.Packages...)
	i.Findings = append(i.Findings, other.Findings...)
}
