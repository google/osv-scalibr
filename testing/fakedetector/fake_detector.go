...
func (d *fakeDetector) Requirements() *plugin.Requirements { return &plugin.Requirements{} }
...
func (d *fakeDetector) Scan(ctx context.Context, fs scalibrfs.FS, scanRoot string, ix *inventoryindex.InventoryIndex) ([]*detector.Finding, error) {
	if d.Finding == nil {
		return nil, d.Err
	}
