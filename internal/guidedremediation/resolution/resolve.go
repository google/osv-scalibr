...
// ResolveOptions are options to use for resolution.
...
func Resolve(ctx context.Context, c resolve.Client, m manifest.Manifest, opts ResolveOptions) (*resolve.Graph, error) {
