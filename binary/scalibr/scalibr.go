...
func parseFlags(args []string) (*cli.Flags, error) {
	...
	disableGoogleAuth := fs.Bool("disable-google-auth", false, "If set, it prevents initializing Google Application Default Credentials (ADC) for Artifact Registry access.")
