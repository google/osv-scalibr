...
type SecretData_DatabricksUserAccountOauth2ClientCredentials struct {
	DatabricksUserAccountOauth2ClientCredentials *SecretData_DatabricksUserAccountOAuth2ClientCredentials `protobuf:"bytes,89,opt,name=databricks_user_account_oauth2_client_credentials,json=databricksUserAccountOauth2ClientCredentials,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xf0s\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12\xab\x01\n" +
	"1databricks_user_account_oauth2_client_credentials\x18Y \x01(\v2@.scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentialsH\x00R,databricksUserAccountOauth2ClientCredentials\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DatabricksUserAccountOAuth2ClientCredentials)(nil), // 172: scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	172, // 170: scalibr.SecretData.databricks_user_account_oauth2_client_credentials:type_name -> scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentials
