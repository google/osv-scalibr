...
type SecretData_Perplexity struct {
	Perplexity *SecretData_PerplexityAPIKey `protobuf:"bytes,2,opt,name=perplexity,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xed\x04\n" +
	"\n" +
	"SecretData\x124\n" +
	"\x06gcpsak\x18\x01 \x01(\v2\x1a.scalibr.SecretData.GCPSAKH\x00R\x06gcpsak\x12F\n" +
	"\n" +
	"perplexity\x18\x02 \x01(\v2$.scalibr.SecretData.PerplexityAPIKeyH\x00R\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_PerplexityAPIKey)(nil),        // 64: scalibr.SecretData.PerplexityAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	64, // 67: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
