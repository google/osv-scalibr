...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0x8e, 0x12, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x64, 0x61, 0x74, 0x61, 0x12, 0x4c, 0x0a, 0x10, 0x70, 0x6f, 0x72, 0x74, 0x61, 0x67, 0x65, 0x5f,
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x29, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f,
	0x2e, 0x73, 0x63, 0x61, 0x6c, 0x69, 0x62, 0x72, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x61, 0x67, 0x65,
	0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x48,
	0x00, 0x52, 0x0f, 0x70, 0x6f, 0x72, 0x74, 0x61, 0x67, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	0x09, 0x52, 0x09, 0x64, 0x65, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72, 0x22, 0xe2, 0x02, 0x0a,
	...
	0x72, 0x22, 0xbb, 0x03, 0x0a, 0x0f, 0x4d, 0x61, 0x63, 0x41, 0x70, 0x70, 0x73, 0x4d, 0x65, 0x74,
	...
	0x31, 0x22, 0x78, 0x0a, 0x14, 0x4a, 0x61, 0x76, 0x61, 0x4c, 0x6f, 0x63, 0x6b, 0x66, 0x69, 0x6c,
	...
	0x65, 0x70, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x56, 0x61, 0x6c, 0x73, 0x22, 0x86, 0x01, 0x0a, 0x12,
	...
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0xdc, 0x02,
	...
	0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xea, 0x01, 0x0a,
	...
	0x75, 0x6c, 0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x3f, 0x50, 0x01, 0x5a, 0x3b,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_proto_scan_result_proto_goTypes = []interface{}{
	...
	(*ModuleMetadata)(nil),                     // 30: scalibr.ModuleMetadata
	(*MacAppsMetadata)(nil),                    // 31: scalibr.MacAppsMetadata
	(*SPDXPackageMetadata)(nil),                // 32: scalibr.SPDXPackageMetadata
	(*CDXPackageMetadata)(nil),                 // 33: scalibr.CDXPackageMetadata
	(*JavaArchiveMetadata)(nil),                // 34: scalibr.JavaArchiveMetadata
	(*JavaLockfileMetadata)(nil),               // 35: scalibr.JavaLockfileMetadata
	(*OSVPackageMetadata)(nil),                 // 36: scalibr.OSVPackageMetadata
	(*PythonRequirementsMetadata)(nil),         // 37: scalibr.PythonRequirementsMetadata
	(*ContainerdContainerMetadata)(nil),        // 38: scalibr.ContainerdContainerMetadata
	(*ContainerdRuntimeContainerMetadata)(nil), // 39: scalibr.ContainerdRuntimeContainerMetadata
	(*WindowsOSVersion)(nil),                   // 40: scalibr.WindowsOSVersion
	(*timestamp.Timestamp)(nil),                // 41: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	41, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	41, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	32, // 17: scalibr.Inventory.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	34, // 18: scalibr.Inventory.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	35, // 19: scalibr.Inventory.java_lockfile_metadata:type_name -> scalibr.JavaLockfileMetadata
	24, // 20: scalibr.Inventory.pacman_metadata:type_name -> scalibr.PACMANPackageMetadata
	30, // 21: scalibr.Inventory.module_metadata:type_name -> scalibr.ModuleMetadata
	25, // 22: scalibr.Inventory.nix_metadata:type_name -> scalibr.NixPackageMetadata
	28, // 23: scalibr.Inventory.portage_metadata:type_name -> scalibr.PortagePackageMetadata
	36, // 24: scalibr.Inventory.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	37, // 25: scalibr.Inventory.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	38, // 26: scalibr.Inventory.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	27, // 27: scalibr.Inventory.snap_metadata:type_name -> scalibr.SNAPPackageMetadata
	29, // 28: scalibr.Inventory.flatpak_metadata:type_name -> scalibr.FlatpakPackageMetadata
	31, // 29: scalibr.Inventory.mac_apps_metadata:type_name -> scalibr.MacAppsMetadata
	39, // 30: scalibr.Inventory.containerd_runtime_container_metadata:type_name -> scalibr.ContainerdRuntimeContainerMetadata
	33, // 31: scalibr.Inventory.cdx_metadata:type_name -> scalibr.CDXPackageMetadata
	40, // 32: scalibr.Inventory.windows_os_version_metadata:type_name -> scalibr.WindowsOSVersion
	1,  // 33: scalibr.Inventory.annotations:type_name -> scalibr.Inventory.AnnotationEnum
	9,  // 34: scalibr.Inventory.layer_details:type_name -> scalibr.LayerDetails
	11, // 35: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	13, // 36: scalibr.Finding.adv:type_name -> scalibr.Advisory
	17, // 37: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	14, // 38: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	2,  // 39: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	15, // 40: scalibr.Advisory.sev:type_name -> scalibr.Severity
	3,  // 41: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	16, // 42: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	16, // 43: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	7,  // 44: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	10, // 45: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
	10, // 46: scalibr.CDXPackageMetadata.purl:type_name -> scalibr.Purl
