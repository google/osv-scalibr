...
type SecretData_DatabricksUserAccountPat_ struct {
	DatabricksUserAccountPat *SecretData_DatabricksUserAccountPat `protobuf:"bytes,77,opt,name=databricks_user_account_pat,json=databricksUserAccountPat,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x92c\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x14cloudflare_api_token\x18L \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x12m\n" +
	"\x1bdatabricks_user_account_pat\x18M \x01(\v2,.scalibr.SecretData.DatabricksUserAccountPatH\x00R\x18databricksUserAccountPat\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DatabricksUserAccountPat)(nil),             // 159: scalibr.SecretData.DatabricksUserAccountPat
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	159, // 157: scalibr.SecretData.databricks_user_account_pat:type_name -> scalibr.SecretData.DatabricksUserAccountPat
	...
	146, // 170: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
