...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xf1S\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x0fmistral_api_key\x18B \x01(\v2!.scalibr.SecretData.MistralAPIKeyH\x00R\rmistralApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
