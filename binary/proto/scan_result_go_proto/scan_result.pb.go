...
type SecretData_DatabricksServicePrincipalPat_ struct {
	DatabricksServicePrincipalPat *SecretData_DatabricksServicePrincipalPat `protobuf:"bytes,88,opt,name=databricks_service_principal_pat,json=databricksServicePrincipalPat,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xbdq\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11discord_bot_token\x18W \x01(\v2#.scalibr.SecretData.DiscordBotTokenH\x00R\x0fdiscordBotToken\x12|\n" +
	" databricks_service_principal_pat\x18X \x01(\v21.scalibr.SecretData.DatabricksServicePrincipalPatH\x00R\x1ddatabricksServicePrincipalPat\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x03key\x18\x02 \x01(\tR\x03key\x1aG\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DatabricksServicePrincipalPat)(nil),        // 170: scalibr.SecretData.DatabricksServicePrincipalPat
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	170, // 168: scalibr.SecretData.databricks_service_principal_pat:type_name -> scalibr.SecretData.DatabricksServicePrincipalPat
