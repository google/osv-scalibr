...
type SpackPackageMetadata struct {
	...
	PlatformOs           string                 `protobuf:"bytes,4,opt,name=platform_os,json=platformOs,proto3" json:"platform_os,omitempty"`
	PlatformArchitecture string                 `protobuf:"bytes,5,opt,name=platform_architecture,json=platformArchitecture,proto3" json:"platform_architecture,omitempty"`
...
func (x *SpackPackageMetadata) GetPackageName() string {
	if x != nil {
		return x.PackageName
	}
	return ""
...
func (x *SpackPackageMetadata) GetPackageVersion() string {
	if x != nil {
		return x.PackageVersion
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tdeveloper\x18\t \x01(\tR\tdeveloper\"\xe8\x01\n" +
	"\x14SpackPackageMetadata\x12!\n" +
	"\fpackage_name\x18\x01 \x01(\tR\vpackageName\x12'\n" +
	"\x0fpackage_version\x18\x02 \x01(\tR\x0epackageVersion\x12\x1a\n" +
	"\bplatform\x18\x03 \x01(\tR\bplatform\x12\x1f\n" +
	"\vplatform_os\x18\x04 \x01(\tR\n" +
	"platformOs\x123\n" +
	"\x15platform_architecture\x18\x05 \x01(\tR\x14platformArchitecture\x12\x12\n" +
	"\x04hash\x18\x06 \x01(\tR\x04hash\"\xe8\x02\n" +
