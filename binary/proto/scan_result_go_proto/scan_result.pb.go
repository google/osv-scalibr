...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x9b\n" +
	"\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1bgrok_xai_management_api_key\x18\a \x01(\v2+.scalibr.SecretData.GrokXAIManagementAPIKeyH\x00R\x17grokXaiManagementApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 68)
...
var file_proto_scan_result_proto_depIdxs = []int32{
	73, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	73, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	73, // 63: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	73, // 64: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	4,  // 76: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	73, // 77: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	61, // 78: scalibr.Location.filepath:type_name -> scalibr.Filepath
	62, // 79: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	63, // 80: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	64, // 81: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11, // 82: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	52, // 83: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
