...
type SecretData_OnepasswordSecretKey struct {
	OnepasswordSecretKey *SecretData_OnePasswordSecretKey `protobuf:"bytes,20,opt,name=onepassword_secret_key,json=onepasswordSecretKey,proto3,oneof"`
}

type SecretData_OnepasswordServiceToken struct {
	OnepasswordServiceToken *SecretData_OnePasswordServiceToken `protobuf:"bytes,21,opt,name=onepassword_service_token,json=onepasswordServiceToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xfb\x18\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\vgcp_api_key\x18\x13 \x01(\v2\x1d.scalibr.SecretData.GCPAPIKeyH\x00R\tgcpApiKey\x12`\n" +
	"\x16onepassword_secret_key\x18\x14 \x01(\v2(.scalibr.SecretData.OnePasswordSecretKeyH\x00R\x14onepasswordSecretKey\x12i\n" +
	"\x19onepassword_service_token\x18\x15 \x01(\v2+.scalibr.SecretData.OnePasswordServiceTokenH\x00R\x17onepasswordServiceToken\x1a(\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_OnePasswordSecretKey)(nil),             // 66: scalibr.SecretData.OnePasswordSecretKey
	(*SecretData_OnePasswordServiceToken)(nil),          // 67: scalibr.SecretData.OnePasswordServiceToken
	(*SecretData_GCPSAK)(nil),                           // 68: scalibr.SecretData.GCPSAK
	(*SecretData_AnthropicWorkspaceAPIKey)(nil),         // 69: scalibr.SecretData.AnthropicWorkspaceAPIKey
	(*SecretData_AnthropicModelAPIKey)(nil),             // 70: scalibr.SecretData.AnthropicModelAPIKey
	(*SecretData_PerplexityAPIKey)(nil),                 // 71: scalibr.SecretData.PerplexityAPIKey
	(*SecretData_GrokXAIAPIKey)(nil),                    // 72: scalibr.SecretData.GrokXAIAPIKey
	(*SecretData_GrokXAIManagementAPIKey)(nil),          // 73: scalibr.SecretData.GrokXAIManagementAPIKey
	(*SecretData_PrivateKey)(nil),                       // 74: scalibr.SecretData.PrivateKey
	(*SecretData_AzureAccessToken)(nil),                 // 75: scalibr.SecretData.AzureAccessToken
	(*SecretData_AzureIdentityToken)(nil),               // 76: scalibr.SecretData.AzureIdentityToken
	(*SecretData_OpenAIAPIKey)(nil),                     // 77: scalibr.SecretData.OpenAIAPIKey
	(*SecretData_DockerHubPat)(nil),                     // 78: scalibr.SecretData.DockerHubPat
	(*SecretData_GitlabPat)(nil),                        // 79: scalibr.SecretData.GitlabPat
	(*SecretData_PostmanAPIKey)(nil),                    // 80: scalibr.SecretData.PostmanAPIKey
	(*SecretData_PostmanCollectionAccessToken)(nil),     // 81: scalibr.SecretData.PostmanCollectionAccessToken
	(*SecretData_DigitalOceanAPIToken)(nil),             // 82: scalibr.SecretData.DigitalOceanAPIToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	68, // 69: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	69, // 70: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	70, // 71: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	71, // 72: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	74, // 73: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	72, // 74: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	73, // 75: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	78, // 76: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	82, // 77: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	77, // 78: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	80, // 79: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	81, // 80: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	75, // 81: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	76, // 82: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	83, // 83: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	79, // 84: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	...
	66, // 88: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	67, // 89: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
