...
type SecretData struct {
	...
	//	*SecretData_SapAccessToken
	//	*SecretData_SapSuccessFactorsAccessToken
	//	*SecretData_SapAribaOauth2ClientCredentials
	//	*SecretData_SapBtpOauth2ClientCredentials
	//	*SecretData_SapConcurAccessToken
	//	*SecretData_SapConcurRefreshToken
...
func (x *SecretData) GetSapAccessToken() *SecretData_SAPAccessToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_SapAccessToken); ok {
			return x.SapAccessToken
		}
	}
	return nil
}

func (x *SecretData) GetSapSuccessFactorsAccessToken() *SecretData_SAPSuccessFactorsAccessToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_SapSuccessFactorsAccessToken); ok {
			return x.SapSuccessFactorsAccessToken
		}
	}
	return nil
}

func (x *SecretData) GetSapAribaOauth2ClientCredentials() *SecretData_SAPAribaOAuth2ClientCredentials {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_SapAribaOauth2ClientCredentials); ok {
			return x.SapAribaOauth2ClientCredentials
		}
	}
	return nil
}

func (x *SecretData) GetSapBtpOauth2ClientCredentials() *SecretData_SAPBTPOAuth2ClientCredentials {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_SapBtpOauth2ClientCredentials); ok {
			return x.SapBtpOauth2ClientCredentials
		}
	}
	return nil
}

func (x *SecretData) GetSapConcurAccessToken() *SecretData_SAPConcurAccessToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_SapConcurAccessToken); ok {
			return x.SapConcurAccessToken
		}
	}
	return nil
}

func (x *SecretData) GetSapConcurRefreshToken() *SecretData_SAPConcurRefreshToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_SapConcurRefreshToken); ok {
			return x.SapConcurRefreshToken
		}
	}
	return nil
}
...
type SecretData_SapAccessToken struct {
	SapAccessToken *SecretData_SAPAccessToken `protobuf:"bytes,89,opt,name=sap_access_token,json=sapAccessToken,proto3,oneof"`
}

type SecretData_SapSuccessFactorsAccessToken struct {
	SapSuccessFactorsAccessToken *SecretData_SAPSuccessFactorsAccessToken `protobuf:"bytes,90,opt,name=sap_success_factors_access_token,json=sapSuccessFactorsAccessToken,proto3,oneof"`
}

type SecretData_SapAribaOauth2ClientCredentials struct {
	SapAribaOauth2ClientCredentials *SecretData_SAPAribaOAuth2ClientCredentials `protobuf:"bytes,91,opt,name=sap_ariba_oauth2_client_credentials,json=sapAribaOauth2ClientCredentials,proto3,oneof"`
}

type SecretData_SapBtpOauth2ClientCredentials struct {
	SapBtpOauth2ClientCredentials *SecretData_SAPBTPOAuth2ClientCredentials `protobuf:"bytes,93,opt,name=sap_btp_oauth2_client_credentials,json=sapBtpOauth2ClientCredentials,proto3,oneof"`
}

type SecretData_SapConcurAccessToken struct {
	SapConcurAccessToken *SecretData_SAPConcurAccessToken `protobuf:"bytes,94,opt,name=sap_concur_access_token,json=sapConcurAccessToken,proto3,oneof"`
}

type SecretData_SapConcurRefreshToken struct {
	SapConcurRefreshToken *SecretData_SAPConcurRefreshToken `protobuf:"bytes,95,opt,name=sap_concur_refresh_token,json=sapConcurRefreshToken,proto3,oneof"`
}
...
func (*SecretData_SapAccessToken) isSecretData_Secret() {}

func (*SecretData_SapSuccessFactorsAccessToken) isSecretData_Secret() {}

func (*SecretData_SapAribaOauth2ClientCredentials) isSecretData_Secret() {}

func (*SecretData_SapBtpOauth2ClientCredentials) isSecretData_Secret() {}

func (*SecretData_SapConcurAccessToken) isSecretData_Secret() {}

func (*SecretData_SapConcurRefreshToken) isSecretData_Secret() {}
...
func (x *SecretData_SAPAccessToken) Reset() {
	*x = SecretData_SAPAccessToken{}
	mi := &file_proto_scan_result_proto_msgTypes[163]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_SAPAccessToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_SAPAccessToken) ProtoMessage() {}

func (x *SecretData_SAPAccessToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[163]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_SAPAccessToken.ProtoReflect.Descriptor instead.
func (*SecretData_SAPAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 82}
}

func (x *SecretData_SAPAccessToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_SAPAccessToken) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *SecretData_SAPSuccessFactorsAccessToken) Reset() {
	*x = SecretData_SAPSuccessFactorsAccessToken{}
	mi := &file_proto_scan_result_proto_msgTypes[164]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_SAPSuccessFactorsAccessToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_SAPSuccessFactorsAccessToken) ProtoMessage() {}

func (x *SecretData_SAPSuccessFactorsAccessToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[164]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_SAPSuccessFactorsAccessToken.ProtoReflect.Descriptor instead.
func (*SecretData_SAPSuccessFactorsAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 83}
}

func (x *SecretData_SAPSuccessFactorsAccessToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_SAPAribaOAuth2ClientCredentials) Reset() {
	*x = SecretData_SAPAribaOAuth2ClientCredentials{}
	mi := &file_proto_scan_result_proto_msgTypes[165]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_SAPAribaOAuth2ClientCredentials) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_SAPAribaOAuth2ClientCredentials) ProtoMessage() {}

func (x *SecretData_SAPAribaOAuth2ClientCredentials) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[165]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_SAPAribaOAuth2ClientCredentials.ProtoReflect.Descriptor instead.
func (*SecretData_SAPAribaOAuth2ClientCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 84}
}

func (x *SecretData_SAPAribaOAuth2ClientCredentials) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SecretData_SAPAribaOAuth2ClientCredentials) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *SecretData_SAPBTPOAuth2ClientCredentials) Reset() {
	*x = SecretData_SAPBTPOAuth2ClientCredentials{}
	mi := &file_proto_scan_result_proto_msgTypes[166]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_SAPBTPOAuth2ClientCredentials) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_SAPBTPOAuth2ClientCredentials) ProtoMessage() {}

func (x *SecretData_SAPBTPOAuth2ClientCredentials) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[166]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_SAPBTPOAuth2ClientCredentials.ProtoReflect.Descriptor instead.
func (*SecretData_SAPBTPOAuth2ClientCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 85}
}

func (x *SecretData_SAPBTPOAuth2ClientCredentials) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SecretData_SAPBTPOAuth2ClientCredentials) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *SecretData_SAPBTPOAuth2ClientCredentials) GetTokenUrl() string {
	if x != nil {
		return x.TokenUrl
	}
	return ""
...
func (x *SecretData_SAPConcurAccessToken) Reset() {
	*x = SecretData_SAPConcurAccessToken{}
	mi := &file_proto_scan_result_proto_msgTypes[167]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_SAPConcurAccessToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_SAPConcurAccessToken) ProtoMessage() {}

func (x *SecretData_SAPConcurAccessToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[167]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_SAPConcurAccessToken.ProtoReflect.Descriptor instead.
func (*SecretData_SAPConcurAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 86}
}

func (x *SecretData_SAPConcurAccessToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_SAPConcurRefreshToken) Reset() {
	*x = SecretData_SAPConcurRefreshToken{}
	mi := &file_proto_scan_result_proto_msgTypes[168]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_SAPConcurRefreshToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_SAPConcurRefreshToken) ProtoMessage() {}

func (x *SecretData_SAPConcurRefreshToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[168]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_SAPConcurRefreshToken.ProtoReflect.Descriptor instead.
func (*SecretData_SAPConcurRefreshToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 87}
}

func (x *SecretData_SAPConcurRefreshToken) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SecretData_SAPConcurRefreshToken) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *SecretData_SAPConcurRefreshToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (*SecretData_SquarePersonalAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 93}
}
...
func (*SecretData_SquareOAuthApplicationSecret) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 94}
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xe6 \n" +
	"\aPackage\x12\x0e\n" +
	...
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation\"\x8bz\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12N\n" +
	"\x10sap_access_token\x18Y \x01(\v2\".scalibr.SecretData.SAPAccessTokenH\x00R\x0esapAccessToken\x12z\n" +
	" sap_success_factors_access_token\x18Z \x01(\v20.scalibr.SecretData.SAPSuccessFactorsAccessTokenH\x00R\x1csapSuccessFactorsAccessToken\x12\x83\x01\n" +
	"#sap_ariba_oauth2_client_credentials\x18[ \x01(\v23.scalibr.SecretData.SAPAribaOAuth2ClientCredentialsH\x00R\x1fsapAribaOauth2ClientCredentials\x12}\n" +
	"!sap_btp_oauth2_client_credentials\x18] \x01(\v21.scalibr.SecretData.SAPBTPOAuth2ClientCredentialsH\x00R\x1dsapBtpOauth2ClientCredentials\x12a\n" +
	"\x17sap_concur_access_token\x18^ \x01(\v2(.scalibr.SecretData.SAPConcurAccessTokenH\x00R\x14sapConcurAccessToken\x12d\n" +
	"\x18sap_concur_refresh_token\x18_ \x01(\v2).scalibr.SecretData.SAPConcurRefreshTokenH\x00R\x15sapConcurRefreshToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"privateKey\x1a8\n" +
	"\x0eSAPAccessToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x1a4\n" +
	"\x1cSAPSuccessFactorsAccessToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x1aI\n" +
	"\x1fSAPAribaOAuth2ClientCredentials\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06secret\x18\x02 \x01(\tR\x06secret\x1ad\n" +
	"\x1dSAPBTPOAuth2ClientCredentials\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06secret\x18\x02 \x01(\tR\x06secret\x12\x1b\n" +
	"\ttoken_url\x18\x03 \x01(\tR\btokenUrl\x1a,\n" +
	"\x14SAPConcurAccessToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x1aU\n" +
	"\x15SAPConcurRefreshToken\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06secret\x18\x02 \x01(\tR\x06secret\x12\x14\n" +
	"\x05token\x18\x03 \x01(\tR\x05token\x1a^\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_SAPAccessToken)(nil),                       // 168: scalibr.SecretData.SAPAccessToken
	(*SecretData_SAPSuccessFactorsAccessToken)(nil),         // 169: scalibr.SecretData.SAPSuccessFactorsAccessToken
	(*SecretData_SAPAribaOAuth2ClientCredentials)(nil),      // 170: scalibr.SecretData.SAPAribaOAuth2ClientCredentials
	(*SecretData_SAPBTPOAuth2ClientCredentials)(nil),        // 171: scalibr.SecretData.SAPBTPOAuth2ClientCredentials
	(*SecretData_SAPConcurAccessToken)(nil),                 // 172: scalibr.SecretData.SAPConcurAccessToken
	(*SecretData_SAPConcurRefreshToken)(nil),                // 173: scalibr.SecretData.SAPConcurRefreshToken
	...
	(*osvschema.Vulnerability)(nil), // 183: osv.Vulnerability
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	67,  // 48: scalibr.Package.winget_metadata:type_name -> scalibr.WingetPackageMetadata
	...
	68,  // 55: scalibr.Package.unknown_binary_metadata:type_name -> scalibr.UnknownBinaryMetadata
	...
	37,  // 58: scalibr.Package.spack_metadata:type_name -> scalibr.SpackPackageMetadata
	14,  // 59: scalibr.Package.exploitability_signals:type_name -> scalibr.PackageExploitabilitySignal
	84,  // 60: scalibr.Package.container_image_metadata_indexes:type_name -> scalibr.Package.ContainerImageMetadataIndexes
	78,  // 61: scalibr.PackageLocation.desc:type_name -> scalibr.Location
	78,  // 62: scalibr.PackageLocation.related:type_name -> scalibr.Location
	0,   // 63: scalibr.PackageExploitabilitySignal.justification:type_name -> scalibr.VexJustification
	15,  // 64: scalibr.PackageExploitabilitySignal.vuln_identifiers:type_name -> scalibr.VulnIdentifiers
	0,   // 65: scalibr.FindingExploitabilitySignal.justification:type_name -> scalibr.VexJustification
	18,  // 66: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	183, // 67: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	16,  // 68: scalibr.PackageVuln.exploitability_signals:type_name -> scalibr.FindingExploitabilitySignal
	21,  // 69: scalibr.GenericFinding.adv:type_name -> scalibr.GenericFindingAdvisory
	23,  // 70: scalibr.GenericFinding.target:type_name -> scalibr.GenericFindingTargetDetails
	16,  // 71: scalibr.GenericFinding.exploitability_signals:type_name -> scalibr.FindingExploitabilitySignal
	22,  // 72: scalibr.GenericFindingAdvisory.id:type_name -> scalibr.AdvisoryId
	1,   // 73: scalibr.GenericFindingAdvisory.sev:type_name -> scalibr.SeverityEnum
	2,   // 74: scalibr.JavascriptPackageJSONMetadata.source:type_name -> scalibr.PackageSource
	17,  // 75: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
	17,  // 76: scalibr.CDXPackageMetadata.purl:type_name -> scalibr.Purl
	85,  // 77: scalibr.PodmanMetadata.exposed_ports:type_name -> scalibr.PodmanMetadata.ExposedPortsEntry
	182, // 78: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	182, // 79: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	66,  // 80: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	69,  // 81: scalibr.UnknownBinaryMetadata.attribution:type_name -> scalibr.UnknownBinaryAttribution
	71,  // 82: scalibr.Secret.secret:type_name -> scalibr.SecretData
	72,  // 83: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	73,  // 84: scalibr.Secret.locations:type_name -> scalibr.LocationLegacy
	78,  // 85: scalibr.Secret.location:type_name -> scalibr.Location
	86,  // 86: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	88,  // 87: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	89,  // 88: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	90,  // 89: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	95,  // 90: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	92,  // 91: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	93,  // 92: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	101, // 93: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	111, // 94: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	100, // 95: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	108, // 96: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	109, // 97: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	96,  // 98: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	99,  // 99: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	121, // 100: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	104, // 101: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	122, // 102: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	123, // 103: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	124, // 104: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	125, // 105: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	114, // 106: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	128, // 107: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	129, // 108: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	130, // 109: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	134, // 110: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	135, // 111: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	115, // 112: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	116, // 113: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	117, // 114: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	119, // 115: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	118, // 116: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	110, // 117: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	107, // 118: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	105, // 119: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	106, // 120: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	94,  // 121: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	126, // 122: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	127, // 123: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	147, // 124: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	148, // 125: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	149, // 126: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	139, // 127: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	97,  // 128: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	120, // 129: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	112, // 130: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	98,  // 131: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	136, // 132: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	137, // 133: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	138, // 134: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	150, // 135: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	151, // 136: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	152, // 137: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	153, // 138: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	154, // 139: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	87,  // 140: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	155, // 141: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	156, // 142: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	158, // 143: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	162, // 144: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	175, // 145: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	157, // 146: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	178, // 147: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	165, // 148: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	163, // 149: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	166, // 150: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	91,  // 151: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	176, // 152: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	177, // 153: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	179, // 154: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	180, // 155: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	167, // 156: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	164, // 157: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	103, // 158: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	160, // 159: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	113, // 160: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	102, // 161: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	131, // 162: scalibr.SecretData.supabase_pat:type_name -> scalibr.SecretData.SupabasePAT
	132, // 163: scalibr.SecretData.supabase_project_secret_key:type_name -> scalibr.SecretData.SupabaseProjectSecretKey
	133, // 164: scalibr.SecretData.supabase_service_role_jwt:type_name -> scalibr.SecretData.SupabaseServiceRoleJWT
	141, // 165: scalibr.SecretData.packagist_api_key:type_name -> scalibr.SecretData.PackagistAPIKey
	142, // 166: scalibr.SecretData.packagist_api_secret:type_name -> scalibr.SecretData.PackagistAPISecret
	143, // 167: scalibr.SecretData.packagist_org_read_token:type_name -> scalibr.SecretData.PackagistOrgReadToken
	144, // 168: scalibr.SecretData.packagist_org_update_token:type_name -> scalibr.SecretData.PackagistOrgUpdateToken
	145, // 169: scalibr.SecretData.packagist_user_update_token:type_name -> scalibr.SecretData.PackagistUserUpdateToken
	146, // 170: scalibr.SecretData.packagist_conductor_update_token:type_name -> scalibr.SecretData.PackagistConductorUpdateToken
	140, // 171: scalibr.SecretData.composer_http_basic_credentials:type_name -> scalibr.SecretData.ComposerPackagistCredentials
	159, // 172: scalibr.SecretData.discord_bot_token:type_name -> scalibr.SecretData.DiscordBotToken
	174, // 173: scalibr.SecretData.bitwarden_oauth2_access_token:type_name -> scalibr.SecretData.BitwardenOAuth2AccessToken
	168, // 174: scalibr.SecretData.sap_access_token:type_name -> scalibr.SecretData.SAPAccessToken
	169, // 175: scalibr.SecretData.sap_success_factors_access_token:type_name -> scalibr.SecretData.SAPSuccessFactorsAccessToken
	170, // 176: scalibr.SecretData.sap_ariba_oauth2_client_credentials:type_name -> scalibr.SecretData.SAPAribaOAuth2ClientCredentials
	171, // 177: scalibr.SecretData.sap_btp_oauth2_client_credentials:type_name -> scalibr.SecretData.SAPBTPOAuth2ClientCredentials
	172, // 178: scalibr.SecretData.sap_concur_access_token:type_name -> scalibr.SecretData.SAPConcurAccessToken
	173, // 179: scalibr.SecretData.sap_concur_refresh_token:type_name -> scalibr.SecretData.SAPConcurRefreshToken
	4,   // 180: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	182, // 181: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	74,  // 182: scalibr.LocationLegacy.filepath:type_name -> scalibr.Filepath
	75,  // 183: scalibr.LocationLegacy.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	76,  // 184: scalibr.LocationLegacy.environment_variable:type_name -> scalibr.EnvironmentVariable
	77,  // 185: scalibr.LocationLegacy.container_command:type_name -> scalibr.ContainerCommand
	13,  // 186: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	79,  // 187: scalibr.Location.file:type_name -> scalibr.File
	83,  // 188: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	81,  // 189: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	181, // 190: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	82,  // 191: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	59,  // 192: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	161, // 193: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	184, // 194: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[66].OneofWrappers = []any{
		...
		(*SecretData_SapAccessToken)(nil),
		(*SecretData_SapSuccessFactorsAccessToken)(nil),
		(*SecretData_SapAribaOauth2ClientCredentials)(nil),
		(*SecretData_SapBtpOauth2ClientCredentials)(nil),
		(*SecretData_SapConcurAccessToken)(nil),
		(*SecretData_SapConcurRefreshToken)(nil),
	}
