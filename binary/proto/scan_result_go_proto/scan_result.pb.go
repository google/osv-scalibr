...
type Package_ChocolateyMetadata struct {
	ChocolateyMetadata *ChocolateyPackageMetadata `protobuf:"bytes,56,opt,name=chocolatey_metadata,json=chocolateyMetadata,proto3,oneof"`
}
...
type PodmanMetadata struct {
	...
	StartedTime   *timestamp.Timestamp   `protobuf:"bytes,4,opt,name=started_time,json=startedTime,proto3" json:"started_time,omitempty"`
	FinishedTime  *timestamp.Timestamp   `protobuf:"bytes,5,opt,name=finished_time,json=finishedTime,proto3" json:"finished_time,omitempty"`
...
func (x *PodmanMetadata) GetStartedTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *PodmanMetadata) GetFinishedTime() *timestamp.Timestamp {
	if x != nil {
...
type ChocolateyPackageMetadata struct {
	...
	Licenseurl    string                 `protobuf:"bytes,5,opt,name=licenseurl,proto3" json:"licenseurl,omitempty"`
...
func (x *ChocolateyPackageMetadata) GetSummary() string {
	if x != nil {
		return x.Summary
	}
	return ""
...
func (x *SecretStatus) GetLastUpdated() *timestamp.Timestamp {
	if x != nil {
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	57, // 48: scalibr.Package.chocolatey_metadata:type_name -> scalibr.ChocolateyPackageMetadata
	...
	88, // 64: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	88, // 65: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	83, // 84: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	78, // 85: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	84, // 86: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	85, // 87: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	86, // 88: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	87, // 89: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	...
	62, // 93: scalibr.Location.filepath:type_name -> scalibr.Filepath
	63, // 94: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	64, // 95: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	65, // 96: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
