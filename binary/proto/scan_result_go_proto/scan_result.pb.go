...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xb1, 0x08, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42,
	0x0a, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4a, 0x04, 0x08, 0x03, 0x10,
	0x04, 0x4a, 0x04, 0x08, 0x11, 0x10, 0x12, 0x4a, 0x04, 0x08, 0x12, 0x10, 0x13, 0x4a, 0x04, 0x08,
	0x13, 0x10, 0x14, 0x22, 0xc8, 0x01, 0x0a, 0x04, 0x50, 0x75, 0x72, 0x6c, 0x12, 0x12, 0x0a, 0x04,
	...
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x4c, 0x0a, 0x13, 0x53, 0x50, 0x44,
	...
	0x6e, 0x69, 0x74, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x50, 0x69, 0x64, 0x42, 0x3f, 0x50,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_proto_scan_result_proto_goTypes = []interface{}{
	...
	(*ContainerdContainerMetadata)(nil),   // 25: scalibr.ContainerdContainerMetadata
	(*timestamppb.Timestamp)(nil),         // 26: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	26, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	26, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	25, // 19: scalibr.Inventory.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	8,  // 20: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	10, // 21: scalibr.Finding.adv:type_name -> scalibr.Advisory
	14, // 22: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	11, // 23: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	1,  // 24: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	12, // 25: scalibr.Advisory.sev:type_name -> scalibr.Severity
	2,  // 26: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	13, // 27: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	13, // 28: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	6,  // 29: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	7,  // 30: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
