...
type SecretData struct {
	...
	//	*SecretData_GitlabPipelineTriggerToken_
...
func (x *SecretData) GetGitlabPipelineTriggerToken() *SecretData_GitlabPipelineTriggerToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GitlabPipelineTriggerToken_); ok {
			return x.GitlabPipelineTriggerToken
		}
	}
	return nil
}
...
type SecretData_GitlabPipelineTriggerToken_ struct {
	GitlabPipelineTriggerToken *SecretData_GitlabPipelineTriggerToken `protobuf:"bytes,89,opt,name=gitlab_pipeline_trigger_token,json=gitlabPipelineTriggerToken,proto3,oneof"`
}
...
func (*SecretData_GitlabPipelineTriggerToken_) isSecretData_Secret() {}
...
type SecretData_GitlabPipelineTriggerToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
...
func (x *SecretData_GitlabPipelineTriggerToken) Reset() {
	*x = SecretData_GitlabPipelineTriggerToken{}
	mi := &file_proto_scan_result_proto_msgTypes[97]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GitlabPipelineTriggerToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GitlabPipelineTriggerToken) ProtoMessage() {}

func (x *SecretData_GitlabPipelineTriggerToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[97]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GitlabPipelineTriggerToken.ProtoReflect.Descriptor instead.
func (*SecretData_GitlabPipelineTriggerToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 19}
}

func (x *SecretData_GitlabPipelineTriggerToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_GitlabPipelineTriggerToken) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *SecretData_GitlabPipelineTriggerToken) GetHostname() string {
	if x != nil {
		return x.Hostname
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xafs\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12s\n" +
	"\x1dgitlab_pipeline_trigger_token\x18Y \x01(\v2..scalibr.SecretData.GitlabPipelineTriggerTokenH\x00R\x1agitlabPipelineTriggerToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\tGitlabPat\x12\x10\n" +
	"\x03pat\x18\x01 \x01(\tR\x03pat\x1am\n" +
	"\x1aGitlabPipelineTriggerToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1d\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectId\x12\x1a\n" +
	"\bhostname\x18\x03 \x01(\tR\bhostname\x1a*\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GitlabPipelineTriggerToken)(nil),           // 102: scalibr.SecretData.GitlabPipelineTriggerToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	109, // 90: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	97,  // 91: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	106, // 92: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	107, // 93: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	...
	119, // 96: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	101, // 97: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	120, // 98: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	121, // 99: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	122, // 100: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	123, // 101: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	112, // 102: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	126, // 103: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	127, // 104: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	128, // 105: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	132, // 106: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	133, // 107: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	113, // 108: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	114, // 109: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	115, // 110: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	117, // 111: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	116, // 112: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	108, // 113: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	105, // 114: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	103, // 115: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	104, // 116: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	91,  // 117: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	124, // 118: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	125, // 119: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	145, // 120: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	146, // 121: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	147, // 122: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	137, // 123: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	94,  // 124: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	118, // 125: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	110, // 126: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	95,  // 127: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	134, // 128: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	135, // 129: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	136, // 130: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	148, // 131: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	149, // 132: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	150, // 133: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	151, // 134: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	152, // 135: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	84,  // 136: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	153, // 137: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	154, // 138: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	156, // 139: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	160, // 140: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	167, // 141: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	155, // 142: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	170, // 143: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	163, // 144: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	161, // 145: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	164, // 146: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	88,  // 147: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	168, // 148: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	169, // 149: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	171, // 150: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	172, // 151: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	165, // 152: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	162, // 153: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	100, // 154: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	158, // 155: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	111, // 156: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	99,  // 157: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	129, // 158: scalibr.SecretData.supabase_pat:type_name -> scalibr.SecretData.SupabasePAT
	130, // 159: scalibr.SecretData.supabase_project_secret_key:type_name -> scalibr.SecretData.SupabaseProjectSecretKey
	131, // 160: scalibr.SecretData.supabase_service_role_jwt:type_name -> scalibr.SecretData.SupabaseServiceRoleJWT
	139, // 161: scalibr.SecretData.packagist_api_key:type_name -> scalibr.SecretData.PackagistAPIKey
	140, // 162: scalibr.SecretData.packagist_api_secret:type_name -> scalibr.SecretData.PackagistAPISecret
	141, // 163: scalibr.SecretData.packagist_org_read_token:type_name -> scalibr.SecretData.PackagistOrgReadToken
	142, // 164: scalibr.SecretData.packagist_org_update_token:type_name -> scalibr.SecretData.PackagistOrgUpdateToken
	143, // 165: scalibr.SecretData.packagist_user_update_token:type_name -> scalibr.SecretData.PackagistUserUpdateToken
	144, // 166: scalibr.SecretData.packagist_conductor_update_token:type_name -> scalibr.SecretData.PackagistConductorUpdateToken
	138, // 167: scalibr.SecretData.composer_http_basic_credentials:type_name -> scalibr.SecretData.ComposerPackagistCredentials
	157, // 168: scalibr.SecretData.discord_bot_token:type_name -> scalibr.SecretData.DiscordBotToken
	166, // 169: scalibr.SecretData.bitwarden_oauth2_access_token:type_name -> scalibr.SecretData.BitwardenOAuth2AccessToken
	102, // 170: scalibr.SecretData.gitlab_pipeline_trigger_token:type_name -> scalibr.SecretData.GitlabPipelineTriggerToken
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[65].OneofWrappers = []any{
		...
		(*SecretData_GitlabPipelineTriggerToken_)(nil),
	}
