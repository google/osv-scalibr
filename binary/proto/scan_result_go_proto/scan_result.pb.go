...
type Package_MiseMetadata struct {
	MiseMetadata *MiseMetadata `protobuf:"bytes,58,opt,name=mise_metadata,json=miseMetadata,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\x06status\x18\x03 \x01(\v2\x13.scalibr.ScanStatusR\x06status\"\xbb\x1d\n" +
	"\aPackage\x12\x12\n" +
	...
	"\fnvm_metadata\x188 \x01(\v2\x14.scalibr.NvmMetadataH\x00R\vnvmMetadata\x12<\n" +
	"\rmise_metadata\x18: \x01(\v2\x15.scalibr.MiseMetadataH\x00R\fmiseMetadata\x12Z\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*MiseMetadata)(nil),                          // 55: scalibr.MiseMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	55,  // 50: scalibr.Package.mise_metadata:type_name -> scalibr.MiseMetadata
