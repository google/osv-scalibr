...
type SecretData struct {
	...
	//	*SecretData_DropboxAppAccessToken_
...
func (x *SecretData) GetDropboxAppAccessToken() *SecretData_DropboxAppAccessToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_DropboxAppAccessToken_); ok {
			return x.DropboxAppAccessToken
		}
	}
	return nil
}
...
type SecretData_DropboxAppAccessToken_ struct {
	DropboxAppAccessToken *SecretData_DropboxAppAccessToken `protobuf:"bytes,77,opt,name=dropbox_app_access_token,json=dropboxAppAccessToken,proto3,oneof"`
}
...
func (*SecretData_DropboxAppAccessToken_) isSecretData_Secret() {}
...
type SecretData_DropboxAppAccessToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SecretData_DropboxAppAccessToken) Reset() {
	*x = SecretData_DropboxAppAccessToken{}
	mi := &file_proto_scan_result_proto_msgTypes[92]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_DropboxAppAccessToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_DropboxAppAccessToken) ProtoMessage() {}

func (x *SecretData_DropboxAppAccessToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[92]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_DropboxAppAccessToken.ProtoReflect.Descriptor instead.
func (*SecretData_DropboxAppAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{62, 17}
}

func (x *SecretData_DropboxAppAccessToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (*SecretData_SquareOAuthApplicationSecret) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{62, 77}
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xe7b\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x18dropbox_app_access_token\x18M \x01(\v2).scalibr.SecretData.DropboxAppAccessTokenH\x00R\x15dropboxAppAccessToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x1a-\n" +
	"\x15DropboxAppAccessToken\x12\x14\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DropboxAppAccessToken)(nil),                // 97: scalibr.SecretData.DropboxAppAccessToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	160, // 61: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	159, // 72: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	159, // 73: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	106, // 87: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	94,  // 88: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	103, // 89: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	104, // 90: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	...
	116, // 93: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	99,  // 94: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	117, // 95: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	118, // 96: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	119, // 97: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	120, // 98: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	109, // 99: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	123, // 100: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	124, // 101: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	125, // 102: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	126, // 103: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	127, // 104: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	110, // 105: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	111, // 106: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	112, // 107: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	114, // 108: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	113, // 109: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	105, // 110: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	102, // 111: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	100, // 112: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	101, // 113: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	88,  // 114: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	121, // 115: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	122, // 116: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	132, // 117: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	133, // 118: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	134, // 119: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	131, // 120: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	91,  // 121: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	115, // 122: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	107, // 123: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	92,  // 124: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	128, // 125: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	129, // 126: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	130, // 127: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	135, // 128: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	136, // 129: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	137, // 130: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	138, // 131: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	139, // 132: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	81,  // 133: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	140, // 134: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	141, // 135: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	143, // 136: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	146, // 137: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	152, // 138: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	142, // 139: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	155, // 140: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	...
	147, // 142: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	...
	153, // 145: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	154, // 146: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	156, // 147: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	157, // 148: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	151, // 149: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	148, // 150: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	98,  // 151: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	144, // 152: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	108, // 153: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	96,  // 154: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	97,  // 155: scalibr.SecretData.dropbox_app_access_token:type_name -> scalibr.SecretData.DropboxAppAccessToken
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[62].OneofWrappers = []any{
		...
		(*SecretData_DropboxAppAccessToken_)(nil),
	}
