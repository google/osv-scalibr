...
=======
func (x *Package) GetChromiumAppsMetadata() *ChromiumAppsMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Package_ChromiumAppsMetadata); ok {
			return x.ChromiumAppsMetadata
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
		}
	}
	return nil
}
...
=======
type Package_ChromiumAppsMetadata struct {
	ChromiumAppsMetadata *ChromiumAppsMetadata `protobuf:"bytes,67,opt,name=chromium_apps_metadata,json=chromiumAppsMetadata,proto3,oneof"`
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
}
...
=======
func (*Package_ChromiumAppsMetadata) isPackage_Metadata() {}
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
...
// The additional data found in Chromium-based app packages (Chrome, Edge, Electron).
type ChromiumAppsMetadata struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The Chromium/Chrome version embedded in the binary (e.g. "137.0.7151.68").
	ChromiumVersion string `protobuf:"bytes,1,opt,name=chromium_version,json=chromiumVersion,proto3" json:"chromium_version,omitempty"`
	// The Electron version (e.g. "34.5.8"), if the app is Electron-based.
	ElectronVersion string `protobuf:"bytes,2,opt,name=electron_version,json=electronVersion,proto3" json:"electron_version,omitempty"`
	// The source used to determine the package version (e.g. "chromium_binary",
	// "path", "plist_cf_bundle_version").
	VersionSource string `protobuf:"bytes,3,opt,name=version_source,json=versionSource,proto3" json:"version_source,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ChromiumAppsMetadata) Reset() {
	*x = ChromiumAppsMetadata{}
	mi := &file_proto_scan_result_proto_msgTypes[75]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ChromiumAppsMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChromiumAppsMetadata) ProtoMessage() {}

func (x *ChromiumAppsMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[75]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChromiumAppsMetadata.ProtoReflect.Descriptor instead.
func (*ChromiumAppsMetadata) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{75}
}

func (x *ChromiumAppsMetadata) GetChromiumVersion() string {
	if x != nil {
...
func (x *ChromiumAppsMetadata) GetElectronVersion() string {
	if x != nil {
		return x.ElectronVersion
	}
	return ""
}

func (x *ChromiumAppsMetadata) GetVersionSource() string {
	if x != nil {
...
func (*SecretData_JWTToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 1}
}
...
func (*SecretData_AnthropicWorkspaceAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 2}
}
...
func (*SecretData_AnthropicModelAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 3}
}
...
func (*SecretData_PerplexityAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 4}
}
...
func (*SecretData_MistralAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 5}
}
...
func (*SecretData_GrokXAIAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 6}
}
...
func (*SecretData_GrokXAIManagementAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 7}
}
...
func (*SecretData_AzureStorageAccountAccessKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 8}
}
...
func (*SecretData_PrivateKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 9}
}
...
func (*SecretData_AzureAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 10}
}
...
func (*SecretData_Pgpass) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 11}
}
...
func (*SecretData_MariaDBCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 12}
}
...
func (*SecretData_AzureIdentityToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 13}
}
...
func (*SecretData_OpenAIAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 14}
}
...
func (*SecretData_DockerHubPat) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 15}
}
...
func (*SecretData_CloudflareAPIToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 16}
}
...
func (*SecretData_DenoPat) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 17}
}
...
func (*SecretData_GitlabPat) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 18}
}
...
func (*SecretData_SlackAppLevelToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 19}
}
...
func (*SecretData_SlackAppConfigAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 20}
}
...
func (*SecretData_SlackAppConfigRefreshToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 21}
}
...
func (*SecretData_PostmanAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 22}
}
...
func (*SecretData_PostmanCollectionAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 23}
}
...
func (*SecretData_OpenRouterAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 24}
}
...
func (*SecretData_DigitalOceanAPIToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 25}
}
...
func (*SecretData_CratesIOAPIToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 26}
}
...
func (*SecretData_NpmJsAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 27}
}
...
func (*SecretData_GithubAppRefreshToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 28}
}
...
func (*SecretData_GithubAppServerToServerToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 29}
}
...
func (*SecretData_GithubClassicPersonalAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 30}
}
...
func (*SecretData_GithubFineGrainedPersonalAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 31}
}
...
func (*SecretData_GithubOAuthToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 32}
}
...
func (*SecretData_GithubAppUserToServerToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 33}
}
...
func (*SecretData_PyPIAPIToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 34}
}
...
func (*SecretData_TinkKeyset) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 35}
}
...
func (*SecretData_HashiCorpVaultToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 36}
}
...
func (*SecretData_HashiCorpVaultAppRoleCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 37}
}
...
func (*SecretData_GCPAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 38}
}
...
func (*SecretData_HuggingfaceAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 39}
}
...
func (*SecretData_HashiCorpCloudPlatformCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 40}
}
...
func (*SecretData_HashiCorpCloudPlatformToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 41}
}
...
func (*SecretData_StripeSecretKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 42}
}
...
func (*SecretData_StripeRestrictedKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 43}
}
...
func (*SecretData_StripeWebhookSecret) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 44}
}
...
func (*SecretData_SupabasePAT) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 45}
}
...
func (*SecretData_SupabaseProjectSecretKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 46}
}
...
func (*SecretData_SupabaseServiceRoleJWT) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 47}
}
...
func (*SecretData_GCPOAuth2ClientCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 48}
}
...
func (*SecretData_GCPOAuth2AccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 49}
}
...
func (*SecretData_GCSHmacKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 50}
}
...
func (*SecretData_MysqlMyloginSection) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 51}
}
...
func (*SecretData_VapidKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 52}
}
...
func (*SecretData_OnePasswordConnectToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 53}
}
...
func (*SecretData_ComposerPackagistCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 54}
}
...
func (*SecretData_PackagistAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 55}
}
...
func (*SecretData_PackagistAPISecret) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 56}
}
...
func (*SecretData_PackagistOrgReadToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 57}
}
...
func (*SecretData_PackagistOrgUpdateToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 58}
}
...
func (*SecretData_PackagistUserUpdateToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 59}
}
...
func (*SecretData_PackagistConductorUpdateToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 60}
}
...
func (*SecretData_OnePasswordSecretKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 61}
}
...
func (*SecretData_OnePasswordServiceToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 62}
}
...
func (*SecretData_OnePasswordRecoveryCode) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 63}
}
...
func (*SecretData_AwsAccessKeyCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 64}
}
...
func (*SecretData_ReCaptchaKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 65}
}
...
func (*SecretData_PyxKeyV1) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 66}
}
...
func (*SecretData_PyxKeyV2) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 67}
}
...
func (*SecretData_CodeCatalystCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 68}
}
...
func (*SecretData_CodeCommitCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 69}
}
...
func (*SecretData_BitBucketCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 70}
}
...
func (*SecretData_ElasticCloudAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 71}
}
...
func (*SecretData_PaystackSecretKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 72}
}
...
func (*SecretData_DiscordBotToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 73}
}
...
func (*SecretData_HerokuSecretKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 74}
}
...
func (*SecretData_HerokuSecretKeyMetadata) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 75}
}
...
func (*SecretData_TelegramBotToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 76}
}
...
func (*SecretData_SendGridAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 78}
}
...
func (*SecretData_SalesforceOAuth2ClientCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 79}
}
...
func (*SecretData_SalesforceOAuth2RefreshCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 80}
}
...
func (*SecretData_SalesforceOAuth2JWTCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 81}
}
...
func (*SecretData_BitwardenOAuth2AccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 82}
}
...
func (*SecretData_CursorAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 83}
}
...
func (*SecretData_CircleCIPersonalAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 84}
}
...
func (*SecretData_CircleCIProjectToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 85}
}
...
func (*SecretData_URLCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 86}
}
...
func (*SecretData_SquarePersonalAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 87}
}
...
func (*SecretData_SquareOAuthApplicationSecret) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 88}
}
...
<<<<<<< HEAD
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xb0 \n" +
=======
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xbf \n" +
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	"\aPackage\x12\x0e\n" +
...
=======
	"\rdeno_metadata\x18B \x01(\v2\x1f.scalibr.JavascriptDenoMetadataH\x00R\fdenoMetadata\x12U\n" +
	"\x16chromium_apps_metadata\x18C \x01(\v2\x1d.scalibr.ChromiumAppsMetadataH\x00R\x14chromiumAppsMetadata\x12[\n" +
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xcbq\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x10base_image_index\x18\x06 \x01(\x05R\x0ebaseImageIndex\"\x93\x01\n" +
	"\x14ChromiumAppsMetadata\x12)\n" +
	"\x10chromium_version\x18\x01 \x01(\tR\x0fchromiumVersion\x12)\n" +
	"\x10electron_version\x18\x02 \x01(\tR\x0felectronVersion\x12%\n" +
	"\x0eversion_source\x18\x03 \x01(\tR\rversionSource*\xf7\x01\n" +
...
<<<<<<< HEAD
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 168)
=======
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 156)
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
...
<<<<<<< HEAD
	(*SpackPackageMetadata)(nil),                  // 36: scalibr.SpackPackageMetadata
	(*KernelModuleMetadata)(nil),                  // 37: scalibr.KernelModuleMetadata
	(*VmlinuzMetadata)(nil),                       // 38: scalibr.VmlinuzMetadata
	(*MacAppsMetadata)(nil),                       // 39: scalibr.MacAppsMetadata
	(*MacportsPackageMetadata)(nil),               // 40: scalibr.MacportsPackageMetadata
	(*SPDXPackageMetadata)(nil),                   // 41: scalibr.SPDXPackageMetadata
	(*CDXPackageMetadata)(nil),                    // 42: scalibr.CDXPackageMetadata
	(*JavaArchiveMetadata)(nil),                   // 43: scalibr.JavaArchiveMetadata
	(*JavaLockfileMetadata)(nil),                  // 44: scalibr.JavaLockfileMetadata
	(*OSVPackageMetadata)(nil),                    // 45: scalibr.OSVPackageMetadata
	(*DepGroupMetadata)(nil),                      // 46: scalibr.DepGroupMetadata
	(*PythonRequirementsMetadata)(nil),            // 47: scalibr.PythonRequirementsMetadata
	(*PythonSetupMetadata)(nil),                   // 48: scalibr.PythonSetupMetadata
	(*NetportsMetadata)(nil),                      // 49: scalibr.NetportsMetadata
	(*ContainerdContainerMetadata)(nil),           // 50: scalibr.ContainerdContainerMetadata
	(*ContainerdRuntimeContainerMetadata)(nil),    // 51: scalibr.ContainerdRuntimeContainerMetadata
	(*WindowsOSVersion)(nil),                      // 52: scalibr.WindowsOSVersion
	(*HomebrewPackageMetadata)(nil),               // 53: scalibr.HomebrewPackageMetadata
	(*ChromeExtensionsMetadata)(nil),              // 54: scalibr.ChromeExtensionsMetadata
	(*VSCodeExtensionsMetadata)(nil),              // 55: scalibr.VSCodeExtensionsMetadata
	(*PodmanMetadata)(nil),                        // 56: scalibr.PodmanMetadata
	(*ChocolateyPackageMetadata)(nil),             // 57: scalibr.ChocolateyPackageMetadata
	(*Protocol)(nil),                              // 58: scalibr.Protocol
	(*DockerContainersMetadata)(nil),              // 59: scalibr.DockerContainersMetadata
	(*AsdfMetadata)(nil),                          // 60: scalibr.AsdfMetadata
	(*MiseMetadata)(nil),                          // 61: scalibr.MiseMetadata
	(*NvmMetadata)(nil),                           // 62: scalibr.NvmMetadata
	(*NodeVersionMetadata)(nil),                   // 63: scalibr.NodeVersionMetadata
	(*BazelMavenMetadata)(nil),                    // 64: scalibr.BazelMavenMetadata
	(*DockerPort)(nil),                            // 65: scalibr.DockerPort
	(*WingetPackageMetadata)(nil),                 // 66: scalibr.WingetPackageMetadata
	(*UnknownBinaryMetadata)(nil),                 // 67: scalibr.UnknownBinaryMetadata
	(*UnknownBinaryAttribution)(nil),              // 68: scalibr.UnknownBinaryAttribution
	(*Secret)(nil),                                // 69: scalibr.Secret
	(*SecretData)(nil),                            // 70: scalibr.SecretData
	(*SecretStatus)(nil),                          // 71: scalibr.SecretStatus
	(*Location)(nil),                              // 72: scalibr.Location
	(*Filepath)(nil),                              // 73: scalibr.Filepath
	(*FilepathWithLayerDetails)(nil),              // 74: scalibr.FilepathWithLayerDetails
	(*EnvironmentVariable)(nil),                   // 75: scalibr.EnvironmentVariable
	(*ContainerCommand)(nil),                      // 76: scalibr.ContainerCommand
	(*ContainerImageMetadata)(nil),                // 77: scalibr.ContainerImageMetadata
	(*BaseImageChain)(nil),                        // 78: scalibr.BaseImageChain
	(*BaseImageDetails)(nil),                      // 79: scalibr.BaseImageDetails
	(*LayerMetadata)(nil),                         // 80: scalibr.LayerMetadata
=======
	...
	(*ChromiumAppsMetadata)(nil),                  // 80: scalibr.ChromiumAppsMetadata
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	(*Package_ContainerImageMetadataIndexes)(nil), // 81: scalibr.Package.ContainerImageMetadataIndexes
	nil,                         // 82: scalibr.PodmanMetadata.ExposedPortsEntry
	(*SecretData_GCPSAK)(nil),   // 83: scalibr.SecretData.GCPSAK
	(*SecretData_JWTToken)(nil), // 84: scalibr.SecretData.JWTToken
...
<<<<<<< HEAD
	...
	(*SecretData_ComposerPackagistCredentials)(nil),         // 137: scalibr.SecretData.ComposerPackagistCredentials
	(*SecretData_PackagistAPIKey)(nil),                      // 138: scalibr.SecretData.PackagistAPIKey
	(*SecretData_PackagistAPISecret)(nil),                   // 139: scalibr.SecretData.PackagistAPISecret
	(*SecretData_PackagistOrgReadToken)(nil),                // 140: scalibr.SecretData.PackagistOrgReadToken
	(*SecretData_PackagistOrgUpdateToken)(nil),              // 141: scalibr.SecretData.PackagistOrgUpdateToken
	(*SecretData_PackagistUserUpdateToken)(nil),             // 142: scalibr.SecretData.PackagistUserUpdateToken
	(*SecretData_PackagistConductorUpdateToken)(nil),        // 143: scalibr.SecretData.PackagistConductorUpdateToken
	(*SecretData_OnePasswordSecretKey)(nil),                 // 144: scalibr.SecretData.OnePasswordSecretKey
	(*SecretData_OnePasswordServiceToken)(nil),              // 145: scalibr.SecretData.OnePasswordServiceToken
	(*SecretData_OnePasswordRecoveryCode)(nil),              // 146: scalibr.SecretData.OnePasswordRecoveryCode
	(*SecretData_AwsAccessKeyCredentials)(nil),              // 147: scalibr.SecretData.AwsAccessKeyCredentials
	(*SecretData_ReCaptchaKey)(nil),                         // 148: scalibr.SecretData.ReCaptchaKey
	(*SecretData_PyxKeyV1)(nil),                             // 149: scalibr.SecretData.PyxKeyV1
	(*SecretData_PyxKeyV2)(nil),                             // 150: scalibr.SecretData.PyxKeyV2
	(*SecretData_CodeCatalystCredentials)(nil),              // 151: scalibr.SecretData.CodeCatalystCredentials
	(*SecretData_CodeCommitCredentials)(nil),                // 152: scalibr.SecretData.CodeCommitCredentials
	(*SecretData_BitBucketCredentials)(nil),                 // 153: scalibr.SecretData.BitBucketCredentials
	(*SecretData_ElasticCloudAPIKey)(nil),                   // 154: scalibr.SecretData.ElasticCloudAPIKey
	(*SecretData_PaystackSecretKey)(nil),                    // 155: scalibr.SecretData.PaystackSecretKey
	(*SecretData_DiscordBotToken)(nil),                      // 156: scalibr.SecretData.DiscordBotToken
	(*SecretData_HerokuSecretKey)(nil),                      // 157: scalibr.SecretData.HerokuSecretKey
	(*SecretData_HerokuSecretKeyMetadata)(nil),              // 158: scalibr.SecretData.HerokuSecretKeyMetadata
	(*SecretData_TelegramBotToken)(nil),                     // 159: scalibr.SecretData.TelegramBotToken
	(*SecretData_SalesforceOAuth2AccessToken)(nil),          // 160: scalibr.SecretData.SalesforceOAuth2AccessToken
	(*SecretData_SendGridAPIKey)(nil),                       // 161: scalibr.SecretData.SendGridAPIKey
	(*SecretData_SalesforceOAuth2ClientCredentials)(nil),    // 162: scalibr.SecretData.SalesforceOAuth2ClientCredentials
	(*SecretData_SalesforceOAuth2RefreshCredentials)(nil),   // 163: scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	(*SecretData_SalesforceOAuth2JWTCredentials)(nil),       // 164: scalibr.SecretData.SalesforceOAuth2JWTCredentials
	(*SecretData_BitwardenOAuth2AccessToken)(nil),           // 165: scalibr.SecretData.BitwardenOAuth2AccessToken
	(*SecretData_CursorAPIKey)(nil),                         // 166: scalibr.SecretData.CursorAPIKey
	(*SecretData_CircleCIPersonalAccessToken)(nil),          // 167: scalibr.SecretData.CircleCIPersonalAccessToken
	(*SecretData_CircleCIProjectToken)(nil),                 // 168: scalibr.SecretData.CircleCIProjectToken
	...
	nil,                             // 172: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil),   // 173: google.protobuf.Timestamp
	(*osvschema.Vulnerability)(nil), // 174: osv.Vulnerability
	(*durationpb.Duration)(nil),     // 175: google.protobuf.Duration
}
var file_proto_scan_result_proto_depIdxs = []int32{
	173, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	173, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
=======
	(*SecretData_GCPOAuth2ClientCredentials)(nil),           // 128: scalibr.SecretData.GCPOAuth2ClientCredentials
	(*SecretData_GCPOAuth2AccessToken)(nil),                 // 129: scalibr.SecretData.GCPOAuth2AccessToken
	(*SecretData_GCSHmacKey)(nil),                           // 130: scalibr.SecretData.GCSHmacKey
	(*SecretData_MysqlMyloginSection)(nil),                  // 131: scalibr.SecretData.MysqlMyloginSection
	(*SecretData_VapidKey)(nil),                             // 132: scalibr.SecretData.VapidKey
	(*SecretData_OnePasswordConnectToken)(nil),              // 133: scalibr.SecretData.OnePasswordConnectToken
	(*SecretData_OnePasswordSecretKey)(nil),                 // 134: scalibr.SecretData.OnePasswordSecretKey
	(*SecretData_OnePasswordServiceToken)(nil),              // 135: scalibr.SecretData.OnePasswordServiceToken
	(*SecretData_OnePasswordRecoveryCode)(nil),              // 136: scalibr.SecretData.OnePasswordRecoveryCode
	(*SecretData_AwsAccessKeyCredentials)(nil),              // 137: scalibr.SecretData.AwsAccessKeyCredentials
	(*SecretData_ReCaptchaKey)(nil),                         // 138: scalibr.SecretData.ReCaptchaKey
	(*SecretData_PyxKeyV1)(nil),                             // 139: scalibr.SecretData.PyxKeyV1
	(*SecretData_PyxKeyV2)(nil),                             // 140: scalibr.SecretData.PyxKeyV2
	(*SecretData_CodeCatalystCredentials)(nil),              // 141: scalibr.SecretData.CodeCatalystCredentials
	(*SecretData_CodeCommitCredentials)(nil),                // 142: scalibr.SecretData.CodeCommitCredentials
	(*SecretData_BitBucketCredentials)(nil),                 // 143: scalibr.SecretData.BitBucketCredentials
	(*SecretData_ElasticCloudAPIKey)(nil),                   // 144: scalibr.SecretData.ElasticCloudAPIKey
	(*SecretData_PaystackSecretKey)(nil),                    // 145: scalibr.SecretData.PaystackSecretKey
	(*SecretData_HerokuSecretKey)(nil),                      // 146: scalibr.SecretData.HerokuSecretKey
	(*SecretData_HerokuSecretKeyMetadata)(nil),              // 147: scalibr.SecretData.HerokuSecretKeyMetadata
	(*SecretData_TelegramBotToken)(nil),                     // 148: scalibr.SecretData.TelegramBotToken
	(*SecretData_SalesforceOAuth2AccessToken)(nil),          // 149: scalibr.SecretData.SalesforceOAuth2AccessToken
	(*SecretData_SendGridAPIKey)(nil),                       // 150: scalibr.SecretData.SendGridAPIKey
	(*SecretData_SalesforceOAuth2ClientCredentials)(nil),    // 151: scalibr.SecretData.SalesforceOAuth2ClientCredentials
	(*SecretData_SalesforceOAuth2RefreshCredentials)(nil),   // 152: scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	(*SecretData_SalesforceOAuth2JWTCredentials)(nil),       // 153: scalibr.SecretData.SalesforceOAuth2JWTCredentials
	(*SecretData_CursorAPIKey)(nil),                         // 154: scalibr.SecretData.CursorAPIKey
	(*SecretData_CircleCIPersonalAccessToken)(nil),          // 155: scalibr.SecretData.CircleCIPersonalAccessToken
	(*SecretData_CircleCIProjectToken)(nil),                 // 156: scalibr.SecretData.CircleCIProjectToken
	(*SecretData_URLCredentials)(nil),                       // 157: scalibr.SecretData.URLCredentials
	(*SecretData_SquarePersonalAccessToken)(nil),            // 158: scalibr.SecretData.SquarePersonalAccessToken
	(*SecretData_SquareOAuthApplicationSecret)(nil),         // 159: scalibr.SecretData.SquareOAuthApplicationSecret
	nil,                             // 160: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil),   // 161: google.protobuf.Timestamp
	(*osvschema.Vulnerability)(nil), // 162: osv.Vulnerability
	(*durationpb.Duration)(nil),     // 163: google.protobuf.Duration
}
var file_proto_scan_result_proto_depIdxs = []int32{
	161, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	161, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	...
	69,  // 8: scalibr.Inventory.secrets:type_name -> scalibr.Secret
	77,  // 9: scalibr.Inventory.container_image_metadata:type_name -> scalibr.ContainerImageMetadata
	...
	41,  // 22: scalibr.Package.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	43,  // 23: scalibr.Package.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	44,  // 24: scalibr.Package.java_lockfile_metadata:type_name -> scalibr.JavaLockfileMetadata
	...
	37,  // 27: scalibr.Package.kernel_module_metadata:type_name -> scalibr.KernelModuleMetadata
	38,  // 28: scalibr.Package.vmlinuz_metadata:type_name -> scalibr.VmlinuzMetadata
	34,  // 29: scalibr.Package.portage_metadata:type_name -> scalibr.PortagePackageMetadata
	45,  // 30: scalibr.Package.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	49,  // 31: scalibr.Package.netports_metadata:type_name -> scalibr.NetportsMetadata
	47,  // 32: scalibr.Package.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	48,  // 33: scalibr.Package.python_setup_metadata:type_name -> scalibr.PythonSetupMetadata
	50,  // 34: scalibr.Package.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	...
	39,  // 37: scalibr.Package.mac_apps_metadata:type_name -> scalibr.MacAppsMetadata
	51,  // 38: scalibr.Package.containerd_runtime_container_metadata:type_name -> scalibr.ContainerdRuntimeContainerMetadata
	42,  // 39: scalibr.Package.cdx_metadata:type_name -> scalibr.CDXPackageMetadata
	52,  // 40: scalibr.Package.windows_os_version_metadata:type_name -> scalibr.WindowsOSVersion
	53,  // 41: scalibr.Package.homebrew_metadata:type_name -> scalibr.HomebrewPackageMetadata
	54,  // 42: scalibr.Package.chrome_extensions_metadata:type_name -> scalibr.ChromeExtensionsMetadata
	55,  // 43: scalibr.Package.vscode_extensions_metadata:type_name -> scalibr.VSCodeExtensionsMetadata
	56,  // 44: scalibr.Package.podman_metadata:type_name -> scalibr.PodmanMetadata
	59,  // 45: scalibr.Package.docker_containers_metadata:type_name -> scalibr.DockerContainersMetadata
	40,  // 46: scalibr.Package.macports_metadata:type_name -> scalibr.MacportsPackageMetadata
	66,  // 47: scalibr.Package.winget_metadata:type_name -> scalibr.WingetPackageMetadata
	60,  // 48: scalibr.Package.asdf_metadata:type_name -> scalibr.AsdfMetadata
	62,  // 49: scalibr.Package.nvm_metadata:type_name -> scalibr.NvmMetadata
	63,  // 50: scalibr.Package.nodeversion_metadata:type_name -> scalibr.NodeVersionMetadata
	46,  // 51: scalibr.Package.dep_group_metadata:type_name -> scalibr.DepGroupMetadata
	57,  // 52: scalibr.Package.chocolatey_metadata:type_name -> scalibr.ChocolateyPackageMetadata
	61,  // 53: scalibr.Package.mise_metadata:type_name -> scalibr.MiseMetadata
	67,  // 54: scalibr.Package.unknown_binary_metadata:type_name -> scalibr.UnknownBinaryMetadata
	64,  // 55: scalibr.Package.bazel_maven_metadata:type_name -> scalibr.BazelMavenMetadata
	25,  // 56: scalibr.Package.deno_metadata:type_name -> scalibr.JavascriptDenoMetadata
<<<<<<< HEAD
	36,  // 57: scalibr.Package.spack_metadata:type_name -> scalibr.SpackPackageMetadata
=======
	80,  // 57: scalibr.Package.chromium_apps_metadata:type_name -> scalibr.ChromiumAppsMetadata
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	13,  // 58: scalibr.Package.exploitability_signals:type_name -> scalibr.PackageExploitabilitySignal
	81,  // 59: scalibr.Package.container_image_metadata_indexes:type_name -> scalibr.Package.ContainerImageMetadataIndexes
	0,   // 60: scalibr.PackageExploitabilitySignal.justification:type_name -> scalibr.VexJustification
...
<<<<<<< HEAD
	174, // 64: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
=======
	162, // 64: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	...
	15,  // 68: scalibr.GenericFinding.exploitability_signals:type_name -> scalibr.FindingExploitabilitySignal
	21,  // 69: scalibr.GenericFindingAdvisory.id:type_name -> scalibr.AdvisoryId
	1,   // 70: scalibr.GenericFindingAdvisory.sev:type_name -> scalibr.SeverityEnum
	2,   // 71: scalibr.JavascriptPackageJSONMetadata.source:type_name -> scalibr.PackageSource
...
<<<<<<< HEAD
	173, // 75: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	173, // 76: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	71,  // 80: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	72,  // 81: scalibr.Secret.locations:type_name -> scalibr.Location
=======
	161, // 75: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	161, // 76: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	64,  // 77: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	67,  // 78: scalibr.UnknownBinaryMetadata.attribution:type_name -> scalibr.UnknownBinaryAttribution
	69,  // 79: scalibr.Secret.secret:type_name -> scalibr.SecretData
	70,  // 80: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	71,  // 81: scalibr.Secret.locations:type_name -> scalibr.Location
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	83,  // 82: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	85,  // 83: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	86,  // 84: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	87,  // 85: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	92,  // 86: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	89,  // 87: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	90,  // 88: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	98,  // 89: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	108, // 90: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	97,  // 91: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	105, // 92: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	106, // 93: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	93,  // 94: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	96,  // 95: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	118, // 96: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	101, // 97: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	119, // 98: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	120, // 99: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	121, // 100: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	122, // 101: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	111, // 102: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	125, // 103: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	126, // 104: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	127, // 105: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
<<<<<<< HEAD
	131, // 106: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	132, // 107: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
=======
	128, // 106: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	129, // 107: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	112, // 108: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	113, // 109: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	114, // 110: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	116, // 111: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	115, // 112: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	107, // 113: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	104, // 114: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	102, // 115: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	103, // 116: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	91,  // 117: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	123, // 118: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	124, // 119: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
<<<<<<< HEAD
	144, // 120: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	145, // 121: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	146, // 122: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	136, // 123: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
=======
	134, // 120: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	135, // 121: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	136, // 122: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	133, // 123: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	94,  // 124: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	117, // 125: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	109, // 126: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	95,  // 127: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
<<<<<<< HEAD
	133, // 128: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	134, // 129: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	135, // 130: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	147, // 131: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	148, // 132: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	149, // 133: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	150, // 134: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	151, // 135: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	84,  // 136: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	152, // 137: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	153, // 138: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	155, // 139: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	159, // 140: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	166, // 141: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	154, // 142: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	169, // 143: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	162, // 144: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	160, // 145: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	163, // 146: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	88,  // 147: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	167, // 148: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	168, // 149: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	170, // 150: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	171, // 151: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	164, // 152: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	161, // 153: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	100, // 154: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	157, // 155: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	110, // 156: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	99,  // 157: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	128, // 158: scalibr.SecretData.supabase_pat:type_name -> scalibr.SecretData.SupabasePAT
	129, // 159: scalibr.SecretData.supabase_project_secret_key:type_name -> scalibr.SecretData.SupabaseProjectSecretKey
	130, // 160: scalibr.SecretData.supabase_service_role_jwt:type_name -> scalibr.SecretData.SupabaseServiceRoleJWT
	138, // 161: scalibr.SecretData.packagist_api_key:type_name -> scalibr.SecretData.PackagistAPIKey
	139, // 162: scalibr.SecretData.packagist_api_secret:type_name -> scalibr.SecretData.PackagistAPISecret
	140, // 163: scalibr.SecretData.packagist_org_read_token:type_name -> scalibr.SecretData.PackagistOrgReadToken
	141, // 164: scalibr.SecretData.packagist_org_update_token:type_name -> scalibr.SecretData.PackagistOrgUpdateToken
	142, // 165: scalibr.SecretData.packagist_user_update_token:type_name -> scalibr.SecretData.PackagistUserUpdateToken
	143, // 166: scalibr.SecretData.packagist_conductor_update_token:type_name -> scalibr.SecretData.PackagistConductorUpdateToken
	...
	4,   // 170: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	173, // 171: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	73,  // 172: scalibr.Location.filepath:type_name -> scalibr.Filepath
	74,  // 173: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	75,  // 174: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	76,  // 175: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 176: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	80,  // 177: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	78,  // 178: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	172, // 179: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	79,  // 180: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	58,  // 181: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	158, // 182: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	175, // 183: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
...
=======
	130, // 128: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	131, // 129: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	132, // 130: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	137, // 131: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	138, // 132: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	139, // 133: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	140, // 134: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	141, // 135: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	84,  // 136: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	142, // 137: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	143, // 138: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	145, // 139: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	148, // 140: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	154, // 141: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	144, // 142: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	157, // 143: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	151, // 144: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	149, // 145: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	152, // 146: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	88,  // 147: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	155, // 148: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	156, // 149: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	158, // 150: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	159, // 151: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	153, // 152: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	150, // 153: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	100, // 154: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	146, // 155: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	110, // 156: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	99,  // 157: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	4,   // 158: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	161, // 159: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	72,  // 160: scalibr.Location.filepath:type_name -> scalibr.Filepath
	73,  // 161: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	74,  // 162: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	75,  // 163: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 164: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	79,  // 165: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	77,  // 166: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	160, // 167: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	78,  // 168: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	...
	163, // 171: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
...
=======
		(*Package_ChromiumAppsMetadata)(nil),
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	}
...
<<<<<<< HEAD
	file_proto_scan_result_proto_msgTypes[152].OneofWrappers = []any{}
=======
	file_proto_scan_result_proto_msgTypes[141].OneofWrappers = []any{}
>>>>>>> 8f287e34 (Add proto serialization support for chromiumapps.Metadata.)
	type x struct{}
