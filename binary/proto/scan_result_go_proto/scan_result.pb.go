...
func (x *SecretData) GetDatabricksUserAccountOauth2ClientCredentials() *DatabricksUserAccountOAuth2ClientCredentials {
	if x != nil {
...
type SecretData_DatabricksUserAccountOauth2ClientCredentials struct {
	DatabricksUserAccountOauth2ClientCredentials *DatabricksUserAccountOAuth2ClientCredentials `protobuf:"bytes,75,opt,name=databricks_user_account_oauth2_client_credentials,json=databricksUserAccountOauth2ClientCredentials,proto3,oneof"`
}
...
type DatabricksUserAccountOAuth2ClientCredentials struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DatabricksUserAccountOAuth2ClientCredentials) Reset() {
	*x = DatabricksUserAccountOAuth2ClientCredentials{}
	mi := &file_proto_scan_result_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DatabricksUserAccountOAuth2ClientCredentials) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatabricksUserAccountOAuth2ClientCredentials) ProtoMessage() {}

func (x *DatabricksUserAccountOAuth2ClientCredentials) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatabricksUserAccountOAuth2ClientCredentials.ProtoReflect.Descriptor instead.
func (*DatabricksUserAccountOAuth2ClientCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{63}
}

func (x *DatabricksUserAccountOAuth2ClientCredentials) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *DatabricksUserAccountOAuth2ClientCredentials) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *DatabricksUserAccountOAuth2ClientCredentials) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xed`\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11heroku_secret_key\x18J \x01(\v2#.scalibr.SecretData.HerokuSecretKeyH\x00R\x0fherokuSecretKey\x12\xa0\x01\n" +
	"1databricks_user_account_oauth2_client_credentials\x18K \x01(\v25.scalibr.DatabricksUserAccountOAuth2ClientCredentialsH\x00R,databricksUserAccountOauth2ClientCredentials\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x06secret\"u\n" +
	",DatabricksUserAccountOAuth2ClientCredentials\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\tR\x06secret\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"account_id\x18\x03 \x01(\tR\taccountId\"\xf8\x01\n" +
	"\fSecretStatus\x12>\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*DatabricksUserAccountOAuth2ClientCredentials)(nil), // 68: scalibr.DatabricksUserAccountOAuth2ClientCredentials
	...
	(*SecretData_GithubAppRefreshToken)(nil),                // 107: scalibr.SecretData.GithubAppRefreshToken
	(*SecretData_GithubAppServerToServerToken)(nil),         // 108: scalibr.SecretData.GithubAppServerToServerToken
	(*SecretData_GithubClassicPersonalAccessToken)(nil),     // 109: scalibr.SecretData.GithubClassicPersonalAccessToken
	(*SecretData_GithubFineGrainedPersonalAccessToken)(nil), // 110: scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	(*SecretData_GithubOAuthToken)(nil),                     // 111: scalibr.SecretData.GithubOAuthToken
	(*SecretData_GithubAppUserToServerToken)(nil),           // 112: scalibr.SecretData.GithubAppUserToServerToken
	(*SecretData_PyPIAPIToken)(nil),                         // 113: scalibr.SecretData.PyPIAPIToken
	(*SecretData_TinkKeyset)(nil),                           // 114: scalibr.SecretData.TinkKeyset
	(*SecretData_HashiCorpVaultToken)(nil),                  // 115: scalibr.SecretData.HashiCorpVaultToken
	(*SecretData_HashiCorpVaultAppRoleCredentials)(nil),     // 116: scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	(*SecretData_GCPAPIKey)(nil),                            // 117: scalibr.SecretData.GCPAPIKey
	(*SecretData_HuggingfaceAPIKey)(nil),                    // 118: scalibr.SecretData.HuggingfaceAPIKey
	(*SecretData_HashiCorpCloudPlatformCredentials)(nil),    // 119: scalibr.SecretData.HashiCorpCloudPlatformCredentials
	(*SecretData_HashiCorpCloudPlatformToken)(nil),          // 120: scalibr.SecretData.HashiCorpCloudPlatformToken
	(*SecretData_StripeSecretKey)(nil),                      // 121: scalibr.SecretData.StripeSecretKey
	(*SecretData_StripeRestrictedKey)(nil),                  // 122: scalibr.SecretData.StripeRestrictedKey
	(*SecretData_StripeWebhookSecret)(nil),                  // 123: scalibr.SecretData.StripeWebhookSecret
	(*SecretData_GCPOAuth2ClientCredentials)(nil),           // 124: scalibr.SecretData.GCPOAuth2ClientCredentials
	(*SecretData_GCPOAuth2AccessToken)(nil),                 // 125: scalibr.SecretData.GCPOAuth2AccessToken
	(*SecretData_GCSHmacKey)(nil),                           // 126: scalibr.SecretData.GCSHmacKey
	(*SecretData_MysqlMyloginSection)(nil),                  // 127: scalibr.SecretData.MysqlMyloginSection
	(*SecretData_VapidKey)(nil),                             // 128: scalibr.SecretData.VapidKey
	(*SecretData_OnePasswordConnectToken)(nil),              // 129: scalibr.SecretData.OnePasswordConnectToken
	(*SecretData_OnePasswordSecretKey)(nil),                 // 130: scalibr.SecretData.OnePasswordSecretKey
	(*SecretData_OnePasswordServiceToken)(nil),              // 131: scalibr.SecretData.OnePasswordServiceToken
	(*SecretData_OnePasswordRecoveryCode)(nil),              // 132: scalibr.SecretData.OnePasswordRecoveryCode
	(*SecretData_AwsAccessKeyCredentials)(nil),              // 133: scalibr.SecretData.AwsAccessKeyCredentials
	(*SecretData_ReCaptchaKey)(nil),                         // 134: scalibr.SecretData.ReCaptchaKey
	(*SecretData_PyxKeyV1)(nil),                             // 135: scalibr.SecretData.PyxKeyV1
	(*SecretData_PyxKeyV2)(nil),                             // 136: scalibr.SecretData.PyxKeyV2
	(*SecretData_CodeCatalystCredentials)(nil),              // 137: scalibr.SecretData.CodeCatalystCredentials
	(*SecretData_CodeCommitCredentials)(nil),                // 138: scalibr.SecretData.CodeCommitCredentials
	(*SecretData_BitBucketCredentials)(nil),                 // 139: scalibr.SecretData.BitBucketCredentials
	(*SecretData_ElasticCloudAPIKey)(nil),                   // 140: scalibr.SecretData.ElasticCloudAPIKey
	(*SecretData_PaystackSecretKey)(nil),                    // 141: scalibr.SecretData.PaystackSecretKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	79,  // 56: scalibr.Package.container_image_metadata_indexes:type_name -> scalibr.Package.ContainerImageMetadataIndexes
	...
	80,  // 71: scalibr.PodmanMetadata.exposed_ports:type_name -> scalibr.PodmanMetadata.ExposedPortsEntry
	...
	69,  // 77: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	70,  // 78: scalibr.Secret.locations:type_name -> scalibr.Location
	81,  // 79: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	...
	114, // 93: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	98,  // 94: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	115, // 95: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	116, // 96: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	117, // 97: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	118, // 98: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	107, // 99: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	121, // 100: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	122, // 101: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	123, // 102: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	124, // 103: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	125, // 104: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	108, // 105: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	109, // 106: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	110, // 107: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	112, // 108: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	111, // 109: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	...
	119, // 115: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	120, // 116: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	130, // 117: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	131, // 118: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	132, // 119: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	129, // 120: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	92,  // 121: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	113, // 122: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	...
	126, // 125: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	127, // 126: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	128, // 127: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	133, // 128: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	134, // 129: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	135, // 130: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	136, // 131: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	137, // 132: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	82,  // 133: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	138, // 134: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	139, // 135: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	141, // 136: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	...
	140, // 139: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	...
	68,  // 153: scalibr.SecretData.databricks_user_account_oauth2_client_credentials:type_name -> scalibr.DatabricksUserAccountOAuth2ClientCredentials
	...
	71,  // 156: scalibr.Location.filepath:type_name -> scalibr.Filepath
	72,  // 157: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	73,  // 158: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	74,  // 159: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 160: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	78,  // 161: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	76,  // 162: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	156, // 163: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	77,  // 164: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
