...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x95@\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\tvapid_key\x181 \x01(\v2\x1c.scalibr.SecretData.VapidKeyH\x00R\bvapidKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	nil,                           // 122: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil), // 123: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	123, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	...
	4,   // 119: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	123, // 120: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	64,  // 121: scalibr.Location.filepath:type_name -> scalibr.Filepath
	65,  // 122: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	66,  // 123: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	67,  // 124: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 125: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	71,  // 126: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	69,  // 127: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	122, // 128: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	70,  // 129: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	53,  // 130: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
