...
type Package_ChromiumAppsMetadata struct {
	ChromiumAppsMetadata *ChromiumAppsMetadata `protobuf:"bytes,69,opt,name=chromium_apps_metadata,json=chromiumAppsMetadata,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xbd!\n" +
	"\aPackage\x12\x0e\n" +
	...
	"\x16chromium_apps_metadata\x18E \x01(\v2\x1d.scalibr.ChromiumAppsMetadataH\x00R\x14chromiumAppsMetadata\x12[\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*ChromiumAppsMetadata)(nil),                  // 84: scalibr.ChromiumAppsMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	84,  // 59: scalibr.Package.chromium_apps_metadata:type_name -> scalibr.ChromiumAppsMetadata
