...
type SecretData_CloudflareApiToken struct {
	CloudflareApiToken *SecretData_CloudflareAPIToken `protobuf:"bytes,44,opt,name=cloudflare_api_token,json=cloudflareApiToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xbf9\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x06pgpass\x18+ \x01(\v2\x1a.scalibr.SecretData.PgpassH\x00R\x06pgpass\x12Z\n" +
	"\x14cloudflare_api_token\x18, \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_AzureIdentityToken)(nil),                   // 83: scalibr.SecretData.AzureIdentityToken
	(*SecretData_OpenAIAPIKey)(nil),                         // 84: scalibr.SecretData.OpenAIAPIKey
	(*SecretData_DockerHubPat)(nil),                         // 85: scalibr.SecretData.DockerHubPat
	(*SecretData_CloudflareAPIToken)(nil),                   // 86: scalibr.SecretData.CloudflareAPIToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	85,  // 79: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	93,  // 80: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	84,  // 81: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	...
	83,  // 85: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	...
	86,  // 114: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
