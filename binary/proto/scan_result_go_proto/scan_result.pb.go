...
type SecretData_DatabricksUserAccountOauth2ClientCredentials struct {
	DatabricksUserAccountOauth2ClientCredentials *SecretData_DatabricksUserAccountOAuth2ClientCredentials `protobuf:"bytes,88,opt,name=databricks_user_account_oauth2_client_credentials,json=databricksUserAccountOauth2ClientCredentials,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x9br\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11discord_bot_token\x18W \x01(\v2#.scalibr.SecretData.DiscordBotTokenH\x00R\x0fdiscordBotToken\x12\xab\x01\n" +
	"1databricks_user_account_oauth2_client_credentials\x18X \x01(\v2@.scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentialsH\x00R,databricksUserAccountOauth2ClientCredentials\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DatabricksUserAccountOAuth2ClientCredentials)(nil), // 170: scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	170, // 168: scalibr.SecretData.databricks_user_account_oauth2_client_credentials:type_name -> scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentials
