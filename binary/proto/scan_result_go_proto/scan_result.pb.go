...
type Package_BazelMavenMetadata struct {
	BazelMavenMetadata *BazelMavenMetadata `protobuf:"bytes,56,opt,name=bazel_maven_metadata,json=bazelMavenMetadata,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\x06status\x18\x03 \x01(\v2\x13.scalibr.ScanStatusR\x06status\"\xb0\x1b\n" +
	"\aPackage\x12\x12\n" +
	...
	"\rasdf_metadata\x187 \x01(\v2\x15.scalibr.AsdfMetadataH\x00R\fasdfMetadata\x12O\n" +
	"\x14bazel_maven_metadata\x188 \x01(\v2\x1b.scalibr.BazelMavenMetadataH\x00R\x12bazelMavenMetadata\x12Z\n" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xa3\v\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x0edocker_hub_pat\x18\b \x01(\v2 .scalibr.SecretData.DockerHubPatH\x00R\fdockerHubPat\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*BazelMavenMetadata)(nil),                  // 55: scalibr.BazelMavenMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	75, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	75, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	55, // 48: scalibr.Package.bazel_maven_metadata:type_name -> scalibr.BazelMavenMetadata
	...
	75, // 64: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	75, // 65: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	4,  // 78: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	75, // 79: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	62, // 80: scalibr.Location.filepath:type_name -> scalibr.Filepath
	63, // 81: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	64, // 82: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	65, // 83: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11, // 84: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	52, // 85: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
