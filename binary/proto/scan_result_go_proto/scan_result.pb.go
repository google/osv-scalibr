...
func (x *Package) GetAndroidApkMetadata() *AndroidApkMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Package_AndroidApkMetadata); ok {
			return x.AndroidApkMetadata
		}
	}
	return nil
}
...
type Package_AndroidApkMetadata struct {
	AndroidApkMetadata *AndroidApkMetadata `protobuf:"bytes,71,opt,name=android_apk_metadata,json=androidApkMetadata,proto3,oneof"`
}
...
func (*Package_AndroidApkMetadata) isPackage_Metadata() {}
...
// The additional data found in Android Apk files.
type AndroidApkMetadata struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *AndroidApkMetadata) Reset() {
	*x = AndroidApkMetadata{}
	mi := &file_proto_scan_result_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AndroidApkMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AndroidApkMetadata) ProtoMessage() {}

func (x *AndroidApkMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AndroidApkMetadata.ProtoReflect.Descriptor instead.
func (*AndroidApkMetadata) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{40}
}

func (x *AndroidApkMetadata) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *AndroidApkMetadata) GetArtifactId() string {
	if x != nil {
		return x.ArtifactId
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xa9\"\n" +
	"\aPackage\x12\x0e\n" +
	...
	"\x0espack_metadata\x18C \x01(\v2\x1d.scalibr.SpackPackageMetadataH\x00R\rspackMetadata\x12O\n" +
	"\x14android_apk_metadata\x18G \x01(\v2\x1b.scalibr.AndroidApkMetadataH\x00R\x12androidApkMetadata\x12[\n" +
	...
	"\x04sha1\x18\x04 \x01(\tR\x04sha1\"P\n" +
	"\x12AndroidApkMetadata\x12\x19\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 180)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*AndroidApkMetadata)(nil),                    // 47: scalibr.AndroidApkMetadata
	...
	(*SecretData_HTTPCookie)(nil),                           // 177: scalibr.SecretData.HTTPCookie
	(*SecretData_CursorAPIKey)(nil),                         // 178: scalibr.SecretData.CursorAPIKey
	(*SecretData_CircleCIPersonalAccessToken)(nil),          // 179: scalibr.SecretData.CircleCIPersonalAccessToken
	(*SecretData_CircleCIProjectToken)(nil),                 // 180: scalibr.SecretData.CircleCIProjectToken
	(*SecretData_URLCredentials)(nil),                       // 181: scalibr.SecretData.URLCredentials
	(*SecretData_SquarePersonalAccessToken)(nil),            // 182: scalibr.SecretData.SquarePersonalAccessToken
	(*SecretData_SquareOAuthApplicationSecret)(nil),         // 183: scalibr.SecretData.SquareOAuthApplicationSecret
	nil,                             // 184: scalibr.SecretData.HTTPCookie.ValuesEntry
	nil,                             // 185: scalibr.ContainerImageMetadata.OsInfoEntry
	nil,                             // 186: scalibr.ContainerImageMetadata.LabelsEntry
	(*timestamppb.Timestamp)(nil),   // 187: google.protobuf.Timestamp
	(*anypb.Any)(nil),               // 188: google.protobuf.Any
	(*osvschema.Vulnerability)(nil), // 189: osv.Vulnerability
	(*durationpb.Duration)(nil),     // 190: google.protobuf.Duration
}
var file_proto_scan_result_proto_depIdxs = []int32{
	187, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	187, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	188, // 17: scalibr.Package.metadata_any:type_name -> google.protobuf.Any
	...
	47,  // 61: scalibr.Package.android_apk_metadata:type_name -> scalibr.AndroidApkMetadata
	...
	81,  // 64: scalibr.PackageLocation.desc:type_name -> scalibr.Location
	81,  // 65: scalibr.PackageLocation.related:type_name -> scalibr.Location
	...
	189, // 70: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	187, // 81: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	187, // 82: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	69,  // 83: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	72,  // 84: scalibr.UnknownBinaryMetadata.attribution:type_name -> scalibr.UnknownBinaryAttribution
	74,  // 85: scalibr.Secret.secret:type_name -> scalibr.SecretData
	75,  // 86: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	76,  // 87: scalibr.Secret.locations:type_name -> scalibr.LocationLegacy
	81,  // 88: scalibr.Secret.location:type_name -> scalibr.Location
	...
	178, // 148: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	162, // 149: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	181, // 150: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	...
	179, // 155: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	180, // 156: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	182, // 157: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	183, // 158: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	...
	177, // 180: scalibr.SecretData.http_cookie:type_name -> scalibr.SecretData.HTTPCookie
	6,   // 181: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	187, // 182: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	77,  // 183: scalibr.LocationLegacy.filepath:type_name -> scalibr.Filepath
	78,  // 184: scalibr.LocationLegacy.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	79,  // 185: scalibr.LocationLegacy.environment_variable:type_name -> scalibr.EnvironmentVariable
	80,  // 186: scalibr.LocationLegacy.container_command:type_name -> scalibr.ContainerCommand
	15,  // 187: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	82,  // 188: scalibr.Location.file:type_name -> scalibr.File
	86,  // 189: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	84,  // 190: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	185, // 191: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	186, // 192: scalibr.ContainerImageMetadata.labels:type_name -> scalibr.ContainerImageMetadata.LabelsEntry
	85,  // 193: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	3,   // 194: scalibr.InfoType.sensitivity:type_name -> scalibr.SensitivityLevel
	87,  // 195: scalibr.SensitiveInformation.info_type:type_name -> scalibr.InfoType
	4,   // 196: scalibr.SensitiveInformation.likelihood:type_name -> scalibr.Likelihood
	81,  // 197: scalibr.SensitiveInformation.location:type_name -> scalibr.Location
	62,  // 198: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	166, // 199: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	190, // 200: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
	184, // 201: scalibr.SecretData.HTTPCookie.values:type_name -> scalibr.SecretData.HTTPCookie.ValuesEntry
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[5].OneofWrappers = []any{
		...
		(*Package_AndroidApkMetadata)(nil),
	}
