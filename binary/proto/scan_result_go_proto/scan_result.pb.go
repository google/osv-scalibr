...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\x1dslack_app_config_access_token\x18# \x01(\v2-.scalibr.SecretData.SlackAppConfigAccessTokenH\x00R\x19slackAppConfigAccessToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_SlackAppLevelToken)(nil),                   // 84: scalibr.SecretData.SlackAppLevelToken
	(*SecretData_SlackAppConfigAccessToken)(nil),            // 85: scalibr.SecretData.SlackAppConfigAccessToken
	(*SecretData_SlackAppConfigRefreshToken)(nil),           // 86: scalibr.SecretData.SlackAppConfigRefreshToken
	(*SecretData_PostmanAPIKey)(nil),                        // 87: scalibr.SecretData.PostmanAPIKey
	(*SecretData_PostmanCollectionAccessToken)(nil),         // 88: scalibr.SecretData.PostmanCollectionAccessToken
	(*SecretData_DigitalOceanAPIToken)(nil),                 // 89: scalibr.SecretData.DigitalOceanAPIToken
	(*SecretData_GithubAppRefreshToken)(nil),                // 90: scalibr.SecretData.GithubAppRefreshToken
	(*SecretData_GithubAppServerToServerToken)(nil),         // 91: scalibr.SecretData.GithubAppServerToServerToken
	(*SecretData_GithubClassicPersonalAccessToken)(nil),     // 92: scalibr.SecretData.GithubClassicPersonalAccessToken
	(*SecretData_GithubFineGrainedPersonalAccessToken)(nil), // 93: scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	(*SecretData_GithubOAuthToken)(nil),                     // 94: scalibr.SecretData.GithubOAuthToken
	(*SecretData_GithubAppUserToServerToken)(nil),           // 95: scalibr.SecretData.GithubAppUserToServerToken
	(*SecretData_TinkKeyset)(nil),                           // 96: scalibr.SecretData.TinkKeyset
	(*SecretData_HashiCorpVaultToken)(nil),                  // 97: scalibr.SecretData.HashiCorpVaultToken
	(*SecretData_HashiCorpVaultAppRoleCredentials)(nil),     // 98: scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	(*SecretData_GCPAPIKey)(nil),                            // 99: scalibr.SecretData.GCPAPIKey
	(*SecretData_HuggingfaceAPIKey)(nil),                    // 100: scalibr.SecretData.HuggingfaceAPIKey
	(*SecretData_StripeSecretKey)(nil),                      // 101: scalibr.SecretData.StripeSecretKey
	(*SecretData_StripeRestrictedKey)(nil),                  // 102: scalibr.SecretData.StripeRestrictedKey
	(*SecretData_StripeWebhookSecret)(nil),                  // 103: scalibr.SecretData.StripeWebhookSecret
	(*SecretData_GCPOAuth2ClientCredentials)(nil),           // 104: scalibr.SecretData.GCPOAuth2ClientCredentials
	(*SecretData_GCPOAuth2AccessToken)(nil),                 // 105: scalibr.SecretData.GCPOAuth2AccessToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	89,  // 79: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	81,  // 80: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	87,  // 81: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	88,  // 82: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	...
	96,  // 85: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	83,  // 86: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	97,  // 87: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	98,  // 88: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	99,  // 89: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	100, // 90: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	90,  // 91: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	101, // 92: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	102, // 93: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	103, // 94: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	104, // 95: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	105, // 96: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	91,  // 97: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	92,  // 98: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	93,  // 99: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	95,  // 100: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	94,  // 101: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	86,  // 102: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	84,  // 103: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	85,  // 104: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
