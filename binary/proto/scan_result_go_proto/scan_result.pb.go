...
type SecretData_SalesforceOauth2AccessToken struct {
	SalesforceOauth2AccessToken *SecretData_SalesforceOAuth2AccessToken `protobuf:"bytes,60,opt,name=salesforce_oauth2_access_token,json=salesforceOauth2AccessToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xbdL\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x16telegram_bot_api_token\x18; \x01(\v2$.scalibr.SecretData.TelegramBotTokenH\x00R\x13telegramBotApiToken\x12v\n" +
	"\x1esalesforce_oauth2_access_token\x18< \x01(\v2/.scalibr.SecretData.SalesforceOAuth2AccessTokenH\x00R\x1bsalesforceOauth2AccessToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_SalesforceOAuth2AccessToken)(nil),          // 136: scalibr.SecretData.SalesforceOAuth2AccessToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	136, // 135: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
