...
func (x *SecretData) GetDatabricksPat() *SecretData_DatabricksPat {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_DatabricksPat_); ok {
			return x.DatabricksPat
		}
	}
	return nil
}
...
func (x *SecretData) GetDatabricksServicePrincipalOauth2ClientCredentials() *SecretData_DatabricksServicePrincipalOAuth2ClientCredentials {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_DatabricksServicePrincipalOauth2ClientCredentials); ok {
			return x.DatabricksServicePrincipalOauth2ClientCredentials
		}
	}
	return nil
}
...
type SecretData_DatabricksPat_ struct {
	DatabricksPat *SecretData_DatabricksPat `protobuf:"bytes,89,opt,name=databricks_pat,json=databricksPat,proto3,oneof"`
}

type SecretData_DatabricksUserAccountOauth2ClientCredentials struct {
	DatabricksUserAccountOauth2ClientCredentials *SecretData_DatabricksUserAccountOAuth2ClientCredentials `protobuf:"bytes,90,opt,name=databricks_user_account_oauth2_client_credentials,json=databricksUserAccountOauth2ClientCredentials,proto3,oneof"`
}

type SecretData_DatabricksServicePrincipalOauth2ClientCredentials struct {
	DatabricksServicePrincipalOauth2ClientCredentials *SecretData_DatabricksServicePrincipalOAuth2ClientCredentials `protobuf:"bytes,91,opt,name=databricks_service_principal_oauth2_client_credentials,json=databricksServicePrincipalOauth2ClientCredentials,proto3,oneof"`
}
...
func (*SecretData_DatabricksPat_) isSecretData_Secret() {}
...
type SecretData_DatabricksPat struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Databricks PAT
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
...
func (x *SecretData_DatabricksPat) Reset() {
	*x = SecretData_DatabricksPat{}
	mi := &file_proto_scan_result_proto_msgTypes[167]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_DatabricksPat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_DatabricksPat) ProtoMessage() {}

func (x *SecretData_DatabricksPat) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[167]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_DatabricksPat.ProtoReflect.Descriptor instead.
func (*SecretData_DatabricksPat) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 89}
}

func (x *SecretData_DatabricksPat) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_DatabricksPat) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
type SecretData_DatabricksServicePrincipalOAuth2ClientCredentials struct {
	...
	Url string `protobuf:"bytes,1,opt,name=url,proto3" json:"url,omitempty"`
	// Databricks Service Principal OAuth2 client secret
	Secret string `protobuf:"bytes,2,opt,name=secret,proto3" json:"secret,omitempty"`
	// Databricks Service Principal OAuth2 client ID
	Id            string `protobuf:"bytes,3,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SecretData_DatabricksServicePrincipalOAuth2ClientCredentials) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SecretData_DatabricksServicePrincipalOAuth2ClientCredentials) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *SecretData_DatabricksServicePrincipalOAuth2ClientCredentials) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xa1w\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12J\n" +
	"\x0edatabricks_pat\x18Y \x01(\v2!.scalibr.SecretData.DatabricksPatH\x00R\rdatabricksPat\x12\xab\x01\n" +
	"1databricks_user_account_oauth2_client_credentials\x18Z \x01(\v2@.scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentialsH\x00R,databricksUserAccountOauth2ClientCredentials\x12\xba\x01\n" +
	...
	"\x03key\x18\x02 \x01(\tR\x03key\x1a7\n" +
	"\rDatabricksPat\x12\x14\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DatabricksPat)(nil),                                     // 172: scalibr.SecretData.DatabricksPat
	(*SecretData_DatabricksUserAccountOAuth2ClientCredentials)(nil),      // 173: scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentials
	(*SecretData_DatabricksServicePrincipalOAuth2ClientCredentials)(nil), // 174: scalibr.SecretData.DatabricksServicePrincipalOAuth2ClientCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	172, // 170: scalibr.SecretData.databricks_pat:type_name -> scalibr.SecretData.DatabricksPat
	173, // 171: scalibr.SecretData.databricks_user_account_oauth2_client_credentials:type_name -> scalibr.SecretData.DatabricksUserAccountOAuth2ClientCredentials
	174, // 172: scalibr.SecretData.databricks_service_principal_oauth2_client_credentials:type_name -> scalibr.SecretData.DatabricksServicePrincipalOAuth2ClientCredentials
	...
	158, // 185: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
