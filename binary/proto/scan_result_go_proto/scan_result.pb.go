...
type SecretData_Qwen_Pat struct {
	Qwen_Pat *SecretData_QwenPat `protobuf:"bytes,89,opt,name=qwen__pat,json=qwenPat,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xa3r\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x129\n" +
	"\tqwen__pat\x18Y \x01(\v2\x1b.scalibr.SecretData.QwenPatH\x00R\aqwenPat\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_QwenPat)(nil),                              // 172: scalibr.SecretData.QwenPat
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	172, // 170: scalibr.SecretData.qwen__pat:type_name -> scalibr.SecretData.QwenPat
