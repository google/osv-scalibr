...
type SecretData struct {
	...
	//	*SecretData_StripeSkTestApiKey
	//	*SecretData_StripeSkLiveApiKey
	//	*SecretData_StripeRkTestApiKey
	//	*SecretData_StripeRkLiveApiKey
...
func (x *SecretData) GetStripeSkTestApiKey() *SecretData_StripeSKTestApiKey {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_StripeSkTestApiKey); ok {
			return x.StripeSkTestApiKey
		}
	}
	return nil
}

func (x *SecretData) GetStripeSkLiveApiKey() *SecretData_StripeSKLiveApiKey {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_StripeSkLiveApiKey); ok {
			return x.StripeSkLiveApiKey
		}
	}
	return nil
}

func (x *SecretData) GetStripeRkTestApiKey() *SecretData_StripeRKTestApiKey {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_StripeRkTestApiKey); ok {
			return x.StripeRkTestApiKey
		}
	}
	return nil
}

func (x *SecretData) GetStripeRkLiveApiKey() *SecretData_StripeRKLiveApiKey {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_StripeRkLiveApiKey); ok {
			return x.StripeRkLiveApiKey
		}
	}
	return nil
}
...
type SecretData_StripeSkTestApiKey struct {
	StripeSkTestApiKey *SecretData_StripeSKTestApiKey `protobuf:"bytes,9,opt,name=stripe_sk_test_api_key,json=stripeSkTestApiKey,proto3,oneof"`
}

type SecretData_StripeSkLiveApiKey struct {
	StripeSkLiveApiKey *SecretData_StripeSKLiveApiKey `protobuf:"bytes,10,opt,name=stripe_sk_live_api_key,json=stripeSkLiveApiKey,proto3,oneof"`
}

type SecretData_StripeRkTestApiKey struct {
	StripeRkTestApiKey *SecretData_StripeRKTestApiKey `protobuf:"bytes,11,opt,name=stripe_rk_test_api_key,json=stripeRkTestApiKey,proto3,oneof"`
}

type SecretData_StripeRkLiveApiKey struct {
	StripeRkLiveApiKey *SecretData_StripeRKLiveApiKey `protobuf:"bytes,12,opt,name=stripe_rk_live_api_key,json=stripeRkLiveApiKey,proto3,oneof"`
}

type SecretData_StripeWebhookSecret_ struct {
	StripeWebhookSecret *SecretData_StripeWebhookSecret `protobuf:"bytes,13,opt,name=stripe_webhook_secret,json=stripeWebhookSecret,proto3,oneof"`
}
...
func (*SecretData_StripeSkTestApiKey) isSecretData_Secret() {}

func (*SecretData_StripeSkLiveApiKey) isSecretData_Secret() {}

func (*SecretData_StripeRkTestApiKey) isSecretData_Secret() {}

func (*SecretData_StripeRkLiveApiKey) isSecretData_Secret() {}
...
func (x *SecretData_StripeSKTestApiKey) Reset() {
	*x = SecretData_StripeSKTestApiKey{}
	mi := &file_proto_scan_result_proto_msgTypes[69]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_StripeSKTestApiKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_StripeSKTestApiKey) ProtoMessage() {}

func (x *SecretData_StripeSKTestApiKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[69]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_StripeSKTestApiKey.ProtoReflect.Descriptor instead.
func (*SecretData_StripeSKTestApiKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{53, 8}
}

func (x *SecretData_StripeSKTestApiKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *SecretData_StripeSKLiveApiKey) Reset() {
	*x = SecretData_StripeSKLiveApiKey{}
	mi := &file_proto_scan_result_proto_msgTypes[70]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_StripeSKLiveApiKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_StripeSKLiveApiKey) ProtoMessage() {}

func (x *SecretData_StripeSKLiveApiKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[70]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_StripeSKLiveApiKey.ProtoReflect.Descriptor instead.
func (*SecretData_StripeSKLiveApiKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{53, 9}
}

func (x *SecretData_StripeSKLiveApiKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *SecretData_StripeRKTestApiKey) Reset() {
	*x = SecretData_StripeRKTestApiKey{}
	mi := &file_proto_scan_result_proto_msgTypes[71]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_StripeRKTestApiKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_StripeRKTestApiKey) ProtoMessage() {}

func (x *SecretData_StripeRKTestApiKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[71]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_StripeRKTestApiKey.ProtoReflect.Descriptor instead.
func (*SecretData_StripeRKTestApiKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{53, 10}
}

func (x *SecretData_StripeRKTestApiKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *SecretData_StripeRKLiveApiKey) Reset() {
	*x = SecretData_StripeRKLiveApiKey{}
	mi := &file_proto_scan_result_proto_msgTypes[72]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_StripeRKLiveApiKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_StripeRKLiveApiKey) ProtoMessage() {}

func (x *SecretData_StripeRKLiveApiKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[72]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_StripeRKLiveApiKey.ProtoReflect.Descriptor instead.
func (*SecretData_StripeRKLiveApiKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{53, 11}
}

func (x *SecretData_StripeRKLiveApiKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xc3\x10\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x0edocker_hub_pat\x18\b \x01(\v2 .scalibr.SecretData.DockerHubPatH\x00R\fdockerHubPat\x12\\\n" +
	"\x16stripe_sk_test_api_key\x18\t \x01(\v2&.scalibr.SecretData.StripeSKTestApiKeyH\x00R\x12stripeSkTestApiKey\x12\\\n" +
	"\x16stripe_sk_live_api_key\x18\n" +
	" \x01(\v2&.scalibr.SecretData.StripeSKLiveApiKeyH\x00R\x12stripeSkLiveApiKey\x12\\\n" +
	"\x16stripe_rk_test_api_key\x18\v \x01(\v2&.scalibr.SecretData.StripeRKTestApiKeyH\x00R\x12stripeRkTestApiKey\x12\\\n" +
	"\x16stripe_rk_live_api_key\x18\f \x01(\v2&.scalibr.SecretData.StripeRKLiveApiKeyH\x00R\x12stripeRkLiveApiKey\x12]\n" +
	"\x15stripe_webhook_secret\x18\r \x01(\v2'.scalibr.SecretData.StripeWebhookSecretH\x00R\x13stripeWebhookSecret\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x12StripeSKTestApiKey\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x1a&\n" +
	"\x12StripeSKLiveApiKey\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x1a&\n" +
	"\x12StripeRKTestApiKey\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x1a&\n" +
	"\x12StripeRKLiveApiKey\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x1a'\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_StripeSKTestApiKey)(nil),       // 74: scalibr.SecretData.StripeSKTestApiKey
	(*SecretData_StripeSKLiveApiKey)(nil),       // 75: scalibr.SecretData.StripeSKLiveApiKey
	(*SecretData_StripeRKTestApiKey)(nil),       // 76: scalibr.SecretData.StripeRKTestApiKey
	(*SecretData_StripeRKLiveApiKey)(nil),       // 77: scalibr.SecretData.StripeRKLiveApiKey
	(*SecretData_StripeWebhookSecret)(nil),      // 78: scalibr.SecretData.StripeWebhookSecret
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	74, // 77: scalibr.SecretData.stripe_sk_test_api_key:type_name -> scalibr.SecretData.StripeSKTestApiKey
	75, // 78: scalibr.SecretData.stripe_sk_live_api_key:type_name -> scalibr.SecretData.StripeSKLiveApiKey
	76, // 79: scalibr.SecretData.stripe_rk_test_api_key:type_name -> scalibr.SecretData.StripeRKTestApiKey
	77, // 80: scalibr.SecretData.stripe_rk_live_api_key:type_name -> scalibr.SecretData.StripeRKLiveApiKey
	78, // 81: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[53].OneofWrappers = []any{
		...
		(*SecretData_StripeSkTestApiKey)(nil),
		(*SecretData_StripeSkLiveApiKey)(nil),
		(*SecretData_StripeRkTestApiKey)(nil),
		(*SecretData_StripeRkLiveApiKey)(nil),
