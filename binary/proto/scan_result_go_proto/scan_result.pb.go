...
type SecretData_CircleciPersonalAccessToken struct {
	CircleciPersonalAccessToken *SecretData_CircleCIPersonalAccessToken `protobuf:"bytes,62,opt,name=circleci_personal_access_token,json=circleciPersonalAccessToken,proto3,oneof"`
}

type SecretData_CircleciProjectToken struct {
	CircleciProjectToken *SecretData_CircleCIProjectToken `protobuf:"bytes,63,opt,name=circleci_project_token,json=circleciProjectToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xbeO\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x15elastic_cloud_api_key\x18= \x01(\v2&.scalibr.SecretData.ElasticCloudAPIKeyH\x00R\x12elasticCloudApiKey\x12v\n" +
	"\x1ecircleci_personal_access_token\x18> \x01(\v2/.scalibr.SecretData.CircleCIPersonalAccessTokenH\x00R\x1bcircleciPersonalAccessToken\x12`\n" +
	"\x16circleci_project_token\x18? \x01(\v2(.scalibr.SecretData.CircleCIProjectTokenH\x00R\x14circleciProjectToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_CircleCIPersonalAccessToken)(nil),          // 139: scalibr.SecretData.CircleCIPersonalAccessToken
	(*SecretData_CircleCIProjectToken)(nil),                 // 140: scalibr.SecretData.CircleCIProjectToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	139, // 138: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	140, // 139: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
