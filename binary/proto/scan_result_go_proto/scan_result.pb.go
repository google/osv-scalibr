...
type SecretData struct {
	...
	//	*SecretData_GitlabIncomingEmailToken_
...
func (x *SecretData) GetGitlabIncomingEmailToken() *SecretData_GitlabIncomingEmailToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GitlabIncomingEmailToken_); ok {
			return x.GitlabIncomingEmailToken
		}
	}
	return nil
}
...
type SecretData_GitlabIncomingEmailToken_ struct {
	GitlabIncomingEmailToken *SecretData_GitlabIncomingEmailToken `protobuf:"bytes,89,opt,name=gitlab_incoming_email_token,json=gitlabIncomingEmailToken,proto3,oneof"`
}
...
func (*SecretData_GitlabIncomingEmailToken_) isSecretData_Secret() {}
...
type SecretData_GitlabIncomingEmailToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SecretData_GitlabIncomingEmailToken) Reset() {
	*x = SecretData_GitlabIncomingEmailToken{}
	mi := &file_proto_scan_result_proto_msgTypes[97]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GitlabIncomingEmailToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GitlabIncomingEmailToken) ProtoMessage() {}

func (x *SecretData_GitlabIncomingEmailToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[97]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GitlabIncomingEmailToken.ProtoReflect.Descriptor instead.
func (*SecretData_GitlabIncomingEmailToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 19}
}

func (x *SecretData_GitlabIncomingEmailToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xecr\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1bgitlab_incoming_email_token\x18Y \x01(\v2,.scalibr.SecretData.GitlabIncomingEmailTokenH\x00R\x18gitlabIncomingEmailToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\tGitlabPat\x12\x10\n" +
	"\x03pat\x18\x01 \x01(\tR\x03pat\x1a0\n" +
	"\x18GitlabIncomingEmailToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x1a*\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GitlabIncomingEmailToken)(nil),             // 102: scalibr.SecretData.GitlabIncomingEmailToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	102, // 170: scalibr.SecretData.gitlab_incoming_email_token:type_name -> scalibr.SecretData.GitlabIncomingEmailToken
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[65].OneofWrappers = []any{
		...
		(*SecretData_GitlabIncomingEmailToken_)(nil),
	}
