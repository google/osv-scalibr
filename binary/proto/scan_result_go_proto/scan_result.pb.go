...
type Package struct {
	...
	//	*Package_JavascriptHtmlcdnMetadata
...
func (x *Package) GetJavascriptHtmlcdnMetadata() *JavascriptHtmlcdnMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Package_JavascriptHtmlcdnMetadata); ok {
			return x.JavascriptHtmlcdnMetadata
		}
	}
	return nil
}
...
type Package_JavascriptHtmlcdnMetadata struct {
	JavascriptHtmlcdnMetadata *JavascriptHtmlcdnMetadata `protobuf:"bytes,70,opt,name=javascript_htmlcdn_metadata,json=javascriptHtmlcdnMetadata,proto3,oneof"`
}
...
func (*Package_JavascriptHtmlcdnMetadata) isPackage_Metadata() {}
...
type JavascriptHtmlcdnMetadata struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *JavascriptHtmlcdnMetadata) Reset() {
	*x = JavascriptHtmlcdnMetadata{}
	mi := &file_proto_scan_result_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *JavascriptHtmlcdnMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JavascriptHtmlcdnMetadata) ProtoMessage() {}

func (x *JavascriptHtmlcdnMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JavascriptHtmlcdnMetadata.ProtoReflect.Descriptor instead.
func (*JavascriptHtmlcdnMetadata) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{22}
}

func (x *JavascriptHtmlcdnMetadata) GetRawVersion() string {
	if x != nil {
		return x.RawVersion
	}
	return ""
...
func (x *JavascriptHtmlcdnMetadata) GetFullUrl() string {
	if x != nil {
		return x.FullUrl
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\x9f\"\n" +
	"\aPackage\x12\x0e\n" +
	...
	"\x0espack_metadata\x18C \x01(\v2\x1d.scalibr.SpackPackageMetadataH\x00R\rspackMetadata\x12d\n" +
	"\x1bjavascript_htmlcdn_metadata\x18F \x01(\v2\".scalibr.JavascriptHtmlcdnMetadataH\x00R\x19javascriptHtmlcdnMetadata\x12[\n" +
	...
	"\x03cdn\"W\n" +
	"\x19JavascriptHtmlcdnMetadata\x12\x1f\n" +
	"\vraw_version\x18\x01 \x01(\tR\n" +
	"rawVersion\x12\x19\n" +
	"\bfull_url\x18\x02 \x01(\tR\afullUrl\"\xe4\x01\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*JavascriptHtmlcdnMetadata)(nil),             // 29: scalibr.JavascriptHtmlcdnMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	30,  // 20: scalibr.Package.apk_metadata:type_name -> scalibr.APKPackageMetadata
	31,  // 21: scalibr.Package.dpkg_metadata:type_name -> scalibr.DPKGPackageMetadata
	32,  // 22: scalibr.Package.rpm_metadata:type_name -> scalibr.RPMPackageMetadata
	33,  // 23: scalibr.Package.cos_metadata:type_name -> scalibr.COSPackageMetadata
	36,  // 24: scalibr.Package.depsjson_metadata:type_name -> scalibr.DEPSJSONMetadata
	...
	34,  // 28: scalibr.Package.pacman_metadata:type_name -> scalibr.PACMANPackageMetadata
	35,  // 29: scalibr.Package.nix_metadata:type_name -> scalibr.NixPackageMetadata
	41,  // 30: scalibr.Package.kernel_module_metadata:type_name -> scalibr.KernelModuleMetadata
	42,  // 31: scalibr.Package.vmlinuz_metadata:type_name -> scalibr.VmlinuzMetadata
	38,  // 32: scalibr.Package.portage_metadata:type_name -> scalibr.PortagePackageMetadata
	...
	37,  // 38: scalibr.Package.snap_metadata:type_name -> scalibr.SNAPPackageMetadata
	39,  // 39: scalibr.Package.flatpak_metadata:type_name -> scalibr.FlatpakPackageMetadata
	43,  // 40: scalibr.Package.mac_apps_metadata:type_name -> scalibr.MacAppsMetadata
	...
	44,  // 49: scalibr.Package.macports_metadata:type_name -> scalibr.MacportsPackageMetadata
	...
	40,  // 60: scalibr.Package.spack_metadata:type_name -> scalibr.SpackPackageMetadata
	29,  // 61: scalibr.Package.javascript_htmlcdn_metadata:type_name -> scalibr.JavascriptHtmlcdnMetadata
	...
	185, // 70: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	183, // 81: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	183, // 82: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	175, // 148: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	162, // 149: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	178, // 150: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	...
	176, // 155: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	177, // 156: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	179, // 157: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	180, // 158: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	...
	77,  // 180: scalibr.LocationLegacy.filepath:type_name -> scalibr.Filepath
	78,  // 181: scalibr.LocationLegacy.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	79,  // 182: scalibr.LocationLegacy.environment_variable:type_name -> scalibr.EnvironmentVariable
	80,  // 183: scalibr.LocationLegacy.container_command:type_name -> scalibr.ContainerCommand
	15,  // 184: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	82,  // 185: scalibr.Location.file:type_name -> scalibr.File
	86,  // 186: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	84,  // 187: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	...
	85,  // 190: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	3,   // 191: scalibr.InfoType.sensitivity:type_name -> scalibr.SensitivityLevel
	87,  // 192: scalibr.SensitiveInformation.info_type:type_name -> scalibr.InfoType
	4,   // 193: scalibr.SensitiveInformation.likelihood:type_name -> scalibr.Likelihood
	81,  // 194: scalibr.SensitiveInformation.location:type_name -> scalibr.Location
	62,  // 195: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	166, // 196: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[5].OneofWrappers = []any{
		...
		(*Package_JavascriptHtmlcdnMetadata)(nil),
	}
