...
func (x *SecretData) GetNugetOrgApiKey() *SecretData_NuGetOrgAPIKey {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_NugetOrgApiKey); ok {
			return x.NugetOrgApiKey
		}
	}
	return nil
}
...
type SecretData_NugetOrgApiKey struct {
	NugetOrgApiKey *SecretData_NuGetOrgAPIKey `protobuf:"bytes,89,opt,name=nuget_org_api_key,json=nugetOrgApiKey,proto3,oneof"`
}
...
func (*SecretData_NugetOrgApiKey) isSecretData_Secret() {}
...
func (x *SecretData_NuGetOrgAPIKey) Reset() {
	*x = SecretData_NuGetOrgAPIKey{}
	mi := &file_proto_scan_result_proto_msgTypes[170]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_NuGetOrgAPIKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_NuGetOrgAPIKey) ProtoMessage() {}

func (x *SecretData_NuGetOrgAPIKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[170]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_NuGetOrgAPIKey.ProtoReflect.Descriptor instead.
func (*SecretData_NuGetOrgAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 89}
}

func (x *SecretData_NuGetOrgAPIKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation\"\xc0r\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11nuget_org_api_key\x18Y \x01(\v2\".scalibr.SecretData.NuGetOrgAPIKeyH\x00R\x0enugetOrgApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_NuGetOrgAPIKey)(nil),                       // 175: scalibr.SecretData.NuGetOrgAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	175, // 175: scalibr.SecretData.nuget_org_api_key:type_name -> scalibr.SecretData.NuGetOrgAPIKey
