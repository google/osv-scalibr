...
type SecretData_Digitalocean struct {
	Digitalocean *SecretData_DigitalOceanAPIToken `protobuf:"bytes,6,opt,name=digitalocean,proto3,oneof"`
}
...
func (*SecretData_PrivateKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{52, 5}
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"privateKey\x12N\n" +
	"\fdigitalocean\x18\x06 \x01(\v2(.scalibr.SecretData.DigitalOceanAPITokenH\x00R\fdigitalocean\x1a(\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DigitalOceanAPIToken)(nil),     // 65: scalibr.SecretData.DigitalOceanAPIToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	71, // 62: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	71, // 63: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	66, // 68: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	67, // 69: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	68, // 70: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	69, // 71: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	70, // 72: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	65, // 73: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	...
	61, // 77: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	62, // 78: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	63, // 79: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
