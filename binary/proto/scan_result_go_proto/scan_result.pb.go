...
type SecretData_DiscordBotToken_ struct {
	DiscordBotToken *SecretData_DiscordBotToken `protobuf:"bytes,77,opt,name=discord_bot_token,json=discordBotToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xceb\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x14cloudflare_api_token\x18L \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x12Q\n" +
	"\x11discord_bot_token\x18M \x01(\v2#.scalibr.SecretData.DiscordBotTokenH\x00R\x0fdiscordBotToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DiscordBotToken)(nil),                      // 145: scalibr.SecretData.DiscordBotToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	145, // 157: scalibr.SecretData.discord_bot_token:type_name -> scalibr.SecretData.DiscordBotToken
