...
type SecretData struct {
	...
	//	*SecretData_GitlabRunnerAuthToken_
...
func (x *SecretData) GetGitlabRunnerAuthToken() *SecretData_GitlabRunnerAuthToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GitlabRunnerAuthToken_); ok {
			return x.GitlabRunnerAuthToken
		}
	}
	return nil
}
...
type SecretData_GitlabRunnerAuthToken_ struct {
	GitlabRunnerAuthToken *SecretData_GitlabRunnerAuthToken `protobuf:"bytes,89,opt,name=gitlab_runner_auth_token,json=gitlabRunnerAuthToken,proto3,oneof"`
}
...
func (*SecretData_GitlabRunnerAuthToken_) isSecretData_Secret() {}
...
type SecretData_GitlabRunnerAuthToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
...
func (x *SecretData_GitlabRunnerAuthToken) Reset() {
	*x = SecretData_GitlabRunnerAuthToken{}
	mi := &file_proto_scan_result_proto_msgTypes[100]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GitlabRunnerAuthToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GitlabRunnerAuthToken) ProtoMessage() {}

func (x *SecretData_GitlabRunnerAuthToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[100]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GitlabRunnerAuthToken.ProtoReflect.Descriptor instead.
func (*SecretData_GitlabRunnerAuthToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 19}
}

func (x *SecretData_GitlabRunnerAuthToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_GitlabRunnerAuthToken) GetHostname() string {
	if x != nil {
		return x.Hostname
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation\"\xfcr\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12d\n" +
	"\x18gitlab_runner_auth_token\x18Y \x01(\v2).scalibr.SecretData.GitlabRunnerAuthTokenH\x00R\x15gitlabRunnerAuthToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\tGitlabPat\x12\x10\n" +
	"\x03pat\x18\x01 \x01(\tR\x03pat\x1aI\n" +
	"\x15GitlabRunnerAuthToken\x12\x14\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GitlabRunnerAuthToken)(nil),                // 105: scalibr.SecretData.GitlabRunnerAuthToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	178, // 67: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	177, // 78: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	177, // 79: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	112, // 94: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	100, // 95: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	109, // 96: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	110, // 97: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	...
	122, // 100: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	104, // 101: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	123, // 102: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	124, // 103: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	125, // 104: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	126, // 105: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	115, // 106: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	129, // 107: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	130, // 108: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	131, // 109: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	135, // 110: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	136, // 111: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	116, // 112: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	117, // 113: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	118, // 114: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	120, // 115: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	119, // 116: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	111, // 117: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	108, // 118: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	106, // 119: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	107, // 120: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	94,  // 121: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	127, // 122: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	128, // 123: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	148, // 124: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	149, // 125: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	150, // 126: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	140, // 127: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	97,  // 128: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	121, // 129: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	113, // 130: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	98,  // 131: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	137, // 132: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	138, // 133: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	139, // 134: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	151, // 135: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	152, // 136: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	153, // 137: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	154, // 138: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	155, // 139: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	87,  // 140: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	156, // 141: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	157, // 142: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	159, // 143: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	163, // 144: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	170, // 145: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	158, // 146: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	173, // 147: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	166, // 148: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	164, // 149: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	167, // 150: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	91,  // 151: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	171, // 152: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	172, // 153: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	174, // 154: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	175, // 155: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	168, // 156: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	165, // 157: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	103, // 158: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	161, // 159: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	114, // 160: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	102, // 161: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	132, // 162: scalibr.SecretData.supabase_pat:type_name -> scalibr.SecretData.SupabasePAT
	133, // 163: scalibr.SecretData.supabase_project_secret_key:type_name -> scalibr.SecretData.SupabaseProjectSecretKey
	134, // 164: scalibr.SecretData.supabase_service_role_jwt:type_name -> scalibr.SecretData.SupabaseServiceRoleJWT
	142, // 165: scalibr.SecretData.packagist_api_key:type_name -> scalibr.SecretData.PackagistAPIKey
	143, // 166: scalibr.SecretData.packagist_api_secret:type_name -> scalibr.SecretData.PackagistAPISecret
	144, // 167: scalibr.SecretData.packagist_org_read_token:type_name -> scalibr.SecretData.PackagistOrgReadToken
	145, // 168: scalibr.SecretData.packagist_org_update_token:type_name -> scalibr.SecretData.PackagistOrgUpdateToken
	146, // 169: scalibr.SecretData.packagist_user_update_token:type_name -> scalibr.SecretData.PackagistUserUpdateToken
	147, // 170: scalibr.SecretData.packagist_conductor_update_token:type_name -> scalibr.SecretData.PackagistConductorUpdateToken
	141, // 171: scalibr.SecretData.composer_http_basic_credentials:type_name -> scalibr.SecretData.ComposerPackagistCredentials
	160, // 172: scalibr.SecretData.discord_bot_token:type_name -> scalibr.SecretData.DiscordBotToken
	169, // 173: scalibr.SecretData.bitwarden_oauth2_access_token:type_name -> scalibr.SecretData.BitwardenOAuth2AccessToken
	105, // 174: scalibr.SecretData.gitlab_runner_auth_token:type_name -> scalibr.SecretData.GitlabRunnerAuthToken
	...
	74,  // 177: scalibr.LocationLegacy.filepath:type_name -> scalibr.Filepath
	75,  // 178: scalibr.LocationLegacy.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	76,  // 179: scalibr.LocationLegacy.environment_variable:type_name -> scalibr.EnvironmentVariable
	77,  // 180: scalibr.LocationLegacy.container_command:type_name -> scalibr.ContainerCommand
	13,  // 181: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	79,  // 182: scalibr.Location.file:type_name -> scalibr.File
	83,  // 183: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	81,  // 184: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	176, // 185: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	82,  // 186: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[66].OneofWrappers = []any{
		...
		(*SecretData_GitlabRunnerAuthToken_)(nil),
	}
