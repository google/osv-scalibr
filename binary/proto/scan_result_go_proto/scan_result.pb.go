...
type SecretData_CloudflareApiToken struct {
	CloudflareApiToken *SecretData_CloudflareAPIToken `protobuf:"bytes,69,opt,name=cloudflare_api_token,json=cloudflareApiToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xb6W\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x16circleci_project_token\x18D \x01(\v2(.scalibr.SecretData.CircleCIProjectTokenH\x00R\x14circleciProjectToken\x12Z\n" +
	"\x14cloudflare_api_token\x18E \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x1a\x1d\n" +
	"\tGitlabPat\x12\x10\n" +
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	96,  // 147: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
