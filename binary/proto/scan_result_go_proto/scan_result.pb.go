...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	151, // 62: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	150, // 73: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	150, // 74: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	104, // 88: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	95,  // 89: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	101, // 90: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	102, // 91: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	...
	113, // 94: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	97,  // 95: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	114, // 96: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	115, // 97: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	116, // 98: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	117, // 99: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	106, // 100: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	120, // 101: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	121, // 102: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	122, // 103: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	123, // 104: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	124, // 105: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	107, // 106: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	108, // 107: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	109, // 108: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	111, // 109: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	110, // 110: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	103, // 111: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	100, // 112: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	98,  // 113: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	99,  // 114: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	89,  // 115: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	118, // 116: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	119, // 117: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	129, // 118: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	130, // 119: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	131, // 120: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	128, // 121: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	92,  // 122: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	112, // 123: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	105, // 124: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	93,  // 125: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	125, // 126: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	126, // 127: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	127, // 128: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	132, // 129: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	133, // 130: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	134, // 131: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	135, // 132: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	136, // 133: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	82,  // 134: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	137, // 135: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	138, // 136: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	140, // 137: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	141, // 138: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	145, // 139: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	139, // 140: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	148, // 141: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	143, // 142: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	142, // 143: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	144, // 144: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	86,  // 145: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	146, // 146: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	147, // 147: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	...
	71,  // 150: scalibr.Location.filepath:type_name -> scalibr.Filepath
	72,  // 151: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	73,  // 152: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	74,  // 153: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 154: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	78,  // 155: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	76,  // 156: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	149, // 157: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	77,  // 158: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	57,  // 159: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
