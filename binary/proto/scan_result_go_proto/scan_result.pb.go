...
type SecretData_SalesforceOauth2ClientCredentials struct {
	SalesforceOauth2ClientCredentials *SecretData_SalesforceOAuth2ClientCredentials `protobuf:"bytes,60,opt,name=salesforce_oauth2_client_credentials,json=salesforceOauth2ClientCredentials,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xfaL\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x16telegram_bot_api_token\x18; \x01(\v2$.scalibr.SecretData.TelegramBotTokenH\x00R\x13telegramBotApiToken\x12\x88\x01\n" +
	"$salesforce_oauth2_client_credentials\x18< \x01(\v25.scalibr.SecretData.SalesforceOAuth2ClientCredentialsH\x00R!salesforceOauth2ClientCredentials\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x03url\x18\x03 \x01(\tR\x03urlB\b\n" +
	"\x06secret\"\xf8\x01\n" +
	"\fSecretStatus\x12>\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_SalesforceOAuth2ClientCredentials)(nil),    // 136: scalibr.SecretData.SalesforceOAuth2ClientCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	136, // 135: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
