...
type SecretData_ClojarsDeployToken_ struct {
	ClojarsDeployToken *SecretData_ClojarsDeployToken `protobuf:"bytes,77,opt,name=clojars_deploy_token,json=clojarsDeployToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xdab\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x14cloudflare_api_token\x18L \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x12Z\n" +
	"\x14clojars_deploy_token\x18M \x01(\v2&.scalibr.SecretData.ClojarsDeployTokenH\x00R\x12clojarsDeployToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	97,  // 154: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	82,  // 155: scalibr.SecretData.clojars_deploy_token:type_name -> scalibr.SecretData.ClojarsDeployToken
