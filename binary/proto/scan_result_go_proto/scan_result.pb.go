...
type SecretData struct {
	...
	//	*SecretData_MongodbConnectionUrl
...
func (x *SecretData) GetMongodbConnectionUrl() *SecretData_MongoDBConnectionURL {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_MongodbConnectionUrl); ok {
			return x.MongodbConnectionUrl
		}
	}
	return nil
}
...
type SecretData_MongodbConnectionUrl struct {
	MongodbConnectionUrl *SecretData_MongoDBConnectionURL `protobuf:"bytes,77,opt,name=mongodb_connection_url,json=mongodbConnectionUrl,proto3,oneof"`
}
...
func (*SecretData_MongodbConnectionUrl) isSecretData_Secret() {}
...
func (x *SecretData_MongoDBConnectionURL) Reset() {
	*x = SecretData_MongoDBConnectionURL{}
	mi := &file_proto_scan_result_proto_msgTypes[94]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_MongoDBConnectionURL) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_MongoDBConnectionURL) ProtoMessage() {}

func (x *SecretData_MongoDBConnectionURL) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[94]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_MongoDBConnectionURL.ProtoReflect.Descriptor instead.
func (*SecretData_MongoDBConnectionURL) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{64, 17}
}

func (x *SecretData_MongoDBConnectionURL) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_MongoDBConnectionURL)(nil),                 // 99: scalibr.SecretData.MongoDBConnectionURL
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	162, // 63: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	161, // 74: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	161, // 75: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	128, // 105: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	129, // 106: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	...
	134, // 119: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	135, // 120: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	136, // 121: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	133, // 122: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	...
	130, // 127: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	131, // 128: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	132, // 129: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	137, // 130: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	138, // 131: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	139, // 132: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	140, // 133: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	141, // 134: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	83,  // 135: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	142, // 136: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	143, // 137: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	145, // 138: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	148, // 139: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	154, // 140: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	144, // 141: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	157, // 142: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	151, // 143: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	149, // 144: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	152, // 145: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	87,  // 146: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	155, // 147: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	156, // 148: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	158, // 149: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	159, // 150: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	153, // 151: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	150, // 152: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	100, // 153: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	146, // 154: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	...
	99,  // 157: scalibr.SecretData.mongodb_connection_url:type_name -> scalibr.SecretData.MongoDBConnectionURL
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[64].OneofWrappers = []any{
		...
		(*SecretData_MongodbConnectionUrl)(nil),
	}
