...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xc5, 0x07, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x13, 0x4a, 0x04, 0x08, 0x13, 0x10, 0x14, 0x22, 0xc8, 0x01, 0x0a, 0x04, 0x50, 0x75, 0x72, 0x6c,
	...
	0x52, 0x0b, 0x6f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x4c, 0x0a,
	0x13, 0x53, 0x50, 0x44, 0x58, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x4d, 0x65, 0x74, 0x61,
	...
	0x61, 0x31, 0x22, 0x86, 0x01, 0x0a, 0x12, 0x4f, 0x53, 0x56, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67,
	...
	0x52, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x65, 0x41, 0x73, 0x22, 0x57, 0x0a, 0x1a, 0x50,
	...
	0x6c, 0x75, 0x65, 0x73, 0x42, 0x3f, 0x50, 0x01, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_proto_scan_result_proto_goTypes = []interface{}{
	...
	(*SPDXPackageMetadata)(nil),           // 21: scalibr.SPDXPackageMetadata
	(*JavaArchiveMetadata)(nil),           // 22: scalibr.JavaArchiveMetadata
	(*OSVPackageMetadata)(nil),            // 23: scalibr.OSVPackageMetadata
	(*PythonRequirementsMetadata)(nil),    // 24: scalibr.PythonRequirementsMetadata
	(*timestamppb.Timestamp)(nil),         // 25: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	25, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	25, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	21, // 15: scalibr.Inventory.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	22, // 16: scalibr.Inventory.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	23, // 17: scalibr.Inventory.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	24, // 18: scalibr.Inventory.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	8,  // 19: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	10, // 20: scalibr.Finding.adv:type_name -> scalibr.Advisory
	14, // 21: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	11, // 22: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	1,  // 23: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	12, // 24: scalibr.Advisory.sev:type_name -> scalibr.Severity
	2,  // 25: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	13, // 26: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	13, // 27: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	6,  // 28: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	7,  // 29: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
