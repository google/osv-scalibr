...
func (x *SecretData) GetIbmCloudSecretKey() *SecretData_IBMCloudUserSecretKey {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_IbmCloudSecretKey); ok {
			return x.IbmCloudSecretKey
		}
	}
	return nil
}
...
type SecretData_IbmCloudSecretKey struct {
	IbmCloudSecretKey *SecretData_IBMCloudUserSecretKey `protobuf:"bytes,89,opt,name=ibm_cloud_secret_key,json=ibmCloudSecretKey,proto3,oneof"`
}
...
func (*SecretData_IbmCloudSecretKey) isSecretData_Secret() {}
...
type SecretData_IBMCloudUserSecretKey struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Key   string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// Optional enrichment fields populated when available
	IbmCloudSecretKeyMetadata *SecretData_IBMCloudUserSecretKeyMetadata `protobuf:"bytes,2,opt,name=ibm_cloud_secret_key_metadata,json=ibmCloudSecretKeyMetadata,proto3,oneof" json:"ibm_cloud_secret_key_metadata,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}

func (x *SecretData_IBMCloudUserSecretKey) Reset() {
	*x = SecretData_IBMCloudUserSecretKey{}
	mi := &file_proto_scan_result_proto_msgTypes[154]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_IBMCloudUserSecretKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_IBMCloudUserSecretKey) ProtoMessage() {}

func (x *SecretData_IBMCloudUserSecretKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[154]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_IBMCloudUserSecretKey.ProtoReflect.Descriptor instead.
func (*SecretData_IBMCloudUserSecretKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 76}
}

func (x *SecretData_IBMCloudUserSecretKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *SecretData_IBMCloudUserSecretKey) GetIbmCloudSecretKeyMetadata() *SecretData_IBMCloudUserSecretKeyMetadata {
	if x != nil {
		return x.IbmCloudSecretKeyMetadata
	}
	return nil
}
...
func (x *SecretData_IBMCloudUserSecretKeyMetadata) Reset() {
	*x = SecretData_IBMCloudUserSecretKeyMetadata{}
	mi := &file_proto_scan_result_proto_msgTypes[155]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_IBMCloudUserSecretKeyMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_IBMCloudUserSecretKeyMetadata) ProtoMessage() {}

func (x *SecretData_IBMCloudUserSecretKeyMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[155]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_IBMCloudUserSecretKeyMetadata.ProtoReflect.Descriptor instead.
func (*SecretData_IBMCloudUserSecretKeyMetadata) Descriptor() ([]byte, []int) {
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\x14ibm_cloud_secret_key\x18Y \x01(\v2).scalibr.SecretData.IBMCloudUserSecretKeyH\x00R\x11ibmCloudSecretKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"expireTime\x12#\n" +
	"\rnever_expires\x18\x02 \x01(\bR\fneverExpires\x1a\xc5\x01\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_IBMCloudUserSecretKey)(nil),                // 159: scalibr.SecretData.IBMCloudUserSecretKey
	(*SecretData_IBMCloudUserSecretKeyMetadata)(nil),        // 160: scalibr.SecretData.IBMCloudUserSecretKeyMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	159, // 170: scalibr.SecretData.ibm_cloud_secret_key:type_name -> scalibr.SecretData.IBMCloudUserSecretKey
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[65].OneofWrappers = []any{
		...
		(*SecretData_IbmCloudSecretKey)(nil),
	}
