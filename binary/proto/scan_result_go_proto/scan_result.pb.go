...
type Package_AsdfMetadata struct {
	AsdfMetadata *AsdfMetadata `protobuf:"bytes,53,opt,name=asdf_metadata,json=asdfMetadata,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\x06status\x18\x03 \x01(\v2\x13.scalibr.ScanStatusR\x06status\"\xc3\x19\n" +
	"\aPackage\x12\x12\n" +
	...
	"\x1adocker_containers_metadata\x180 \x01(\v2!.scalibr.DockerContainersMetadataH\x00R\x18dockerContainersMetadata\x12<\n" +
	"\rasdf_metadata\x185 \x01(\v2\x15.scalibr.AsdfMetadataH\x00R\fasdfMetadata\x12Z\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*AsdfMetadata)(nil),                       // 53: scalibr.AsdfMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	53, // 45: scalibr.Package.asdf_metadata:type_name -> scalibr.AsdfMetadata
