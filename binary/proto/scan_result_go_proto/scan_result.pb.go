...
type SecretData struct {
	...
	//	*SecretData_MongodbAtlasAccessToken
	//	*SecretData_MongodbAtlasRefreshToken
...
func (x *SecretData) GetMongodbAtlasAccessToken() *SecretData_MongoDBAtlasAccessToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_MongodbAtlasAccessToken); ok {
			return x.MongodbAtlasAccessToken
		}
	}
	return nil
}

func (x *SecretData) GetMongodbAtlasRefreshToken() *SecretData_MongoDBAtlasRefreshToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_MongodbAtlasRefreshToken); ok {
			return x.MongodbAtlasRefreshToken
		}
	}
	return nil
}
...
type SecretData_MongodbAtlasAccessToken struct {
	MongodbAtlasAccessToken *SecretData_MongoDBAtlasAccessToken `protobuf:"bytes,77,opt,name=mongodb_atlas_access_token,json=mongodbAtlasAccessToken,proto3,oneof"`
}

type SecretData_MongodbAtlasRefreshToken struct {
	MongodbAtlasRefreshToken *SecretData_MongoDBAtlasRefreshToken `protobuf:"bytes,78,opt,name=mongodb_atlas_refresh_token,json=mongodbAtlasRefreshToken,proto3,oneof"`
}
...
func (*SecretData_MongodbAtlasAccessToken) isSecretData_Secret() {}

func (*SecretData_MongodbAtlasRefreshToken) isSecretData_Secret() {}
...
func (x *SecretData_MongoDBAtlasAccessToken) Reset() {
	*x = SecretData_MongoDBAtlasAccessToken{}
	mi := &file_proto_scan_result_proto_msgTypes[94]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_MongoDBAtlasAccessToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_MongoDBAtlasAccessToken) ProtoMessage() {}

func (x *SecretData_MongoDBAtlasAccessToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[94]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_MongoDBAtlasAccessToken.ProtoReflect.Descriptor instead.
func (*SecretData_MongoDBAtlasAccessToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{64, 17}
}

func (x *SecretData_MongoDBAtlasAccessToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_MongoDBAtlasRefreshToken) Reset() {
	*x = SecretData_MongoDBAtlasRefreshToken{}
	mi := &file_proto_scan_result_proto_msgTypes[95]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_MongoDBAtlasRefreshToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_MongoDBAtlasRefreshToken) ProtoMessage() {}

func (x *SecretData_MongoDBAtlasRefreshToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[95]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_MongoDBAtlasRefreshToken.ProtoReflect.Descriptor instead.
func (*SecretData_MongoDBAtlasRefreshToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{64, 18}
}

func (x *SecretData_MongoDBAtlasRefreshToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x90d\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x14cloudflare_api_token\x18L \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x12j\n" +
	"\x1amongodb_atlas_access_token\x18M \x01(\v2+.scalibr.SecretData.MongoDBAtlasAccessTokenH\x00R\x17mongodbAtlasAccessToken\x12m\n" +
	"\x1bmongodb_atlas_refresh_token\x18N \x01(\v2,.scalibr.SecretData.MongoDBAtlasRefreshTokenH\x00R\x18mongodbAtlasRefreshToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x1a/\n" +
	"\x17MongoDBAtlasAccessToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x1a0\n" +
	"\x18MongoDBAtlasRefreshToken\x12\x14\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_MongoDBAtlasAccessToken)(nil),              // 99: scalibr.SecretData.MongoDBAtlasAccessToken
	(*SecretData_MongoDBAtlasRefreshToken)(nil),             // 100: scalibr.SecretData.MongoDBAtlasRefreshToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	163, // 63: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	162, // 74: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	162, // 75: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	129, // 105: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	130, // 106: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	...
	135, // 119: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	136, // 120: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	137, // 121: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	134, // 122: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	...
	131, // 127: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	132, // 128: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	133, // 129: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	138, // 130: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	139, // 131: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	140, // 132: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	141, // 133: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	142, // 134: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	83,  // 135: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	143, // 136: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	144, // 137: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	146, // 138: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	149, // 139: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	155, // 140: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	145, // 141: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	158, // 142: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	152, // 143: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	150, // 144: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	153, // 145: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	87,  // 146: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	156, // 147: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	157, // 148: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	159, // 149: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	160, // 150: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	154, // 151: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	151, // 152: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	101, // 153: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	147, // 154: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	...
	99,  // 157: scalibr.SecretData.mongodb_atlas_access_token:type_name -> scalibr.SecretData.MongoDBAtlasAccessToken
	100, // 158: scalibr.SecretData.mongodb_atlas_refresh_token:type_name -> scalibr.SecretData.MongoDBAtlasRefreshToken
	...
	72,  // 161: scalibr.Location.filepath:type_name -> scalibr.Filepath
	73,  // 162: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	74,  // 163: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	75,  // 164: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 165: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	79,  // 166: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	77,  // 167: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	161, // 168: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	78,  // 169: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	57,  // 170: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[64].OneofWrappers = []any{
		...
		(*SecretData_MongodbAtlasAccessToken)(nil),
		(*SecretData_MongodbAtlasRefreshToken)(nil),
	}
