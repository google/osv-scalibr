...
type SecretData_Digitalocean struct {
	Digitalocean *SecretData_DigitalOceanAPIToken `protobuf:"bytes,2,opt,name=digitalocean,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xf9\x04\n" +
	"\n" +
	"SecretData\x124\n" +
	"\x06gcpsak\x18\x01 \x01(\v2\x1a.scalibr.SecretData.GCPSAKH\x00R\x06gcpsak\x12N\n" +
	"\fdigitalocean\x18\x02 \x01(\v2(.scalibr.SecretData.DigitalOceanAPITokenH\x00R\fdigitalocean\x1a(\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DigitalOceanAPIToken)(nil),    // 63: scalibr.SecretData.DigitalOceanAPIToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	63, // 67: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
