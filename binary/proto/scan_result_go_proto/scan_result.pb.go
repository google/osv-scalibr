...
type SecretData_NpmjsAccessToken struct {
	NpmjsAccessToken *SecretData_NpmJSAccessToken `protobuf:"bytes,44,opt,name=npmjs_access_token,json=npmjsAccessToken,proto3,oneof"`
}
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_NpmJSAccessToken)(nil),                     // 93: scalibr.SecretData.NpmJSAccessToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	93,  // 114: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJSAccessToken
