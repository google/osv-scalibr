...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 115)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_OnePasswordConnectToken)(nil),              // 116: scalibr.SecretData.OnePasswordConnectToken
	(*SecretData_OnePasswordSecretKey)(nil),                 // 117: scalibr.SecretData.OnePasswordSecretKey
	(*SecretData_OnePasswordServiceToken)(nil),              // 118: scalibr.SecretData.OnePasswordServiceToken
	(*SecretData_OnePasswordRecoveryCode)(nil),              // 119: scalibr.SecretData.OnePasswordRecoveryCode
	nil,                           // 120: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil), // 121: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	121, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	121, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	121, // 68: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	121, // 69: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	117, // 111: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	118, // 112: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	119, // 113: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	116, // 114: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	...
	121, // 120: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	...
	120, // 128: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
