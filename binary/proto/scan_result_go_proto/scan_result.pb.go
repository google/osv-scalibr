...
func (x *SecretData) GetGitlabDeployToken() *SecretData_GitlabDeployToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GitlabDeployToken_); ok {
			return x.GitlabDeployToken
		}
	}
	return nil
}
...
type SecretData_GitlabDeployToken_ struct {
	GitlabDeployToken *SecretData_GitlabDeployToken `protobuf:"bytes,89,opt,name=gitlab_deploy_token,json=gitlabDeployToken,proto3,oneof"`
}
...
func (*SecretData_GitlabDeployToken_) isSecretData_Secret() {}
...
type SecretData_GitlabDeployToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	Username      string                 `protobuf:"bytes,2,opt,name=username,proto3" json:"username,omitempty"`
...
func (x *SecretData_GitlabDeployToken) Reset() {
	*x = SecretData_GitlabDeployToken{}
	mi := &file_proto_scan_result_proto_msgTypes[152]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GitlabDeployToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GitlabDeployToken) ProtoMessage() {}

func (x *SecretData_GitlabDeployToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[152]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GitlabDeployToken.ProtoReflect.Descriptor instead.
func (*SecretData_GitlabDeployToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 74}
}

func (x *SecretData_GitlabDeployToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_GitlabDeployToken) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *SecretData_GitlabDeployToken) GetRepoUrl() string {
	if x != nil {
		return x.RepoUrl
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x86s\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12W\n" +
	"\x13gitlab_deploy_token\x18Y \x01(\v2%.scalibr.SecretData.GitlabDeployTokenH\x00R\x11gitlabDeployToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x1a`\n" +
	"\x11GitlabDeployToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x19\n" +
	"\brepo_url\x18\x03 \x01(\tR\arepoUrl\x1a\xb1\x01\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GitlabDeployToken)(nil),                    // 157: scalibr.SecretData.GitlabDeployToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	157, // 170: scalibr.SecretData.gitlab_deploy_token:type_name -> scalibr.SecretData.GitlabDeployToken
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[65].OneofWrappers = []any{
		...
		(*SecretData_GitlabDeployToken_)(nil),
	}
