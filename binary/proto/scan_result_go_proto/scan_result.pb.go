...
type SecretData_DatabricksServicePrincipalOauth2ClientCredentials struct {
	DatabricksServicePrincipalOauth2ClientCredentials *SecretData_DatabricksServicePrincipalOAuth2ClientCredentials `protobuf:"bytes,76,opt,name=databricks_service_principal_oauth2_client_credentials,json=databricksServicePrincipalOauth2ClientCredentials,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xf6b\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x12npmjs_access_token\x18K \x01(\v2$.scalibr.SecretData.NpmJsAccessTokenH\x00R\x10npmjsAccessToken\x12\xba\x01\n" +
	"6databricks_service_principal_oauth2_client_credentials\x18L \x01(\v2E.scalibr.SecretData.DatabricksServicePrincipalOAuth2ClientCredentialsH\x00R1databricksServicePrincipalOauth2ClientCredentials\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DatabricksServicePrincipalOAuth2ClientCredentials)(nil), // 156: scalibr.SecretData.DatabricksServicePrincipalOAuth2ClientCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	156, // 154: scalibr.SecretData.databricks_service_principal_oauth2_client_credentials:type_name -> scalibr.SecretData.DatabricksServicePrincipalOAuth2ClientCredentials
	...
	143, // 167: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
