...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x99\t\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"privateKey\x12^\n" +
	"\x16openai_project_api_key\x18\x06 \x01(\v2'.scalibr.SecretData.OpenAIProjectAPIKeyH\x00R\x13openaiProjectApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_OpenAIProjectAPIKey)(nil),      // 70: scalibr.SecretData.OpenAIProjectAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	70, // 73: scalibr.SecretData.openai_project_api_key:type_name -> scalibr.SecretData.OpenAIProjectAPIKey
