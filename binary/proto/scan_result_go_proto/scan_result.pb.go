...
type SecretData_NugetApiKey struct {
	NugetApiKey *SecretData_NuGetAPIKey `protobuf:"bytes,80,opt,name=nuget_api_key,json=nugetApiKey,proto3,oneof"`
}

type SecretData_NugetProxyCredential struct {
	NugetProxyCredential *SecretData_NuGetProxyCredential `protobuf:"bytes,81,opt,name=nuget_proxy_credential,json=nugetProxyCredential,proto3,oneof"`
}

type SecretData_NugetPackageSourceCredential struct {
	NugetPackageSourceCredential *SecretData_NuGetPackageSourceCredential `protobuf:"bytes,82,opt,name=nuget_package_source_credential,json=nugetPackageSourceCredential,proto3,oneof"`
}
...
func (*SecretData_NuGetAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{64, 81}
}
...
func (*SecretData_SquareOAuthApplicationSecret) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{64, 82}
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xf9i\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x19supabase_service_role_jwt\x18O \x01(\v2*.scalibr.SecretData.SupabaseServiceRoleJWTH\x00R\x16supabaseServiceRoleJwt\x12E\n" +
	"\rnuget_api_key\x18P \x01(\v2\x1f.scalibr.SecretData.NuGetAPIKeyH\x00R\vnugetApiKey\x12`\n" +
	"\x16nuget_proxy_credential\x18Q \x01(\v2(.scalibr.SecretData.NuGetProxyCredentialH\x00R\x14nugetProxyCredential\x12y\n" +
	"\x1fnuget_package_source_credential\x18R \x01(\v20.scalibr.SecretData.NuGetPackageSourceCredentialH\x00R\x1cnugetPackageSourceCredential\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 161)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_NuGetProxyCredential)(nil),                 // 100: scalibr.SecretData.NuGetProxyCredential
	(*SecretData_NuGetPackageSourceCredential)(nil),         // 101: scalibr.SecretData.NuGetPackageSourceCredential
	...
	(*SecretData_OnePasswordSecretKey)(nil),                 // 138: scalibr.SecretData.OnePasswordSecretKey
	(*SecretData_OnePasswordServiceToken)(nil),              // 139: scalibr.SecretData.OnePasswordServiceToken
	(*SecretData_OnePasswordRecoveryCode)(nil),              // 140: scalibr.SecretData.OnePasswordRecoveryCode
	(*SecretData_AwsAccessKeyCredentials)(nil),              // 141: scalibr.SecretData.AwsAccessKeyCredentials
	(*SecretData_ReCaptchaKey)(nil),                         // 142: scalibr.SecretData.ReCaptchaKey
	(*SecretData_PyxKeyV1)(nil),                             // 143: scalibr.SecretData.PyxKeyV1
	(*SecretData_PyxKeyV2)(nil),                             // 144: scalibr.SecretData.PyxKeyV2
	(*SecretData_CodeCatalystCredentials)(nil),              // 145: scalibr.SecretData.CodeCatalystCredentials
	(*SecretData_CodeCommitCredentials)(nil),                // 146: scalibr.SecretData.CodeCommitCredentials
	(*SecretData_BitBucketCredentials)(nil),                 // 147: scalibr.SecretData.BitBucketCredentials
	(*SecretData_ElasticCloudAPIKey)(nil),                   // 148: scalibr.SecretData.ElasticCloudAPIKey
	(*SecretData_PaystackSecretKey)(nil),                    // 149: scalibr.SecretData.PaystackSecretKey
	(*SecretData_HerokuSecretKey)(nil),                      // 150: scalibr.SecretData.HerokuSecretKey
	(*SecretData_HerokuSecretKeyMetadata)(nil),              // 151: scalibr.SecretData.HerokuSecretKeyMetadata
	(*SecretData_TelegramBotToken)(nil),                     // 152: scalibr.SecretData.TelegramBotToken
	(*SecretData_SalesforceOAuth2AccessToken)(nil),          // 153: scalibr.SecretData.SalesforceOAuth2AccessToken
	(*SecretData_SendGridAPIKey)(nil),                       // 154: scalibr.SecretData.SendGridAPIKey
	(*SecretData_SalesforceOAuth2ClientCredentials)(nil),    // 155: scalibr.SecretData.SalesforceOAuth2ClientCredentials
	(*SecretData_SalesforceOAuth2RefreshCredentials)(nil),   // 156: scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	(*SecretData_SalesforceOAuth2JWTCredentials)(nil),       // 157: scalibr.SecretData.SalesforceOAuth2JWTCredentials
	(*SecretData_CursorAPIKey)(nil),                         // 158: scalibr.SecretData.CursorAPIKey
	(*SecretData_CircleCIPersonalAccessToken)(nil),          // 159: scalibr.SecretData.CircleCIPersonalAccessToken
	(*SecretData_CircleCIProjectToken)(nil),                 // 160: scalibr.SecretData.CircleCIProjectToken
	(*SecretData_URLCredentials)(nil),                       // 161: scalibr.SecretData.URLCredentials
	(*SecretData_SquarePersonalAccessToken)(nil),            // 162: scalibr.SecretData.SquarePersonalAccessToken
	(*SecretData_NuGetAPIKey)(nil),                          // 163: scalibr.SecretData.NuGetAPIKey
	(*SecretData_SquareOAuthApplicationSecret)(nil),         // 164: scalibr.SecretData.SquareOAuthApplicationSecret
	nil,                             // 165: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil),   // 166: google.protobuf.Timestamp
	(*osvschema.Vulnerability)(nil), // 167: osv.Vulnerability
	(*durationpb.Duration)(nil),     // 168: google.protobuf.Duration
}
var file_proto_scan_result_proto_depIdxs = []int32{
	166, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	166, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	167, // 63: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	166, // 74: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	166, // 75: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	109, // 89: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	96,  // 90: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	106, // 91: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	107, // 92: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	...
	119, // 95: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	102, // 96: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	120, // 97: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	121, // 98: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	122, // 99: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	123, // 100: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	112, // 101: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	126, // 102: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	127, // 103: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	128, // 104: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	132, // 105: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	133, // 106: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	113, // 107: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	114, // 108: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	115, // 109: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	117, // 110: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	116, // 111: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	108, // 112: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	105, // 113: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	103, // 114: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	104, // 115: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	90,  // 116: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	124, // 117: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	125, // 118: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	138, // 119: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	139, // 120: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	140, // 121: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	137, // 122: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	93,  // 123: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	118, // 124: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	110, // 125: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	94,  // 126: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	134, // 127: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	135, // 128: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	136, // 129: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	141, // 130: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	142, // 131: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	143, // 132: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	144, // 133: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	145, // 134: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	83,  // 135: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	146, // 136: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	147, // 137: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	149, // 138: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	152, // 139: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	158, // 140: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	148, // 141: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	161, // 142: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	155, // 143: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	153, // 144: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	156, // 145: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	87,  // 146: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	159, // 147: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	160, // 148: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	162, // 149: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	164, // 150: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	157, // 151: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	154, // 152: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	99,  // 153: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	150, // 154: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	111, // 155: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	98,  // 156: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	129, // 157: scalibr.SecretData.supabase_pat:type_name -> scalibr.SecretData.SupabasePAT
	130, // 158: scalibr.SecretData.supabase_project_secret_key:type_name -> scalibr.SecretData.SupabaseProjectSecretKey
	131, // 159: scalibr.SecretData.supabase_service_role_jwt:type_name -> scalibr.SecretData.SupabaseServiceRoleJWT
	163, // 160: scalibr.SecretData.nuget_api_key:type_name -> scalibr.SecretData.NuGetAPIKey
	100, // 161: scalibr.SecretData.nuget_proxy_credential:type_name -> scalibr.SecretData.NuGetProxyCredential
	101, // 162: scalibr.SecretData.nuget_package_source_credential:type_name -> scalibr.SecretData.NuGetPackageSourceCredential
	4,   // 163: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	166, // 164: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	72,  // 165: scalibr.Location.filepath:type_name -> scalibr.Filepath
	73,  // 166: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	74,  // 167: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	75,  // 168: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 169: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	79,  // 170: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	77,  // 171: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	165, // 172: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	78,  // 173: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	57,  // 174: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	151, // 175: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	168, // 176: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[145].OneofWrappers = []any{}
	type x struct{}
