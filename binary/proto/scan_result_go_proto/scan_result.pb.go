...
type SecretData_UrlCredentials struct {
	UrlCredentials *SecretData_URLCredentials `protobuf:"bytes,60,opt,name=url_credentials,json=urlCredentials,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x83L\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x16telegram_bot_api_token\x18; \x01(\v2$.scalibr.SecretData.TelegramBotTokenH\x00R\x13telegramBotApiToken\x12M\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_URLCredentials)(nil),                       // 136: scalibr.SecretData.URLCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	136, // 135: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
