...
func (x *SecretData) GetQwenAiApiKey() *SecretData_QwenAIAPIKey {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_QwenAiApiKey); ok {
			return x.QwenAiApiKey
		}
	}
	return nil
}
...
type SecretData_QwenAiApiKey struct {
	QwenAiApiKey *SecretData_QwenAIAPIKey `protobuf:"bytes,89,opt,name=qwen_ai_api_key,json=qwenAiApiKey,proto3,oneof"`
}
...
func (*SecretData_QwenAiApiKey) isSecretData_Secret() {}
...
func (x *SecretData_QwenAIAPIKey) Reset() {
	*x = SecretData_QwenAIAPIKey{}
	mi := &file_proto_scan_result_proto_msgTypes[81]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_QwenAIAPIKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_QwenAIAPIKey) ProtoMessage() {}

func (x *SecretData_QwenAIAPIKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[81]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_QwenAIAPIKey.ProtoReflect.Descriptor instead.
func (*SecretData_QwenAIAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 0}
}

func (x *SecretData_QwenAIAPIKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation\"\xb8r\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12I\n" +
	"\x0fqwen_ai_api_key\x18Y \x01(\v2 .scalibr.SecretData.QwenAIAPIKeyH\x00R\fqwenAiApiKey\x1a \n" +
	"\fQwenAIAPIKey\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_QwenAIAPIKey)(nil), // 86: scalibr.SecretData.QwenAIAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	86,  // 175: scalibr.SecretData.qwen_ai_api_key:type_name -> scalibr.SecretData.QwenAIAPIKey
