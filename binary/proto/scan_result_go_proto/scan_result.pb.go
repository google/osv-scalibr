...
type SecretData_CratesIO struct {
	CratesIO *SecretData_CratesIOAPIToken `protobuf:"bytes,44,opt,name=cratesIO,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xa59\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x06pgpass\x18+ \x01(\v2\x1a.scalibr.SecretData.PgpassH\x00R\x06pgpass\x12B\n" +
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	93,  // 114: scalibr.SecretData.cratesIO:type_name -> scalibr.SecretData.CratesIOAPIToken
