...
type SecretData struct {
	...
	//	*SecretData_GrafanaServiceAccountToken_
	//	*SecretData_GrafanaCloudToken_
...
func (x *SecretData) GetGrafanaServiceAccountToken() *SecretData_GrafanaServiceAccountToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GrafanaServiceAccountToken_); ok {
			return x.GrafanaServiceAccountToken
		}
	}
	return nil
}

func (x *SecretData) GetGrafanaCloudToken() *SecretData_GrafanaCloudToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GrafanaCloudToken_); ok {
			return x.GrafanaCloudToken
		}
	}
	return nil
}
...
type SecretData_GrafanaServiceAccountToken_ struct {
	GrafanaServiceAccountToken *SecretData_GrafanaServiceAccountToken `protobuf:"bytes,89,opt,name=grafana_service_account_token,json=grafanaServiceAccountToken,proto3,oneof"`
}

type SecretData_GrafanaCloudToken_ struct {
	GrafanaCloudToken *SecretData_GrafanaCloudToken `protobuf:"bytes,90,opt,name=grafana_cloud_token,json=grafanaCloudToken,proto3,oneof"`
}
...
func (*SecretData_GrafanaServiceAccountToken_) isSecretData_Secret() {}

func (*SecretData_GrafanaCloudToken_) isSecretData_Secret() {}
...
type SecretData_GrafanaServiceAccountToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
...
func (x *SecretData_GrafanaServiceAccountToken) Reset() {
	*x = SecretData_GrafanaServiceAccountToken{}
	mi := &file_proto_scan_result_proto_msgTypes[161]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GrafanaServiceAccountToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GrafanaServiceAccountToken) ProtoMessage() {}

func (x *SecretData_GrafanaServiceAccountToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[161]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GrafanaServiceAccountToken.ProtoReflect.Descriptor instead.
func (*SecretData_GrafanaServiceAccountToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 83}
}

func (x *SecretData_GrafanaServiceAccountToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_GrafanaServiceAccountToken) GetStack() string {
	if x != nil {
		return x.Stack
	}
	return ""
...
type SecretData_GrafanaCloudToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SecretData_GrafanaCloudToken) Reset() {
	*x = SecretData_GrafanaCloudToken{}
	mi := &file_proto_scan_result_proto_msgTypes[162]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GrafanaCloudToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GrafanaCloudToken) ProtoMessage() {}

func (x *SecretData_GrafanaCloudToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[162]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GrafanaCloudToken.ProtoReflect.Descriptor instead.
func (*SecretData_GrafanaCloudToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 84}
}

func (x *SecretData_GrafanaCloudToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x8et\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dgrafana_service_account_token\x18Y \x01(\v2..scalibr.SecretData.GrafanaServiceAccountTokenH\x00R\x1agrafanaServiceAccountToken\x12W\n" +
	"\x13grafana_cloud_token\x18Z \x01(\v2%.scalibr.SecretData.GrafanaCloudTokenH\x00R\x11grafanaCloudToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\tclient_id\x18\x01 \x01(\tR\bclientId\x12#\n" +
	"\rclient_secret\x18\x02 \x01(\tR\fclientSecret\x1aH\n" +
	"\x1aGrafanaServiceAccountToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x14\n" +
	"\x05stack\x18\x02 \x01(\tR\x05stack\x1a)\n" +
	"\x11GrafanaCloudToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x1a \n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 170)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GrafanaServiceAccountToken)(nil),           // 166: scalibr.SecretData.GrafanaServiceAccountToken
	(*SecretData_GrafanaCloudToken)(nil),                    // 167: scalibr.SecretData.GrafanaCloudToken
	...
	(*SecretData_SquareOAuthApplicationSecret)(nil),         // 173: scalibr.SecretData.SquareOAuthApplicationSecret
	nil,                             // 174: scalibr.ContainerImageMetadata.OsInfoEntry
...
var file_proto_scan_result_proto_depIdxs = []int32{
	175, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	175, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	176, // 64: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	175, // 75: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	175, // 76: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	173, // 151: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	...
	166, // 170: scalibr.SecretData.grafana_service_account_token:type_name -> scalibr.SecretData.GrafanaServiceAccountToken
	167, // 171: scalibr.SecretData.grafana_cloud_token:type_name -> scalibr.SecretData.GrafanaCloudToken
	4,   // 172: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	175, // 173: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	73,  // 174: scalibr.Location.filepath:type_name -> scalibr.Filepath
	74,  // 175: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	75,  // 176: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	76,  // 177: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 178: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	80,  // 179: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	78,  // 180: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	174, // 181: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	79,  // 182: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	58,  // 183: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	158, // 184: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	177, // 185: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[65].OneofWrappers = []any{
		...
		(*SecretData_GrafanaServiceAccountToken_)(nil),
		(*SecretData_GrafanaCloudToken_)(nil),
	}
