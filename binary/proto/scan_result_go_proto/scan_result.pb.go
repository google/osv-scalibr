...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x89\x18\n" +
	"\n" +
	"SecretData\x124\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_HuggingfaceAPIKey)(nil),                // 85: scalibr.SecretData.HuggingfaceAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	85, // 88: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
