...
type SecretData_BitwardenOauth2AccessToken struct {
	BitwardenOauth2AccessToken *SecretData_BitwardenOAuth2AccessToken `protobuf:"bytes,77,opt,name=bitwarden_oauth2_access_token,json=bitwardenOauth2AccessToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xa7c\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x14cloudflare_api_token\x18L \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x12s\n" +
	"\x1dbitwarden_oauth2_access_token\x18M \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_BitwardenOAuth2AccessToken)(nil),           // 151: scalibr.SecretData.BitwardenOAuth2AccessToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	151, // 155: scalibr.SecretData.bitwarden_oauth2_access_token:type_name -> scalibr.SecretData.BitwardenOAuth2AccessToken
