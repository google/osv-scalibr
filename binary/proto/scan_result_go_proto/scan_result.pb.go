...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0x82, 0x3d, 0x0a, 0x0a, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x34,
	...
	0x63, 0x4b, 0x65, 0x79, 0x1a, 0xb0, 0x03, 0x0a, 0x06, 0x47, 0x43, 0x50, 0x53, 0x41, 0x4b, 0x12,
	...
	0x72, 0x65, 0x74, 0x1a, 0xb0, 0x02, 0x0a, 0x17, 0x4f, 0x6e, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77,
	0x6f, 0x72, 0x64, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x42, 0x08, 0x0a, 0x06, 0x73, 0x65,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 116)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_OnePasswordConnectToken)(nil),              // 117: scalibr.SecretData.OnePasswordConnectToken
	(*SecretData_OnePasswordSecretKey)(nil),                 // 118: scalibr.SecretData.OnePasswordSecretKey
	(*SecretData_OnePasswordServiceToken)(nil),              // 119: scalibr.SecretData.OnePasswordServiceToken
	(*SecretData_OnePasswordRecoveryCode)(nil),              // 120: scalibr.SecretData.OnePasswordRecoveryCode
	nil,                           // 121: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil), // 122: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	122, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	122, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	122, // 68: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	122, // 69: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	118, // 111: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	119, // 112: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	120, // 113: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	117, // 114: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	...
	122, // 121: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	...
	121, // 129: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
