...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xb1\x1e\n" +
	"\aPackage\x12\x0e\n" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xdeO\n" +
	"\n" +
	"SecretData\x124\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 139)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_SalesforceOAuth2ClientCredentials)(nil),    // 140: scalibr.SecretData.SalesforceOAuth2ClientCredentials
	(*SecretData_CursorAPIKey)(nil),                         // 141: scalibr.SecretData.CursorAPIKey
	(*SecretData_URLCredentials)(nil),                       // 142: scalibr.SecretData.URLCredentials
	nil,                                                     // 143: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil),                           // 144: google.protobuf.Timestamp
	(*osvschema.Vulnerability)(nil),                         // 145: osv.Vulnerability
}
var file_proto_scan_result_proto_depIdxs = []int32{
	144, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	144, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	145, // 61: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	144, // 72: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	144, // 73: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	141, // 138: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	137, // 139: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	142, // 140: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	140, // 141: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	4,   // 142: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	144, // 143: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	70,  // 144: scalibr.Location.filepath:type_name -> scalibr.Filepath
	71,  // 145: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	72,  // 146: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	73,  // 147: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 148: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	77,  // 149: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	75,  // 150: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	143, // 151: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	76,  // 152: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	56,  // 153: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
