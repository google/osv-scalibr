...
type Package struct {
	...
	//	*Package_BrowserExtensionsMetadata
...
func (x *Package) GetBrowserExtensionsMetadata() *BrowserExtensionsMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Package_BrowserExtensionsMetadata); ok {
			return x.BrowserExtensionsMetadata
		}
	}
	return nil
}
...
type Package_BrowserExtensionsMetadata struct {
	BrowserExtensionsMetadata *BrowserExtensionsMetadata `protobuf:"bytes,47,opt,name=browser_extensions_metadata,json=browserExtensionsMetadata,proto3,oneof"`
}
...
func (*Package_BrowserExtensionsMetadata) isPackage_Metadata() {}
...
// The additional data found in Browser extensions.
type BrowserExtensionsMetadata struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	Name                 string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	...
	HostPermissions      []string               `protobuf:"bytes,5,rep,name=host_permissions,json=hostPermissions,proto3" json:"host_permissions,omitempty"`
	ManifestVersion      int32                  `protobuf:"varint,6,opt,name=manifest_version,json=manifestVersion,proto3" json:"manifest_version,omitempty"`
	MinimumChromeVersion string                 `protobuf:"bytes,7,opt,name=minimum_chrome_version,json=minimumChromeVersion,proto3" json:"minimum_chrome_version,omitempty"`
...
func (x *BrowserExtensionsMetadata) Reset() {
	*x = BrowserExtensionsMetadata{}
	mi := &file_proto_scan_result_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BrowserExtensionsMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BrowserExtensionsMetadata) ProtoMessage() {}

func (x *BrowserExtensionsMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[50]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BrowserExtensionsMetadata.ProtoReflect.Descriptor instead.
func (*BrowserExtensionsMetadata) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{50}
}

func (x *BrowserExtensionsMetadata) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *BrowserExtensionsMetadata) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *BrowserExtensionsMetadata) GetAuthorEmail() string {
	if x != nil {
		return x.AuthorEmail
	}
	return ""
...
func (x *BrowserExtensionsMetadata) GetAuthor() string {
	if x != nil {
		return x.Author
	}
	return ""
...
func (x *BrowserExtensionsMetadata) GetHostPermissions() []string {
	if x != nil {
...
func (x *BrowserExtensionsMetadata) GetManifestVersion() int32 {
	if x != nil {
...
func (x *BrowserExtensionsMetadata) GetMinimumChromeVersion() string {
	if x != nil {
...
func (x *BrowserExtensionsMetadata) GetPermissions() []string {
	if x != nil {
...
func (x *BrowserExtensionsMetadata) GetUpdateUrl() string {
	if x != nil {
		return x.UpdateUrl
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xbc!\n" +
	"\aPackage\x12\x0e\n" +
	...
	"\x11homebrew_metadata\x18* \x01(\v2 .scalibr.HomebrewPackageMetadataH\x00R\x10homebrewMetadata\x12d\n" +
	"\x1bbrowser_extensions_metadata\x18/ \x01(\v2\".scalibr.BrowserExtensionsMetadataH\x00R\x19browserExtensionsMetadata\x12a\n" +
	...
	"\amirrors\x18\x03 \x03(\tR\amirrors\"\xd9\x02\n" +
	"\x19BrowserExtensionsMetadata\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12!\n" +
	"\fauthor_email\x18\x03 \x01(\tR\vauthorEmail\x12\x16\n" +
	"\x06author\x18\x04 \x01(\tR\x06author\x12)\n" +
	"\x10host_permissions\x18\x05 \x03(\tR\x0fhostPermissions\x12)\n" +
	"\x10manifest_version\x18\x06 \x01(\x05R\x0fmanifestVersion\x124\n" +
	"\x16minimum_chrome_version\x18\a \x01(\tR\x14minimumChromeVersion\x12 \n" +
	"\vpermissions\x18\b \x03(\tR\vpermissions\x12\x1d\n" +
	"\n" +
	"update_url\x18\t \x01(\tR\tupdateUrl\"\xac\x02\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*BrowserExtensionsMetadata)(nil),             // 57: scalibr.BrowserExtensionsMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	57,  // 45: scalibr.Package.browser_extensions_metadata:type_name -> scalibr.BrowserExtensionsMetadata
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[5].OneofWrappers = []any{
		...
		(*Package_BrowserExtensionsMetadata)(nil),
