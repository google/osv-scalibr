...
type Package_DenoMetadata struct {
	DenoMetadata *JavascriptDenoJSONMetadata `protobuf:"bytes,56,opt,name=deno_metadata,json=denoMetadata,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\x06status\x18\x03 \x01(\v2\x13.scalibr.ScanStatusR\x06status\"\xab\x1b\n" +
	"\aPackage\x12\x12\n" +
	...
	"\x13javascript_metadata\x18\x06 \x01(\v2&.scalibr.JavascriptPackageJSONMetadataH\x00R\x12javascriptMetadata\x12J\n" +
	"\rdeno_metadata\x188 \x01(\v2#.scalibr.JavascriptDenoJSONMetadataH\x00R\fdenoMetadata\x12@\n" +
	...
	"\x13from_npm_repository\x18\x04 \x01(\bR\x11fromNpmRepository\"\xaf\x01\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*JavascriptDenoJSONMetadata)(nil),              // 23: scalibr.JavascriptDenoJSONMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	23, // 16: scalibr.Package.deno_metadata:type_name -> scalibr.JavascriptDenoJSONMetadata
	...
	81, // 64: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	81, // 65: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	80, // 78: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	76, // 79: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	78, // 80: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	79, // 81: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	...
	62, // 86: scalibr.Location.filepath:type_name -> scalibr.Filepath
	63, // 87: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	64, // 88: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	65, // 89: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11, // 90: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	53, // 91: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[18].OneofWrappers = []any{
