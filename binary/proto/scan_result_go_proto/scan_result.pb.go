...
type SecretData struct {
	...
	//	*SecretData_GitlabFeatureFlagsClientToken_
...
func (x *SecretData) GetGitlabFeatureFlagsClientToken() *SecretData_GitlabFeatureFlagsClientToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GitlabFeatureFlagsClientToken_); ok {
			return x.GitlabFeatureFlagsClientToken
		}
	}
	return nil
}
...
type SecretData_GitlabFeatureFlagsClientToken_ struct {
	GitlabFeatureFlagsClientToken *SecretData_GitlabFeatureFlagsClientToken `protobuf:"bytes,89,opt,name=gitlab_feature_flags_client_token,json=gitlabFeatureFlagsClientToken,proto3,oneof"`
}
...
func (*SecretData_GitlabFeatureFlagsClientToken_) isSecretData_Secret() {}
...
type SecretData_GitlabFeatureFlagsClientToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
...
func (x *SecretData_GitlabFeatureFlagsClientToken) Reset() {
	*x = SecretData_GitlabFeatureFlagsClientToken{}
	mi := &file_proto_scan_result_proto_msgTypes[119]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GitlabFeatureFlagsClientToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GitlabFeatureFlagsClientToken) ProtoMessage() {}

func (x *SecretData_GitlabFeatureFlagsClientToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[119]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GitlabFeatureFlagsClientToken.ProtoReflect.Descriptor instead.
func (*SecretData_GitlabFeatureFlagsClientToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 41}
}

func (x *SecretData_GitlabFeatureFlagsClientToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_GitlabFeatureFlagsClientToken) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x9ds\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12}\n" +
	"!gitlab_feature_flags_client_token\x18Y \x01(\v21.scalibr.SecretData.GitlabFeatureFlagsClientTokenH\x00R\x1dgitlabFeatureFlagsClientToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\rclient_secret\x18\x02 \x01(\tR\fclientSecret\x1aQ\n" +
	"\x1dGitlabFeatureFlagsClientToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1a\n" +
	"\bendpoint\x18\x02 \x01(\tR\bendpoint\x1a\xbd\x02\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GitlabFeatureFlagsClientToken)(nil),        // 124: scalibr.SecretData.GitlabFeatureFlagsClientToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	124, // 170: scalibr.SecretData.gitlab_feature_flags_client_token:type_name -> scalibr.SecretData.GitlabFeatureFlagsClientToken
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[65].OneofWrappers = []any{
		...
		(*SecretData_GitlabFeatureFlagsClientToken_)(nil),
	}
