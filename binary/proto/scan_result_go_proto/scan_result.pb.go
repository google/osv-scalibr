...
func (x *Package) GetBazelGoMetadata() *BazelGoMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Package_BazelGoMetadata); ok {
			return x.BazelGoMetadata
		}
	}
	return nil
}
...
type Package_BazelGoMetadata struct {
	BazelGoMetadata *BazelGoMetadata `protobuf:"bytes,66,opt,name=bazel_go_metadata,json=bazelGoMetadata,proto3,oneof"`
}

type Package_DenoMetadata struct {
	DenoMetadata *JavascriptDenoMetadata `protobuf:"bytes,67,opt,name=deno_metadata,json=denoMetadata,proto3,oneof"`
}

type Package_SpackMetadata struct {
	SpackMetadata *SpackPackageMetadata `protobuf:"bytes,69,opt,name=spack_metadata,json=spackMetadata,proto3,oneof"`
}
...
func (*Package_BazelGoMetadata) isPackage_Metadata() {}
...
func (x *BazelGoMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BazelGoMetadata) ProtoMessage() {}

func (x *BazelGoMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[61]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BazelGoMetadata.ProtoReflect.Descriptor instead.
func (*BazelGoMetadata) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{61}
}

func (x *BazelGoMetadata) GetRuleName() string {
	if x != nil {
		return x.RuleName
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xae!\n" +
	"\aPackage\x12\x0e\n" +
	...
	"\x11bazel_go_metadata\x18B \x01(\v2\x18.scalibr.BazelGoMetadataH\x00R\x0fbazelGoMetadata\x12F\n" +
	"\rdeno_metadata\x18C \x01(\v2\x1f.scalibr.JavascriptDenoMetadataH\x00R\fdenoMetadata\x12F\n" +
	"\x0espack_metadata\x18E \x01(\v2\x1d.scalibr.SpackPackageMetadataH\x00R\rspackMetadata\x12[\n" +
	...
	"\trule_name\x18\x05 \x01(\tR\bruleName\".\n" +
	"\x0fBazelGoMetadata\x12\x1b\n" +
	"\trule_name\x18\x01 \x01(\tR\bruleName\"t\n" +
	"\n" +
	"DockerPort\x12\x0e\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*BazelGoMetadata)(nil),                       // 66: scalibr.BazelGoMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	27,  // 18: scalibr.Package.apk_metadata:type_name -> scalibr.APKPackageMetadata
	28,  // 19: scalibr.Package.dpkg_metadata:type_name -> scalibr.DPKGPackageMetadata
	29,  // 20: scalibr.Package.rpm_metadata:type_name -> scalibr.RPMPackageMetadata
	30,  // 21: scalibr.Package.cos_metadata:type_name -> scalibr.COSPackageMetadata
	33,  // 22: scalibr.Package.depsjson_metadata:type_name -> scalibr.DEPSJSONMetadata
	42,  // 23: scalibr.Package.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	44,  // 24: scalibr.Package.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	45,  // 25: scalibr.Package.java_lockfile_metadata:type_name -> scalibr.JavaLockfileMetadata
	31,  // 26: scalibr.Package.pacman_metadata:type_name -> scalibr.PACMANPackageMetadata
	32,  // 27: scalibr.Package.nix_metadata:type_name -> scalibr.NixPackageMetadata
	38,  // 28: scalibr.Package.kernel_module_metadata:type_name -> scalibr.KernelModuleMetadata
	39,  // 29: scalibr.Package.vmlinuz_metadata:type_name -> scalibr.VmlinuzMetadata
	35,  // 30: scalibr.Package.portage_metadata:type_name -> scalibr.PortagePackageMetadata
	46,  // 31: scalibr.Package.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	50,  // 32: scalibr.Package.netports_metadata:type_name -> scalibr.NetportsMetadata
	48,  // 33: scalibr.Package.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	49,  // 34: scalibr.Package.python_setup_metadata:type_name -> scalibr.PythonSetupMetadata
	51,  // 35: scalibr.Package.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	34,  // 36: scalibr.Package.snap_metadata:type_name -> scalibr.SNAPPackageMetadata
	36,  // 37: scalibr.Package.flatpak_metadata:type_name -> scalibr.FlatpakPackageMetadata
	40,  // 38: scalibr.Package.mac_apps_metadata:type_name -> scalibr.MacAppsMetadata
	52,  // 39: scalibr.Package.containerd_runtime_container_metadata:type_name -> scalibr.ContainerdRuntimeContainerMetadata
	43,  // 40: scalibr.Package.cdx_metadata:type_name -> scalibr.CDXPackageMetadata
	53,  // 41: scalibr.Package.windows_os_version_metadata:type_name -> scalibr.WindowsOSVersion
	54,  // 42: scalibr.Package.homebrew_metadata:type_name -> scalibr.HomebrewPackageMetadata
	55,  // 43: scalibr.Package.chrome_extensions_metadata:type_name -> scalibr.ChromeExtensionsMetadata
	56,  // 44: scalibr.Package.vscode_extensions_metadata:type_name -> scalibr.VSCodeExtensionsMetadata
	57,  // 45: scalibr.Package.podman_metadata:type_name -> scalibr.PodmanMetadata
	60,  // 46: scalibr.Package.docker_containers_metadata:type_name -> scalibr.DockerContainersMetadata
	41,  // 47: scalibr.Package.macports_metadata:type_name -> scalibr.MacportsPackageMetadata
	68,  // 48: scalibr.Package.winget_metadata:type_name -> scalibr.WingetPackageMetadata
	61,  // 49: scalibr.Package.asdf_metadata:type_name -> scalibr.AsdfMetadata
	63,  // 50: scalibr.Package.nvm_metadata:type_name -> scalibr.NvmMetadata
	64,  // 51: scalibr.Package.nodeversion_metadata:type_name -> scalibr.NodeVersionMetadata
	47,  // 52: scalibr.Package.dep_group_metadata:type_name -> scalibr.DepGroupMetadata
	58,  // 53: scalibr.Package.chocolatey_metadata:type_name -> scalibr.ChocolateyPackageMetadata
	62,  // 54: scalibr.Package.mise_metadata:type_name -> scalibr.MiseMetadata
	69,  // 55: scalibr.Package.unknown_binary_metadata:type_name -> scalibr.UnknownBinaryMetadata
	65,  // 56: scalibr.Package.bazel_maven_metadata:type_name -> scalibr.BazelMavenMetadata
	66,  // 57: scalibr.Package.bazel_go_metadata:type_name -> scalibr.BazelGoMetadata
	...
	178, // 68: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	86,  // 78: scalibr.PodmanMetadata.exposed_ports:type_name -> scalibr.PodmanMetadata.ExposedPortsEntry
	177, // 79: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	177, // 80: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	67,  // 81: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	70,  // 82: scalibr.UnknownBinaryMetadata.attribution:type_name -> scalibr.UnknownBinaryAttribution
	72,  // 83: scalibr.Secret.secret:type_name -> scalibr.SecretData
	73,  // 84: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	74,  // 85: scalibr.Secret.locations:type_name -> scalibr.LocationLegacy
	79,  // 86: scalibr.Secret.location:type_name -> scalibr.Location
	87,  // 87: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	89,  // 88: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	90,  // 89: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	91,  // 90: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	96,  // 91: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	93,  // 92: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	94,  // 93: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	102, // 94: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	112, // 95: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	101, // 96: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	109, // 97: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	110, // 98: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	97,  // 99: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	100, // 100: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	122, // 101: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	105, // 102: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	123, // 103: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	124, // 104: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	125, // 105: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	126, // 106: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	115, // 107: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	129, // 108: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	130, // 109: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	131, // 110: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	135, // 111: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	136, // 112: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	116, // 113: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	117, // 114: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	118, // 115: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	120, // 116: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	119, // 117: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	111, // 118: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	108, // 119: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	106, // 120: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	107, // 121: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	95,  // 122: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	127, // 123: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	128, // 124: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	148, // 125: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	149, // 126: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	150, // 127: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	140, // 128: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	98,  // 129: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	121, // 130: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	113, // 131: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	99,  // 132: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	137, // 133: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	138, // 134: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	139, // 135: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	151, // 136: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	152, // 137: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	153, // 138: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	154, // 139: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	155, // 140: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	88,  // 141: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	156, // 142: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	157, // 143: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	159, // 144: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	163, // 145: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	170, // 146: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	158, // 147: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	173, // 148: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	166, // 149: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	164, // 150: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	167, // 151: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	92,  // 152: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	...
	168, // 157: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	165, // 158: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	104, // 159: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	161, // 160: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	114, // 161: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	103, // 162: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	132, // 163: scalibr.SecretData.supabase_pat:type_name -> scalibr.SecretData.SupabasePAT
	133, // 164: scalibr.SecretData.supabase_project_secret_key:type_name -> scalibr.SecretData.SupabaseProjectSecretKey
	134, // 165: scalibr.SecretData.supabase_service_role_jwt:type_name -> scalibr.SecretData.SupabaseServiceRoleJWT
	142, // 166: scalibr.SecretData.packagist_api_key:type_name -> scalibr.SecretData.PackagistAPIKey
	143, // 167: scalibr.SecretData.packagist_api_secret:type_name -> scalibr.SecretData.PackagistAPISecret
	144, // 168: scalibr.SecretData.packagist_org_read_token:type_name -> scalibr.SecretData.PackagistOrgReadToken
	145, // 169: scalibr.SecretData.packagist_org_update_token:type_name -> scalibr.SecretData.PackagistOrgUpdateToken
	146, // 170: scalibr.SecretData.packagist_user_update_token:type_name -> scalibr.SecretData.PackagistUserUpdateToken
	147, // 171: scalibr.SecretData.packagist_conductor_update_token:type_name -> scalibr.SecretData.PackagistConductorUpdateToken
	141, // 172: scalibr.SecretData.composer_http_basic_credentials:type_name -> scalibr.SecretData.ComposerPackagistCredentials
	160, // 173: scalibr.SecretData.discord_bot_token:type_name -> scalibr.SecretData.DiscordBotToken
	169, // 174: scalibr.SecretData.bitwarden_oauth2_access_token:type_name -> scalibr.SecretData.BitwardenOAuth2AccessToken
	4,   // 175: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	177, // 176: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	75,  // 177: scalibr.LocationLegacy.filepath:type_name -> scalibr.Filepath
	76,  // 178: scalibr.LocationLegacy.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	77,  // 179: scalibr.LocationLegacy.environment_variable:type_name -> scalibr.EnvironmentVariable
	78,  // 180: scalibr.LocationLegacy.container_command:type_name -> scalibr.ContainerCommand
	13,  // 181: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	80,  // 182: scalibr.Location.file:type_name -> scalibr.File
	84,  // 183: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	82,  // 184: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	176, // 185: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	83,  // 186: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	59,  // 187: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	162, // 188: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	179, // 189: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[156].OneofWrappers = []any{}
	type x struct{}
