...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xd7\x16\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\vgcp_api_key\x18\x13 \x01(\v2\x1d.scalibr.SecretData.GCPAPIKeyH\x00R\tgcpApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	85, // 63: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	85, // 64: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	4,  // 88: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	85, // 89: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	61, // 90: scalibr.Location.filepath:type_name -> scalibr.Filepath
	62, // 91: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	63, // 92: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	64, // 93: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11, // 94: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	52, // 95: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
