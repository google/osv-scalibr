...
type SecretData_DatabricksUserAccountPat_ struct {
	DatabricksUserAccountPat *SecretData_DatabricksUserAccountPat `protobuf:"bytes,88,opt,name=databricks_user_account_pat,json=databricksUserAccountPat,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xb6q\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11discord_bot_token\x18W \x01(\v2#.scalibr.SecretData.DiscordBotTokenH\x00R\x0fdiscordBotToken\x12m\n" +
	"\x1bdatabricks_user_account_pat\x18X \x01(\v2,.scalibr.SecretData.DatabricksUserAccountPatH\x00R\x18databricksUserAccountPat\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\n" +
	"account_id\x18\x02 \x01(\tR\taccountIdB\b\n" +
	"\x06secret\"\xf8\x01\n" +
	"\fSecretStatus\x12>\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DatabricksUserAccountPat)(nil),             // 170: scalibr.SecretData.DatabricksUserAccountPat
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	170, // 168: scalibr.SecretData.databricks_user_account_pat:type_name -> scalibr.SecretData.DatabricksUserAccountPat
