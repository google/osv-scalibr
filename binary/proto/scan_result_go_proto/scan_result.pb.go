...
message SecretData {
  oneof secret {
    ...
    SalesforceOAuth2RefreshCredentials salesforce_oauth2_refresh_credentials = 65;
    CircleCIPersonalAccessToken circleci_personal_access_token = 66;
    CircleCIProjectToken circleci_project_token = 67;
  }
  ...
  message CodeCommitCredentials {
    string url = 1;
  }

  message BitBucketCredentials {
    string url = 1;
  }

  message ElasticCloudAPIKey {
    string key = 1;
  }

  message PaystackSecretKey {
    string key = 1;
  }
  ...
  message SalesforceOAuth2AccessToken {
  ...
  message SalesforceOAuth2RefreshCredentials {
    // Salesforce OAuth2 client ID
    string id = 1;
    // Salesforce OAuth2 client secret
    string secret = 2;
  ...
  message CursorAPIKey {
    string key = 1;
  }
  
  message CircleCIPersonalAccessToken {
    string token = 1;
  }

  message CircleCIProjectToken {
    string token = 1;
  }

  message URLCredentials {
    string url = 1;
  }
}
