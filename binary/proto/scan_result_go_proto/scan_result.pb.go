...
type SecretData struct {
	...
	//	*SecretData_DatabricksServicePrincipalPat
...
func (x *SecretData) GetDatabricksServicePrincipalPat() *DatabricksServicePrincipalPat {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_DatabricksServicePrincipalPat); ok {
...
type SecretData_DatabricksServicePrincipalPat struct {
	DatabricksServicePrincipalPat *DatabricksServicePrincipalPat `protobuf:"bytes,75,opt,name=databricks_service_principal_pat,json=databricksServicePrincipalPat,proto3,oneof"`
}
...
func (*SecretData_DatabricksServicePrincipalPat) isSecretData_Secret() {}

type DatabricksServicePrincipalPat struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DatabricksServicePrincipalPat) Reset() {
	*x = DatabricksServicePrincipalPat{}
	mi := &file_proto_scan_result_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DatabricksServicePrincipalPat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatabricksServicePrincipalPat) ProtoMessage() {}

func (x *DatabricksServicePrincipalPat) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatabricksServicePrincipalPat.ProtoReflect.Descriptor instead.
func (*DatabricksServicePrincipalPat) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{63}
}

func (x *DatabricksServicePrincipalPat) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *DatabricksServicePrincipalPat) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xbd`\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	" databricks_service_principal_pat\x18K \x01(\v2&.scalibr.DatabricksServicePrincipalPatH\x00R\x1ddatabricksServicePrincipalPat\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x03url\x18\x02 \x01(\tR\x03url\"\xf8\x01\n" +
	"\fSecretStatus\x12>\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*DatabricksServicePrincipalPat)(nil),         // 68: scalibr.DatabricksServicePrincipalPat
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	68,  // 153: scalibr.SecretData.databricks_service_principal_pat:type_name -> scalibr.DatabricksServicePrincipalPat
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[62].OneofWrappers = []any{
		...
		(*SecretData_DatabricksServicePrincipalPat)(nil),
	}
