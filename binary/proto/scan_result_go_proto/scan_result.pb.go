...
func (x *SecretData) GetGitlabAgentToken() *SecretData_GitlabAgentToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GitlabAgentToken_); ok {
			return x.GitlabAgentToken
		}
	}
	return nil
}
...
type SecretData_GitlabAgentToken_ struct {
	GitlabAgentToken *SecretData_GitlabAgentToken `protobuf:"bytes,89,opt,name=gitlab_agent_token,json=gitlabAgentToken,proto3,oneof"`
}
...
func (*SecretData_GitlabAgentToken_) isSecretData_Secret() {}
...
type SecretData_GitlabAgentToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	KasUrl        string                 `protobuf:"bytes,2,opt,name=kas_url,json=kasUrl,proto3" json:"kas_url,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SecretData_GitlabAgentToken) Reset() {
	*x = SecretData_GitlabAgentToken{}
	mi := &file_proto_scan_result_proto_msgTypes[100]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GitlabAgentToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GitlabAgentToken) ProtoMessage() {}

func (x *SecretData_GitlabAgentToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[100]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GitlabAgentToken.ProtoReflect.Descriptor instead.
func (*SecretData_GitlabAgentToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{66, 19}
}

func (x *SecretData_GitlabAgentToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_GitlabAgentToken) GetKasUrl() string {
	if x != nil {
		return x.KasUrl
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation\"\xe4r\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12T\n" +
	"\x12gitlab_agent_token\x18Y \x01(\v2$.scalibr.SecretData.GitlabAgentTokenH\x00R\x10gitlabAgentToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\tGitlabPat\x12\x10\n" +
	"\x03pat\x18\x01 \x01(\tR\x03pat\x1aA\n" +
	"\x10GitlabAgentToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x17\n" +
	"\akas_url\x18\x02 \x01(\tR\x06kasUrl\x1a*\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GitlabAgentToken)(nil),                     // 105: scalibr.SecretData.GitlabAgentToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	105, // 174: scalibr.SecretData.gitlab_agent_token:type_name -> scalibr.SecretData.GitlabAgentToken
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[66].OneofWrappers = []any{
		...
		(*SecretData_GitlabAgentToken_)(nil),
	}
