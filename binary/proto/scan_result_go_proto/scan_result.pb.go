...
func (x *SecretData) GetAnthropicApiKey() *SecretData_AnthropicAPIKey {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_AnthropicApiKey); ok {
...
type SecretData_AnthropicApiKey struct {
	AnthropicApiKey *SecretData_AnthropicAPIKey `protobuf:"bytes,2,opt,name=anthropic_api_key,json=anthropicApiKey,proto3,oneof"`
}

func (*SecretData_Gcpsak) isSecretData_Secret() {}

func (*SecretData_AnthropicApiKey) isSecretData_Secret() {}
...
func (x *SecretData_AnthropicAPIKey) Reset() {
	*x = SecretData_AnthropicAPIKey{}
	mi := &file_proto_scan_result_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_AnthropicAPIKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_AnthropicAPIKey) ProtoMessage() {}

func (x *SecretData_AnthropicAPIKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_AnthropicAPIKey.ProtoReflect.Descriptor instead.
func (*SecretData_AnthropicAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{50, 1}
}

func (x *SecretData_AnthropicAPIKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xf7\x04\n" +
	"\n" +
	"SecretData\x124\n" +
	"\x06gcpsak\x18\x01 \x01(\v2\x1a.scalibr.SecretData.GCPSAKH\x00R\x06gcpsak\x12Q\n" +
	"\x11anthropic_api_key\x18\x02 \x01(\v2#.scalibr.SecretData.AnthropicAPIKeyH\x00R\x0fanthropicApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_AnthropicAPIKey)(nil),         // 64: scalibr.SecretData.AnthropicAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	64, // 67: scalibr.SecretData.anthropic_api_key:type_name -> scalibr.SecretData.AnthropicAPIKey
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[50].OneofWrappers = []any{
		...
		(*SecretData_AnthropicApiKey)(nil),
	}
