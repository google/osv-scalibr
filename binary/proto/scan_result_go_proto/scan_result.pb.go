...
type Package struct {
	...
	Metadata *anypb.Any `protobuf:"bytes,68,opt,name=metadata,proto3,oneof" json:"metadata,omitempty"`
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\bmetadata\x18D \x01(\v2\x14.google.protobuf.AnyH\x00R\bmetadata\x88\x01\x01\x12[\n" +
	...
	"J\x04\b\r\x10\x1aJ\x04\b\x1d\x10#J\x04\b$\x101J\x04\b2\x103J\x04\b5\x109J\x04\b:\x10;J\x04\b;\x10<J\x04\b=\x10D\"B\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*FSMetadata)(nil),                            // 49: scalibr.FSMetadata
	...
	(*Location)(nil),                              // 73: scalibr.Location
	...
	(*ContainerImageMetadata)(nil),                // 78: scalibr.ContainerImageMetadata
	(*BaseImageChain)(nil),                        // 79: scalibr.BaseImageChain
	(*BaseImageDetails)(nil),                      // 80: scalibr.BaseImageDetails
	(*LayerMetadata)(nil),                         // 81: scalibr.LayerMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	78,  // 9: scalibr.Inventory.container_image_metadata:type_name -> scalibr.ContainerImageMetadata
	...
	175, // 15: scalibr.Package.metadata:type_name -> google.protobuf.Any
	13,  // 16: scalibr.Package.exploitability_signals:type_name -> scalibr.PackageExploitabilitySignal
	82,  // 17: scalibr.Package.container_image_metadata_indexes:type_name -> scalibr.Package.ContainerImageMetadataIndexes
	...
	176, // 22: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	83,  // 32: scalibr.PodmanMetadata.exposed_ports:type_name -> scalibr.PodmanMetadata.ExposedPortsEntry
	174, // 33: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	174, // 34: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	66,  // 35: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	69,  // 36: scalibr.UnknownBinaryMetadata.attribution:type_name -> scalibr.UnknownBinaryAttribution
	71,  // 37: scalibr.Secret.secret:type_name -> scalibr.SecretData
	72,  // 38: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	73,  // 39: scalibr.Secret.locations:type_name -> scalibr.Location
	84,  // 40: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	86,  // 41: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	87,  // 42: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	88,  // 43: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	93,  // 44: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	90,  // 45: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	91,  // 46: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	99,  // 47: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	109, // 48: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	98,  // 49: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	106, // 50: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	107, // 51: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	94,  // 52: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	97,  // 53: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	119, // 54: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	102, // 55: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	120, // 56: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	121, // 57: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	122, // 58: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	123, // 59: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	112, // 60: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	126, // 61: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	127, // 62: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	128, // 63: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	132, // 64: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	133, // 65: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	113, // 66: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	114, // 67: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	115, // 68: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	117, // 69: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	116, // 70: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	108, // 71: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	105, // 72: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	103, // 73: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	104, // 74: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	92,  // 75: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	124, // 76: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	125, // 77: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	145, // 78: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	146, // 79: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	147, // 80: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	137, // 81: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	95,  // 82: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	118, // 83: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	110, // 84: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	96,  // 85: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	134, // 86: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	135, // 87: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	136, // 88: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	148, // 89: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	149, // 90: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	150, // 91: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	151, // 92: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	152, // 93: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	85,  // 94: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	153, // 95: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	154, // 96: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	156, // 97: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	160, // 98: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	167, // 99: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	155, // 100: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	170, // 101: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	163, // 102: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	161, // 103: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	164, // 104: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	89,  // 105: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	168, // 106: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	169, // 107: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	171, // 108: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	172, // 109: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	165, // 110: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	162, // 111: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	101, // 112: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	158, // 113: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	111, // 114: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	100, // 115: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	129, // 116: scalibr.SecretData.supabase_pat:type_name -> scalibr.SecretData.SupabasePAT
	130, // 117: scalibr.SecretData.supabase_project_secret_key:type_name -> scalibr.SecretData.SupabaseProjectSecretKey
	131, // 118: scalibr.SecretData.supabase_service_role_jwt:type_name -> scalibr.SecretData.SupabaseServiceRoleJWT
	139, // 119: scalibr.SecretData.packagist_api_key:type_name -> scalibr.SecretData.PackagistAPIKey
	140, // 120: scalibr.SecretData.packagist_api_secret:type_name -> scalibr.SecretData.PackagistAPISecret
	141, // 121: scalibr.SecretData.packagist_org_read_token:type_name -> scalibr.SecretData.PackagistOrgReadToken
	142, // 122: scalibr.SecretData.packagist_org_update_token:type_name -> scalibr.SecretData.PackagistOrgUpdateToken
	143, // 123: scalibr.SecretData.packagist_user_update_token:type_name -> scalibr.SecretData.PackagistUserUpdateToken
	144, // 124: scalibr.SecretData.packagist_conductor_update_token:type_name -> scalibr.SecretData.PackagistConductorUpdateToken
	138, // 125: scalibr.SecretData.composer_http_basic_credentials:type_name -> scalibr.SecretData.ComposerPackagistCredentials
	157, // 126: scalibr.SecretData.discord_bot_token:type_name -> scalibr.SecretData.DiscordBotToken
	166, // 127: scalibr.SecretData.bitwarden_oauth2_access_token:type_name -> scalibr.SecretData.BitwardenOAuth2AccessToken
	4,   // 128: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	174, // 129: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	74,  // 130: scalibr.Location.filepath:type_name -> scalibr.Filepath
	75,  // 131: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	76,  // 132: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	77,  // 133: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 134: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	81,  // 135: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	79,  // 136: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	173, // 137: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	80,  // 138: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	59,  // 139: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	159, // 140: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	177, // 141: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
