...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xfcK\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x0ecursor_api_key\x18< \x01(\v2 .scalibr.SecretData.CursorAPIKeyH\x00R\fcursorApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_CursorAPIKey)(nil),                         // 136: scalibr.SecretData.CursorAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	136, // 135: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
