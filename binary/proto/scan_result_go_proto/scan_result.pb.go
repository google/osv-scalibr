...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xa6\x0f\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1fpostman_collection_access_token\x18\f \x01(\v20.scalibr.SecretData.PostmanCollectionAccessTokenH\x00R\x1cpostmanCollectionAccessToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
...
var file_proto_scan_result_proto_depIdxs = []int32{
	78, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	78, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	78, // 63: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	78, // 64: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	4,  // 81: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	78, // 82: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	61, // 83: scalibr.Location.filepath:type_name -> scalibr.Filepath
	62, // 84: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	63, // 85: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	64, // 86: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11, // 87: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	52, // 88: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
