...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xca`\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x12npmjs_access_token\x18K \x01(\v2$.scalibr.SecretData.NpmJsAccessTokenH\x00R\x10npmjsAccessToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_NpmJsAccessToken)(nil),                     // 106: scalibr.SecretData.NpmJsAccessToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	106, // 153: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
