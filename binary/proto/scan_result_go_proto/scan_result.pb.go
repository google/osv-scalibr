...
type SecretData_OnepasswordSecretKey struct {
	OnepasswordSecretKey *SecretData_OnePasswordSecretKey `protobuf:"bytes,32,opt,name=onepassword_secret_key,json=onepasswordSecretKey,proto3,oneof"`
}

type SecretData_OnepasswordServiceToken struct {
	OnepasswordServiceToken *SecretData_OnePasswordServiceToken `protobuf:"bytes,33,opt,name=onepassword_service_token,json=onepasswordServiceToken,proto3,oneof"`
}

type SecretData_OnepasswordRecoveryCode struct {
	OnepasswordRecoveryCode *SecretData_OnePasswordRecoveryCode `protobuf:"bytes,34,opt,name=onepassword_recovery_code,json=onepasswordRecoveryCode,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xa3)\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x12github_oauth_token\x18\x1f \x01(\v2$.scalibr.SecretData.GithubOAuthTokenH\x00R\x10githubOauthToken\x12`\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 101)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_OnePasswordSecretKey)(nil),                 // 103: scalibr.SecretData.OnePasswordSecretKey
	(*SecretData_OnePasswordServiceToken)(nil),              // 104: scalibr.SecretData.OnePasswordServiceToken
	(*SecretData_OnePasswordRecoveryCode)(nil),              // 105: scalibr.SecretData.OnePasswordRecoveryCode
	(*timestamppb.Timestamp)(nil),                           // 106: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	106, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	106, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	106, // 65: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	106, // 66: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	103, // 102: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	104, // 103: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	105, // 104: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	4,   // 105: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	106, // 106: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	62,  // 107: scalibr.Location.filepath:type_name -> scalibr.Filepath
	63,  // 108: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	64,  // 109: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	65,  // 110: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11,  // 111: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	69,  // 112: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	67,  // 113: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	68,  // 114: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	52,  // 115: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
