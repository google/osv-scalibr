...
type SecretData_MysqlMyloginSection_ struct {
	MysqlMyloginSection *SecretData_MysqlMyloginSection `protobuf:"bytes,47,opt,name=mysql_mylogin_section,json=mysqlMyloginSection,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x85>\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x14maria_db_credentials\x18. \x01(\v2&.scalibr.SecretData.MariaDBCredentialsH\x00R\x12mariaDbCredentials\x12]\n" +
	"\x15mysql_mylogin_section\x18/ \x01(\v2'.scalibr.SecretData.MysqlMyloginSectionH\x00R\x13mysqlMyloginSection\x1a\xa8\x01\n" +
	...
	"\x06socket\x18\x06 \x01(\tR\x06socket\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_MysqlMyloginSection)(nil), // 75: scalibr.SecretData.MysqlMyloginSection
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	76,  // 74: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	...
	75,  // 119: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
