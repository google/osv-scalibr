...
func (*SecretData_AnthropicModelAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{50, 2}
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xa9\x06\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x17anthropic_model_api_key\x18\x03 \x01(\v2(.scalibr.SecretData.AnthropicModelAPIKeyH\x00R\x14anthropicModelApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_AnthropicWorkspaceAPIKey)(nil), // 64: scalibr.SecretData.AnthropicWorkspaceAPIKey
	(*SecretData_AnthropicModelAPIKey)(nil),     // 65: scalibr.SecretData.AnthropicModelAPIKey
	(*timestamppb.Timestamp)(nil),               // 66: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	66, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	66, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	66, // 60: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	66, // 61: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	64, // 67: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	65, // 68: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	4,  // 69: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	66, // 70: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	58, // 71: scalibr.Location.filepath:type_name -> scalibr.Filepath
	59, // 72: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	60, // 73: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	61, // 74: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11, // 75: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	51, // 76: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
