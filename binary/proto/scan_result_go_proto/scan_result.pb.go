...
type SecretData_IbmCloudSecretKey struct {
	IbmCloudSecretKey *SecretData_IBMCloudUserSecretKey `protobuf:"bytes,77,opt,name=ibm_cloud_secret_key,json=ibmCloudSecretKey,proto3,oneof"`
}
...
func (*SecretData_SquareOAuthApplicationSecret) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{62, 78}
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xdfd\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x14ibm_cloud_secret_key\x18M \x01(\v2).scalibr.SecretData.IBMCloudUserSecretKeyH\x00R\x11ibmCloudSecretKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_IBMCloudUserSecretKey)(nil),                // 145: scalibr.SecretData.IBMCloudUserSecretKey
	(*SecretData_IBMCloudUserSecretKeyMetadata)(nil),        // 146: scalibr.SecretData.IBMCloudUserSecretKeyMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	161, // 61: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	160, // 72: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	160, // 73: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	153, // 138: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	141, // 139: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	156, // 140: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	150, // 141: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	148, // 142: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	151, // 143: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	85,  // 144: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	154, // 145: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	155, // 146: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	157, // 147: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	158, // 148: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	152, // 149: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	149, // 150: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	...
	145, // 155: scalibr.SecretData.ibm_cloud_secret_key:type_name -> scalibr.SecretData.IBMCloudUserSecretKey
	4,   // 156: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	160, // 157: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	...
	159, // 165: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	...
	144, // 168: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	162, // 169: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
	146, // 170: scalibr.SecretData.IBMCloudUserSecretKey.ibm_cloud_secret_key_metadata:type_name -> scalibr.SecretData.IBMCloudUserSecretKeyMetadata
