...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xdc, 0x06, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x73, 0x76, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x0a, 0x0a, 0x08, 0x6d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x11,
	0x10, 0x12, 0x4a, 0x04, 0x08, 0x12, 0x10, 0x13, 0x4a, 0x04, 0x08, 0x13, 0x10, 0x14, 0x22, 0xc8,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x22, 0x4c, 0x0a, 0x13, 0x53, 0x50, 0x44, 0x58, 0x50, 0x61, 0x63, 0x6b,
	...
	0x41, 0x73, 0x42, 0x3f, 0x50, 0x01, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
...
var file_proto_scan_result_proto_depIdxs = []int32{
	24, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	24, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	8,  // 18: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	10, // 19: scalibr.Finding.adv:type_name -> scalibr.Advisory
	14, // 20: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	11, // 21: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	1,  // 22: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	12, // 23: scalibr.Advisory.sev:type_name -> scalibr.Severity
	2,  // 24: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	13, // 25: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	13, // 26: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	6,  // 27: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	7,  // 28: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
