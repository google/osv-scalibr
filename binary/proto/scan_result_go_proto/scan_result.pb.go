...
type SecretData_ClojarsDeployToken_ struct {
	ClojarsDeployToken *SecretData_ClojarsDeployToken `protobuf:"bytes,89,opt,name=clojars_deploy_token,json=clojarsDeployToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xd3r\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12Z\n" +
	"\x14clojars_deploy_token\x18Y \x01(\v2&.scalibr.SecretData.ClojarsDeployTokenH\x00R\x12clojarsDeployToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_ClojarsDeployToken)(nil), // 85: scalibr.SecretData.ClojarsDeployToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	86,  // 83: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	87,  // 84: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	88,  // 85: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	93,  // 86: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	90,  // 87: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	91,  // 88: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	99,  // 89: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	109, // 90: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	98,  // 91: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	...
	94,  // 94: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	97,  // 95: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	119, // 96: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	102, // 97: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	...
	92,  // 117: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	...
	95,  // 124: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	...
	96,  // 127: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	...
	89,  // 147: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	...
	101, // 154: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	...
	100, // 157: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	...
	85,  // 170: scalibr.SecretData.clojars_deploy_token:type_name -> scalibr.SecretData.ClojarsDeployToken
