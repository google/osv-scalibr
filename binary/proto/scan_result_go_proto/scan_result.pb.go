...
type SecretData_DiscordBotToken_ struct {
	DiscordBotToken *SecretData_DiscordBotToken `protobuf:"bytes,80,opt,name=discord_bot_token,json=discordBotToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x86f\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11discord_bot_token\x18P \x01(\v2#.scalibr.SecretData.DiscordBotTokenH\x00R\x0fdiscordBotToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DiscordBotToken)(nil),                      // 148: scalibr.SecretData.DiscordBotToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	148, // 160: scalibr.SecretData.discord_bot_token:type_name -> scalibr.SecretData.DiscordBotToken
