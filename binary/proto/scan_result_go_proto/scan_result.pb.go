...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xa1, 0x0e, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x60, 0x0a, 0x0e, 0x41, 0x6e, 0x6e,
	...
	0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x04, 0x50, 0x75, 0x72, 0x6c,
	...
	0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x5d, 0x0a,
	0x0d, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x30,
	0x0a, 0x09, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x12, 0x2e, 0x73, 0x63, 0x61, 0x6c, 0x69, 0x62, 0x72, 0x2e, 0x49, 0x6e, 0x76, 0x65,
	...
	0x52, 0x0b, 0x6f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0xfc, 0x01,
	...
	0x6c, 0x6f, 0x70, 0x65, 0x72, 0x22, 0x4c, 0x0a, 0x13, 0x53, 0x50, 0x44, 0x58, 0x50, 0x61, 0x63,
	...
	0x74, 0x6f, 0x72, 0x22, 0xdc, 0x02, 0x0a, 0x1b, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65,
	...
	0x69, 0x64, 0x22, 0xea, 0x01, 0x0a, 0x22, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_proto_scan_result_proto_goTypes = []interface{}{
	...
	(*WindowsOSVersion)(nil),                   // 33: scalibr.WindowsOSVersion
	(*timestamppb.Timestamp)(nil),              // 34: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	34, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	34, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	33, // 26: scalibr.Inventory.windows_os_version_metadata:type_name -> scalibr.WindowsOSVersion
	1,  // 27: scalibr.Inventory.annotations:type_name -> scalibr.Inventory.AnnotationEnum
	10, // 28: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	12, // 29: scalibr.Finding.adv:type_name -> scalibr.Advisory
	16, // 30: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	13, // 31: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	2,  // 32: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	14, // 33: scalibr.Advisory.sev:type_name -> scalibr.Severity
	3,  // 34: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	15, // 35: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	15, // 36: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	7,  // 37: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	9,  // 38: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
	9,  // 39: scalibr.CDXPackageMetadata.purl:type_name -> scalibr.Purl
