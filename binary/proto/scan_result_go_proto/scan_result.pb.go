...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation\"\xa3r\n" +
	"\n" +
	"SecretData\x124\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_QwenPat)(nil),                              // 175: scalibr.SecretData.QwenPat
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	175, // 174: scalibr.SecretData.qwen__pat:type_name -> scalibr.SecretData.QwenPat
	...
	161, // 188: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
