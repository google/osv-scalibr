...
type SecretData_CloudflareApiToken struct {
	CloudflareApiToken *SecretData_CloudflareAPIToken `protobuf:"bytes,66,opt,name=cloudflare_api_token,json=cloudflareApiToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x89T\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"%salesforce_oauth2_refresh_credentials\x18A \x01(\v26.scalibr.SecretData.SalesforceOAuth2RefreshCredentialsH\x00R\"salesforceOauth2RefreshCredentials\x12Z\n" +
	"\x14cloudflare_api_token\x18B \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_CloudflareAPIToken)(nil),                   // 95: scalibr.SecretData.CloudflareAPIToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	95,  // 144: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
