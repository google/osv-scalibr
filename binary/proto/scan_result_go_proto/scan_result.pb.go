...
type SecretData_DockerHubPat_ struct {
	DockerHubPat *SecretData_DockerHubPat `protobuf:"bytes,6,opt,name=docker_hub_pat,json=dockerHubPat,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x98\t\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"privateKey\x12H\n" +
	"\x0edocker_hub_pat\x18\x06 \x01(\v2 .scalibr.SecretData.DockerHubPatH\x00R\fdockerHubPat\x1a<\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 67)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DockerHubPat)(nil),             // 66: scalibr.SecretData.DockerHubPat
	...
	(*SecretData_PrivateKey)(nil),               // 71: scalibr.SecretData.PrivateKey
	(*timestamppb.Timestamp)(nil),               // 72: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	72, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	72, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	72, // 63: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	72, // 64: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	67, // 69: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	68, // 70: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	69, // 71: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	70, // 72: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	71, // 73: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	66, // 74: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	4,  // 75: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	72, // 76: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	61, // 77: scalibr.Location.filepath:type_name -> scalibr.Filepath
	62, // 78: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	63, // 79: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	64, // 80: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11, // 81: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	52, // 82: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
