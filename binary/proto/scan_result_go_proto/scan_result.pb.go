...
type SecretData struct {
	...
	//	*SecretData_SapOauth2ClientCredentials
...
func (x *SecretData) GetSapOauth2ClientCredentials() *SecretData_SAPOAuth2ClientCredentials {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_SapOauth2ClientCredentials); ok {
			return x.SapOauth2ClientCredentials
		}
	}
	return nil
}
...
type SecretData_SapOauth2ClientCredentials struct {
	SapOauth2ClientCredentials *SecretData_SAPOAuth2ClientCredentials `protobuf:"bytes,89,opt,name=sap_oauth2_client_credentials,json=sapOauth2ClientCredentials,proto3,oneof"`
}
...
func (*SecretData_SapOauth2ClientCredentials) isSecretData_Secret() {}
...
type SecretData_SAPOAuth2ClientCredentials struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// SAP OAuth2 client ID
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// SAP OAuth2 client Secret
	Secret string `protobuf:"bytes,2,opt,name=secret,proto3" json:"secret,omitempty"`
	// SAP Token URL
...
func (x *SecretData_SAPOAuth2ClientCredentials) Reset() {
	*x = SecretData_SAPOAuth2ClientCredentials{}
	mi := &file_proto_scan_result_proto_msgTypes[167]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_SAPOAuth2ClientCredentials) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_SAPOAuth2ClientCredentials) ProtoMessage() {}

func (x *SecretData_SAPOAuth2ClientCredentials) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[167]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_SAPOAuth2ClientCredentials.ProtoReflect.Descriptor instead.
func (*SecretData_SAPOAuth2ClientCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 89}
}

func (x *SecretData_SAPOAuth2ClientCredentials) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SecretData_SAPOAuth2ClientCredentials) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *SecretData_SAPOAuth2ClientCredentials) GetTokenUrl() string {
	if x != nil {
		return x.TokenUrl
	}
	return ""
...
func (x *SecretData_SAPOAuth2ClientCredentials) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xb5s\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dsap_oauth2_client_credentials\x18Y \x01(\v2..scalibr.SecretData.SAPOAuth2ClientCredentialsH\x00R\x1asapOauth2ClientCredentials\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x1aSAPOAuth2ClientCredentials\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06secret\x18\x02 \x01(\tR\x06secret\x12\x1b\n" +
	"\ttoken_url\x18\x03 \x01(\tR\btokenUrl\x12\x10\n" +
	"\x03url\x18\x04 \x01(\tR\x03urlB\b\n" +
	"\x06secret\"\xf8\x01\n" +
	"\fSecretStatus\x12>\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_SAPOAuth2ClientCredentials)(nil),           // 172: scalibr.SecretData.SAPOAuth2ClientCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	172, // 170: scalibr.SecretData.sap_oauth2_client_credentials:type_name -> scalibr.SecretData.SAPOAuth2ClientCredentials
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[65].OneofWrappers = []any{
		...
		(*SecretData_SapOauth2ClientCredentials)(nil),
	}
