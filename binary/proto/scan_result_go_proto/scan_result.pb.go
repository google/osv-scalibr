...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xa5, 0x0f, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x09, 0x52, 0x0b, 0x6f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0xfc,
	...
	0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72, 0x22, 0xbb, 0x03, 0x0a, 0x0f, 0x4d, 0x61, 0x63, 0x41, 0x70,
	...
	0x65, 0x55, 0x72, 0x6c, 0x22, 0x4c, 0x0a, 0x13, 0x53, 0x50, 0x44, 0x58, 0x50, 0x61, 0x63, 0x6b,
	...
	0x52, 0x04, 0x73, 0x68, 0x61, 0x31, 0x22, 0x78, 0x0a, 0x14, 0x4a, 0x61, 0x76, 0x61, 0x4c, 0x6f,
	...
	0x6f, 0x72, 0x22, 0xdc, 0x02, 0x0a, 0x1b, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	...
	0x64, 0x22, 0xea, 0x01, 0x0a, 0x22, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x64,
	0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	...
	0x28, 0x09, 0x52, 0x0b, 0x66, 0x75, 0x6c, 0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_proto_scan_result_proto_goTypes = []interface{}{
	...
	(*SNAPPackageMetadata)(nil),                // 24: scalibr.SNAPPackageMetadata
	(*FlatpakPackageMetadata)(nil),             // 25: scalibr.FlatpakPackageMetadata
	(*MacAppsMetadata)(nil),                    // 26: scalibr.MacAppsMetadata
	(*SPDXPackageMetadata)(nil),                // 27: scalibr.SPDXPackageMetadata
	(*CDXPackageMetadata)(nil),                 // 28: scalibr.CDXPackageMetadata
	(*JavaArchiveMetadata)(nil),                // 29: scalibr.JavaArchiveMetadata
	(*JavaLockfileMetadata)(nil),               // 30: scalibr.JavaLockfileMetadata
	(*OSVPackageMetadata)(nil),                 // 31: scalibr.OSVPackageMetadata
	(*PythonRequirementsMetadata)(nil),         // 32: scalibr.PythonRequirementsMetadata
	(*ContainerdContainerMetadata)(nil),        // 33: scalibr.ContainerdContainerMetadata
	(*ContainerdRuntimeContainerMetadata)(nil), // 34: scalibr.ContainerdRuntimeContainerMetadata
	(*WindowsOSVersion)(nil),                   // 35: scalibr.WindowsOSVersion
	(*timestamppb.Timestamp)(nil),              // 36: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	36, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	36, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	27, // 16: scalibr.Inventory.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	29, // 17: scalibr.Inventory.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	30, // 18: scalibr.Inventory.java_lockfile_metadata:type_name -> scalibr.JavaLockfileMetadata
	31, // 19: scalibr.Inventory.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	32, // 20: scalibr.Inventory.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	33, // 21: scalibr.Inventory.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	24, // 22: scalibr.Inventory.snap_metadata:type_name -> scalibr.SNAPPackageMetadata
	25, // 23: scalibr.Inventory.flatpak_metadata:type_name -> scalibr.FlatpakPackageMetadata
	26, // 24: scalibr.Inventory.mac_apps_metadata:type_name -> scalibr.MacAppsMetadata
	34, // 25: scalibr.Inventory.containerd_runtime_container_metadata:type_name -> scalibr.ContainerdRuntimeContainerMetadata
	28, // 26: scalibr.Inventory.cdx_metadata:type_name -> scalibr.CDXPackageMetadata
	35, // 27: scalibr.Inventory.windows_os_version_metadata:type_name -> scalibr.WindowsOSVersion
	1,  // 28: scalibr.Inventory.annotations:type_name -> scalibr.Inventory.AnnotationEnum
	9,  // 29: scalibr.Inventory.layer_details:type_name -> scalibr.LayerDetails
	11, // 30: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	13, // 31: scalibr.Finding.adv:type_name -> scalibr.Advisory
	17, // 32: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	14, // 33: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	2,  // 34: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	15, // 35: scalibr.Advisory.sev:type_name -> scalibr.Severity
	3,  // 36: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	16, // 37: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	16, // 38: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	7,  // 39: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	10, // 40: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
	10, // 41: scalibr.CDXPackageMetadata.purl:type_name -> scalibr.Purl
