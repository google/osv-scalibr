...
type Package struct {
	...
	Metadata *anypb.Any `protobuf:"bytes,67,opt,name=metadata,proto3,oneof" json:"metadata,omitempty"`
...
func (x *Package) GetMetadata() *anypb.Any {
	if x != nil {
		return x.Metadata
	}
	return nil
...
// Used for holding a non-serializable filesystem.
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xaa\x06\n" +
	"\aPackage\x12\x0e\n" +
	...
	"\aplugins\x181 \x03(\tR\aplugins\x125\n" +
	"\bmetadata\x18C \x01(\v2\x14.google.protobuf.AnyH\x00R\bmetadata\x88\x01\x01\x12[\n" +
	...
	"\x10\vJ\x04\b\x1c\x10\x1dJ\x04\b#\x10$J\x04\b\x05\x10\n" +
	"J\x04\b\r\x10\x1aJ\x04\b\x1d\x10#J\x04\b$\x101J\x04\b2\x103J\x04\b5\x109J\x04\b:\x10;J\x04\b;\x10<J\x04\b=\x10C\"B\n" +
	...
	"\x12version_comparator\x18\x02 \x01(\tR\x11versionComparator\"#\n" +
	"\n" +
	"FSMetadata\x12\x15\n" +
	"\x06has_fs\x18\x01 \x01(\bR\x05hasFs\"e\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*FSMetadata)(nil),                            // 48: scalibr.FSMetadata
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	173, // 15: scalibr.Package.metadata:type_name -> google.protobuf.Any
	13,  // 16: scalibr.Package.exploitability_signals:type_name -> scalibr.PackageExploitabilitySignal
	81,  // 17: scalibr.Package.container_image_metadata_indexes:type_name -> scalibr.Package.ContainerImageMetadataIndexes
	0,   // 18: scalibr.PackageExploitabilitySignal.justification:type_name -> scalibr.VexJustification
	14,  // 19: scalibr.PackageExploitabilitySignal.vuln_identifiers:type_name -> scalibr.VulnIdentifiers
	0,   // 20: scalibr.FindingExploitabilitySignal.justification:type_name -> scalibr.VexJustification
	17,  // 21: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	174, // 22: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	15,  // 23: scalibr.PackageVuln.exploitability_signals:type_name -> scalibr.FindingExploitabilitySignal
	20,  // 24: scalibr.GenericFinding.adv:type_name -> scalibr.GenericFindingAdvisory
	22,  // 25: scalibr.GenericFinding.target:type_name -> scalibr.GenericFindingTargetDetails
	15,  // 26: scalibr.GenericFinding.exploitability_signals:type_name -> scalibr.FindingExploitabilitySignal
	21,  // 27: scalibr.GenericFindingAdvisory.id:type_name -> scalibr.AdvisoryId
	1,   // 28: scalibr.GenericFindingAdvisory.sev:type_name -> scalibr.SeverityEnum
	2,   // 29: scalibr.JavascriptPackageJSONMetadata.source:type_name -> scalibr.PackageSource
	16,  // 30: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
	16,  // 31: scalibr.CDXPackageMetadata.purl:type_name -> scalibr.Purl
	82,  // 32: scalibr.PodmanMetadata.exposed_ports:type_name -> scalibr.PodmanMetadata.ExposedPortsEntry
	172, // 33: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	172, // 34: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	65,  // 35: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	68,  // 36: scalibr.UnknownBinaryMetadata.attribution:type_name -> scalibr.UnknownBinaryAttribution
	70,  // 37: scalibr.Secret.secret:type_name -> scalibr.SecretData
	71,  // 38: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	72,  // 39: scalibr.Secret.locations:type_name -> scalibr.Location
	83,  // 40: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	85,  // 41: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	86,  // 42: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	87,  // 43: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	92,  // 44: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	89,  // 45: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	90,  // 46: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	98,  // 47: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	108, // 48: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	97,  // 49: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	105, // 50: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	106, // 51: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	93,  // 52: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	96,  // 53: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	118, // 54: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	101, // 55: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	119, // 56: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	120, // 57: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	121, // 58: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	122, // 59: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	111, // 60: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	125, // 61: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	126, // 62: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	127, // 63: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	131, // 64: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	132, // 65: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	112, // 66: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	113, // 67: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	114, // 68: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	116, // 69: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	115, // 70: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	107, // 71: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	104, // 72: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	102, // 73: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	103, // 74: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	91,  // 75: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	123, // 76: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	124, // 77: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	144, // 78: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	145, // 79: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	146, // 80: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	136, // 81: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	94,  // 82: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	117, // 83: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	109, // 84: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	95,  // 85: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	133, // 86: scalibr.SecretData.gcs_hmac_key:type_name -> scalibr.SecretData.GCSHmacKey
	134, // 87: scalibr.SecretData.mysql_mylogin_section:type_name -> scalibr.SecretData.MysqlMyloginSection
	135, // 88: scalibr.SecretData.vapid_key:type_name -> scalibr.SecretData.VapidKey
	147, // 89: scalibr.SecretData.aws_access_key_credentials:type_name -> scalibr.SecretData.AwsAccessKeyCredentials
	148, // 90: scalibr.SecretData.re_captcha_key:type_name -> scalibr.SecretData.ReCaptchaKey
	149, // 91: scalibr.SecretData.pyx_key_v1:type_name -> scalibr.SecretData.PyxKeyV1
	150, // 92: scalibr.SecretData.pyx_key_v2:type_name -> scalibr.SecretData.PyxKeyV2
	151, // 93: scalibr.SecretData.code_catalyst_credentials:type_name -> scalibr.SecretData.CodeCatalystCredentials
	84,  // 94: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	152, // 95: scalibr.SecretData.code_commit_credentials:type_name -> scalibr.SecretData.CodeCommitCredentials
	153, // 96: scalibr.SecretData.bitbucket_credentials:type_name -> scalibr.SecretData.BitBucketCredentials
	155, // 97: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	159, // 98: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	165, // 99: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	154, // 100: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	168, // 101: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	162, // 102: scalibr.SecretData.salesforce_oauth2_client_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2ClientCredentials
	160, // 103: scalibr.SecretData.salesforce_oauth2_access_token:type_name -> scalibr.SecretData.SalesforceOAuth2AccessToken
	163, // 104: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
	88,  // 105: scalibr.SecretData.mistral_api_key:type_name -> scalibr.SecretData.MistralAPIKey
	166, // 106: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	167, // 107: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	169, // 108: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	170, // 109: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	164, // 110: scalibr.SecretData.salesforce_oauth2_jwt_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2JWTCredentials
	161, // 111: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
	100, // 112: scalibr.SecretData.deno_pat:type_name -> scalibr.SecretData.DenoPat
	157, // 113: scalibr.SecretData.heroku_secret_key:type_name -> scalibr.SecretData.HerokuSecretKey
	110, // 114: scalibr.SecretData.npmjs_access_token:type_name -> scalibr.SecretData.NpmJsAccessToken
	99,  // 115: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
	128, // 116: scalibr.SecretData.supabase_pat:type_name -> scalibr.SecretData.SupabasePAT
	129, // 117: scalibr.SecretData.supabase_project_secret_key:type_name -> scalibr.SecretData.SupabaseProjectSecretKey
	130, // 118: scalibr.SecretData.supabase_service_role_jwt:type_name -> scalibr.SecretData.SupabaseServiceRoleJWT
	138, // 119: scalibr.SecretData.packagist_api_key:type_name -> scalibr.SecretData.PackagistAPIKey
	139, // 120: scalibr.SecretData.packagist_api_secret:type_name -> scalibr.SecretData.PackagistAPISecret
	140, // 121: scalibr.SecretData.packagist_org_read_token:type_name -> scalibr.SecretData.PackagistOrgReadToken
	141, // 122: scalibr.SecretData.packagist_org_update_token:type_name -> scalibr.SecretData.PackagistOrgUpdateToken
	142, // 123: scalibr.SecretData.packagist_user_update_token:type_name -> scalibr.SecretData.PackagistUserUpdateToken
	143, // 124: scalibr.SecretData.packagist_conductor_update_token:type_name -> scalibr.SecretData.PackagistConductorUpdateToken
	137, // 125: scalibr.SecretData.composer_http_basic_credentials:type_name -> scalibr.SecretData.ComposerPackagistCredentials
	156, // 126: scalibr.SecretData.discord_bot_token:type_name -> scalibr.SecretData.DiscordBotToken
	4,   // 127: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	172, // 128: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	73,  // 129: scalibr.Location.filepath:type_name -> scalibr.Filepath
	74,  // 130: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	75,  // 131: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	76,  // 132: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 133: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	80,  // 134: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	78,  // 135: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	171, // 136: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	79,  // 137: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	58,  // 138: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	158, // 139: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	175, // 140: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
