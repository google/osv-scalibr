...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xf6, 0x08, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x11, 0x10, 0x12, 0x4a, 0x04, 0x08, 0x12,
	0x10, 0x13, 0x4a, 0x04, 0x08, 0x13, 0x10, 0x14, 0x22, 0xc8, 0x01, 0x0a, 0x04, 0x50, 0x75, 0x72,
	...
	0x6c, 0x75, 0x65, 0x73, 0x22, 0xca, 0x01, 0x0a, 0x1b, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	...
	0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x28, 0x0a, 0x10, 0x69, 0x6e, 0x69, 0x74, 0x5f,
	0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x70, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x0e, 0x69, 0x6e, 0x69, 0x74, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x50, 0x69,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_proto_scan_result_proto_goTypes = []interface{}{
	...
	(*SPDXPackageMetadata)(nil),           // 22: scalibr.SPDXPackageMetadata
	(*JavaArchiveMetadata)(nil),           // 23: scalibr.JavaArchiveMetadata
	(*OSVPackageMetadata)(nil),            // 24: scalibr.OSVPackageMetadata
	(*PythonRequirementsMetadata)(nil),    // 25: scalibr.PythonRequirementsMetadata
	(*ContainerdContainerMetadata)(nil),   // 26: scalibr.ContainerdContainerMetadata
	(*timestamppb.Timestamp)(nil),         // 27: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	27, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	27, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	22, // 15: scalibr.Inventory.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	23, // 16: scalibr.Inventory.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	24, // 17: scalibr.Inventory.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	25, // 18: scalibr.Inventory.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	26, // 19: scalibr.Inventory.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	21, // 20: scalibr.Inventory.snap_metadata:type_name -> scalibr.SNAPPackageMetadata
	8,  // 21: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	10, // 22: scalibr.Finding.adv:type_name -> scalibr.Advisory
	14, // 23: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	11, // 24: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	1,  // 25: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	12, // 26: scalibr.Advisory.sev:type_name -> scalibr.Severity
	2,  // 27: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	13, // 28: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	13, // 29: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	6,  // 30: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	7,  // 31: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
