...
type Inventory struct {
	...
	SourceCode *SourceCodeIdentifier `protobuf:"bytes,25,opt,name=source_code,json=sourceCode,proto3" json:"source_code,omitempty"`
	...
	// value, e.g. PyPI.
	Ecosystem string `protobuf:"bytes,26,opt,name=ecosystem,proto3" json:"ecosystem,omitempty"`
...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xa2, 0x0a, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x19, 0x20, 0x01, 0x28, 0x0b,
	...
	0x1a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x65, 0x63, 0x6f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d,
	...
	0x10, 0x04, 0x4a, 0x04, 0x08, 0x11, 0x10, 0x12, 0x4a, 0x04, 0x08, 0x12, 0x10, 0x13, 0x4a, 0x04,
	0x08, 0x13, 0x10, 0x14, 0x22, 0x42, 0x0a, 0x14, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x6f,
	...
	0x52, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x04, 0x50, 0x75, 0x72,
	...
	0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72, 0x22, 0x4c, 0x0a, 0x13, 0x53, 0x50, 0x44, 0x58, 0x50, 0x61,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x68, 0x61, 0x31, 0x22, 0x86, 0x01, 0x0a, 0x12,
	...
	0x72, 0x65, 0x41, 0x73, 0x22, 0x57, 0x0a, 0x1a, 0x50, 0x79, 0x74, 0x68, 0x6f, 0x6e, 0x52, 0x65,
	...
	0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x64, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xca, 0x01,
	...
	0x12, 0x28, 0x0a, 0x10, 0x69, 0x6e, 0x69, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	0x5f, 0x70, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x69, 0x6e, 0x69, 0x74,
	0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x50, 0x69, 0x64, 0x42, 0x3f, 0x50, 0x01, 0x5a, 0x3b,
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	9,  // 23: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	11, // 24: scalibr.Finding.adv:type_name -> scalibr.Advisory
	15, // 25: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	12, // 26: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	1,  // 27: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	13, // 28: scalibr.Advisory.sev:type_name -> scalibr.Severity
	2,  // 29: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	14, // 30: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	14, // 31: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	6,  // 32: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	8,  // 33: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
