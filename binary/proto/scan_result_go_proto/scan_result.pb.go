...
type SecretData struct {
	...
	//	*SecretData_DatabricksUserAccountPat
...
func (x *SecretData) GetDatabricksUserAccountPat() *DatabricksUserAccountPat {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_DatabricksUserAccountPat); ok {
...
type SecretData_DatabricksUserAccountPat struct {
	DatabricksUserAccountPat *DatabricksUserAccountPat `protobuf:"bytes,75,opt,name=databricks_user_account_pat,json=databricksUserAccountPat,proto3,oneof"`
}
...
func (*SecretData_DatabricksUserAccountPat) isSecretData_Secret() {}

type DatabricksUserAccountPat struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DatabricksUserAccountPat) Reset() {
	*x = DatabricksUserAccountPat{}
	mi := &file_proto_scan_result_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DatabricksUserAccountPat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatabricksUserAccountPat) ProtoMessage() {}

func (x *DatabricksUserAccountPat) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatabricksUserAccountPat.ProtoReflect.Descriptor instead.
func (*DatabricksUserAccountPat) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{63}
}

func (x *DatabricksUserAccountPat) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *DatabricksUserAccountPat) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xae`\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11heroku_secret_key\x18J \x01(\v2#.scalibr.SecretData.HerokuSecretKeyH\x00R\x0fherokuSecretKey\x12b\n" +
	"\x1bdatabricks_user_account_pat\x18K \x01(\v2!.scalibr.DatabricksUserAccountPatH\x00R\x18databricksUserAccountPat\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\n" +
	"account_id\x18\x02 \x01(\tR\taccountId\"\xf8\x01\n" +
	"\fSecretStatus\x12>\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*DatabricksUserAccountPat)(nil),              // 68: scalibr.DatabricksUserAccountPat
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	68,  // 153: scalibr.SecretData.databricks_user_account_pat:type_name -> scalibr.DatabricksUserAccountPat
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[62].OneofWrappers = []any{
		...
		(*SecretData_DatabricksUserAccountPat)(nil),
	}
