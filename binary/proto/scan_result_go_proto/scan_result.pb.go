...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 133)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_PaystackSecretKey)(nil),                    // 135: scalibr.SecretData.PaystackSecretKey
	(*SecretData_TelegramBotToken)(nil),                     // 136: scalibr.SecretData.TelegramBotToken
	nil,                                                     // 137: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil),                           // 138: google.protobuf.Timestamp
	(*osvschema.Vulnerability)(nil),                         // 139: osv.Vulnerability
}
var file_proto_scan_result_proto_depIdxs = []int32{
	138, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	138, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	139, // 60: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	138, // 71: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	138, // 72: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	135, // 134: scalibr.SecretData.paystack_secret_key:type_name -> scalibr.SecretData.PaystackSecretKey
	136, // 135: scalibr.SecretData.telegram_bot_api_token:type_name -> scalibr.SecretData.TelegramBotToken
	4,   // 136: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	138, // 137: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	68,  // 138: scalibr.Location.filepath:type_name -> scalibr.Filepath
	69,  // 139: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	70,  // 140: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	71,  // 141: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 142: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	75,  // 143: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	73,  // 144: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	137, // 145: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	74,  // 146: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	56,  // 147: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
