...
type SecretData_SalesforceOauth2RefreshCredentials struct {
	SalesforceOauth2RefreshCredentials *SecretData_SalesforceOAuth2RefreshCredentials `protobuf:"bytes,60,opt,name=salesforce_oauth2_refresh_credentials,json=salesforceOauth2RefreshCredentials,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x86M\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x16telegram_bot_api_token\x18; \x01(\v2$.scalibr.SecretData.TelegramBotTokenH\x00R\x13telegramBotApiToken\x12\x8b\x01\n" +
	"%salesforce_oauth2_refresh_credentials\x18< \x01(\v26.scalibr.SecretData.SalesforceOAuth2RefreshCredentialsH\x00R\"salesforceOauth2RefreshCredentials\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_SalesforceOAuth2RefreshCredentials)(nil),   // 136: scalibr.SecretData.SalesforceOAuth2RefreshCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	136, // 135: scalibr.SecretData.salesforce_oauth2_refresh_credentials:type_name -> scalibr.SecretData.SalesforceOAuth2RefreshCredentials
