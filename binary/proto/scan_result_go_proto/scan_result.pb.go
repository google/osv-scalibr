...
type SecretData_Pypi struct {
	Pypi *SecretData_PyPIAPIToken `protobuf:"bytes,20,opt,name=pypi,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xb5\x17\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\vgcp_api_key\x18\x13 \x01(\v2\x1d.scalibr.SecretData.GCPAPIKeyH\x00R\tgcpApiKey\x126\n" +
	"\x04pypi\x18\x14 \x01(\v2 .scalibr.SecretData.PyPIAPITokenH\x00R\x04pypi\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_PyPIAPIToken)(nil),                     // 81: scalibr.SecretData.PyPIAPIToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	81, // 88: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
