...
const file_proto_scan_result_proto_rawDesc = "" +
	"\n" +
	"\x17proto/scan_result.proto\x12\ascalibr\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb9\x02\n" +
	"\n" +
	"ScanResult\x12\x18\n" +
	...
	"\tinventory\x18\b \x01(\v2\x12.scalibr.InventoryR\tinventoryJ\x04\b\a\x10\b\"\x83\x02\n" +
	"\tInventory\x12,\n" +
	...
	"\x06status\x18\x03 \x01(\v2\x13.scalibr.ScanStatusR\x06status\"\xc3\x1c\n" +
	"\aPackage\x12\x12\n" +
	...
	"\n" +
	"\bmetadataB#\n" +
	"!_container_image_metadata_indexesJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x1c\x10\x1dJ\x04\b#\x10$\"B\n" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xfb;\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x14maria_db_credentials\x18. \x01(\v2&.scalibr.SecretData.MariaDBCredentialsH\x00R\x12mariaDbCredentials\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	8,   // 10: scalibr.PluginStatus.status:type_name -> scalibr.ScanStatus
	11,  // 11: scalibr.Package.source_code:type_name -> scalibr.SourceCodeIdentifier
	16,  // 12: scalibr.Package.purl:type_name -> scalibr.Purl
	22,  // 13: scalibr.Package.python_metadata:type_name -> scalibr.PythonPackageMetadata
	23,  // 14: scalibr.Package.javascript_metadata:type_name -> scalibr.JavascriptPackageJSONMetadata
	24,  // 15: scalibr.Package.apk_metadata:type_name -> scalibr.APKPackageMetadata
	25,  // 16: scalibr.Package.dpkg_metadata:type_name -> scalibr.DPKGPackageMetadata
	26,  // 17: scalibr.Package.rpm_metadata:type_name -> scalibr.RPMPackageMetadata
	27,  // 18: scalibr.Package.cos_metadata:type_name -> scalibr.COSPackageMetadata
	30,  // 19: scalibr.Package.depsjson_metadata:type_name -> scalibr.DEPSJSONMetadata
	38,  // 20: scalibr.Package.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	40,  // 21: scalibr.Package.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	41,  // 22: scalibr.Package.java_lockfile_metadata:type_name -> scalibr.JavaLockfileMetadata
	28,  // 23: scalibr.Package.pacman_metadata:type_name -> scalibr.PACMANPackageMetadata
	29,  // 24: scalibr.Package.nix_metadata:type_name -> scalibr.NixPackageMetadata
	34,  // 25: scalibr.Package.kernel_module_metadata:type_name -> scalibr.KernelModuleMetadata
	35,  // 26: scalibr.Package.vmlinuz_metadata:type_name -> scalibr.VmlinuzMetadata
	32,  // 27: scalibr.Package.portage_metadata:type_name -> scalibr.PortagePackageMetadata
	42,  // 28: scalibr.Package.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	45,  // 29: scalibr.Package.netports_metadata:type_name -> scalibr.NetportsMetadata
	43,  // 30: scalibr.Package.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	44,  // 31: scalibr.Package.python_setup_metadata:type_name -> scalibr.PythonSetupMetadata
	46,  // 32: scalibr.Package.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	31,  // 33: scalibr.Package.snap_metadata:type_name -> scalibr.SNAPPackageMetadata
	33,  // 34: scalibr.Package.flatpak_metadata:type_name -> scalibr.FlatpakPackageMetadata
	36,  // 35: scalibr.Package.mac_apps_metadata:type_name -> scalibr.MacAppsMetadata
	47,  // 36: scalibr.Package.containerd_runtime_container_metadata:type_name -> scalibr.ContainerdRuntimeContainerMetadata
	39,  // 37: scalibr.Package.cdx_metadata:type_name -> scalibr.CDXPackageMetadata
	48,  // 38: scalibr.Package.windows_os_version_metadata:type_name -> scalibr.WindowsOSVersion
	49,  // 39: scalibr.Package.homebrew_metadata:type_name -> scalibr.HomebrewPackageMetadata
	50,  // 40: scalibr.Package.chrome_extensions_metadata:type_name -> scalibr.ChromeExtensionsMetadata
	51,  // 41: scalibr.Package.vscode_extensions_metadata:type_name -> scalibr.VSCodeExtensionsMetadata
	52,  // 42: scalibr.Package.podman_metadata:type_name -> scalibr.PodmanMetadata
	54,  // 43: scalibr.Package.docker_containers_metadata:type_name -> scalibr.DockerContainersMetadata
	37,  // 44: scalibr.Package.macports_metadata:type_name -> scalibr.MacportsPackageMetadata
	59,  // 45: scalibr.Package.winget_metadata:type_name -> scalibr.WingetPackageMetadata
	55,  // 46: scalibr.Package.asdf_metadata:type_name -> scalibr.AsdfMetadata
	56,  // 47: scalibr.Package.nvm_metadata:type_name -> scalibr.NvmMetadata
	57,  // 48: scalibr.Package.nodeversion_metadata:type_name -> scalibr.NodeVersionMetadata
	13,  // 49: scalibr.Package.exploitability_signals:type_name -> scalibr.PackageExploitabilitySignal
	72,  // 50: scalibr.Package.container_image_metadata_indexes:type_name -> scalibr.Package.ContainerImageMetadataIndexes
	0,   // 51: scalibr.PackageExploitabilitySignal.justification:type_name -> scalibr.VexJustification
	14,  // 52: scalibr.PackageExploitabilitySignal.vuln_identifiers:type_name -> scalibr.VulnIdentifiers
	0,   // 53: scalibr.FindingExploitabilitySignal.justification:type_name -> scalibr.VexJustification
	17,  // 54: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	19,  // 55: scalibr.GenericFinding.adv:type_name -> scalibr.GenericFindingAdvisory
	21,  // 56: scalibr.GenericFinding.target:type_name -> scalibr.GenericFindingTargetDetails
	15,  // 57: scalibr.GenericFinding.exploitability_signals:type_name -> scalibr.FindingExploitabilitySignal
	20,  // 58: scalibr.GenericFindingAdvisory.id:type_name -> scalibr.AdvisoryId
	1,   // 59: scalibr.GenericFindingAdvisory.sev:type_name -> scalibr.SeverityEnum
	2,   // 60: scalibr.JavascriptPackageJSONMetadata.source:type_name -> scalibr.PackageSource
	16,  // 61: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
	16,  // 62: scalibr.CDXPackageMetadata.purl:type_name -> scalibr.Purl
	73,  // 63: scalibr.PodmanMetadata.exposed_ports:type_name -> scalibr.PodmanMetadata.ExposedPortsEntry
	120, // 64: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	120, // 65: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	58,  // 66: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	61,  // 67: scalibr.Secret.secret:type_name -> scalibr.SecretData
	62,  // 68: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	63,  // 69: scalibr.Secret.locations:type_name -> scalibr.Location
	74,  // 70: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	75,  // 71: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	76,  // 72: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	77,  // 73: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	81,  // 74: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	78,  // 75: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	79,  // 76: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	87,  // 77: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	94,  // 78: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	86,  // 79: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	92,  // 80: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	93,  // 81: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	82,  // 82: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	85,  // 83: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	103, // 84: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	88,  // 85: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	104, // 86: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	105, // 87: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	106, // 88: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	107, // 89: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	96,  // 90: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	110, // 91: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	111, // 92: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	112, // 93: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	113, // 94: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	114, // 95: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	97,  // 96: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	98,  // 97: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	99,  // 98: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	101, // 99: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	100, // 100: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	91,  // 101: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	89,  // 102: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	90,  // 103: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	80,  // 104: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	108, // 105: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	109, // 106: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	116, // 107: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	117, // 108: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	118, // 109: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	115, // 110: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	83,  // 111: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	102, // 112: scalibr.SecretData.pypi:type_name -> scalibr.SecretData.PyPIAPIToken
	95,  // 113: scalibr.SecretData.crates_io_api_token:type_name -> scalibr.SecretData.CratesIOAPIToken
	84,  // 114: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	5,   // 115: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	120, // 116: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	64,  // 117: scalibr.Location.filepath:type_name -> scalibr.Filepath
	65,  // 118: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	66,  // 119: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	67,  // 120: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 121: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	71,  // 122: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	69,  // 123: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	119, // 124: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	70,  // 125: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	53,  // 126: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
