...
type NodeVersionMetadata struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NodejsVersion string                 `protobuf:"bytes,1,opt,name=nodejs_version,json=nodejsVersion,proto3" json:"nodejs_version,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\x0enodejs_version\x18\x01 \x01(\tR\rnodejsVersion\"t\n" +
	"\n" +
	"DockerPort\x12\x0e\n" +
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	115, // 66: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	115, // 67: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	84,  // 79: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	91,  // 80: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	83,  // 81: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	89,  // 82: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	90,  // 83: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	81,  // 84: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	82,  // 85: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	98,  // 86: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	85,  // 87: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	99,  // 88: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	100, // 89: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	101, // 90: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	102, // 91: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	92,  // 92: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	105, // 93: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	106, // 94: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	107, // 95: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	108, // 96: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	109, // 97: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	93,  // 98: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	94,  // 99: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	95,  // 100: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	97,  // 101: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	96,  // 102: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	88,  // 103: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	86,  // 104: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	87,  // 105: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	79,  // 106: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	103, // 107: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	104, // 108: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	111, // 109: scalibr.SecretData.onepassword_secret_key:type_name -> scalibr.SecretData.OnePasswordSecretKey
	112, // 110: scalibr.SecretData.onepassword_service_token:type_name -> scalibr.SecretData.OnePasswordServiceToken
	113, // 111: scalibr.SecretData.onepassword_recovery_code:type_name -> scalibr.SecretData.OnePasswordRecoveryCode
	110, // 112: scalibr.SecretData.onepassword_connect_token:type_name -> scalibr.SecretData.OnePasswordConnectToken
	...
	63,  // 115: scalibr.Location.filepath:type_name -> scalibr.Filepath
	64,  // 116: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	65,  // 117: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	66,  // 118: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11,  // 119: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	70,  // 120: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	68,  // 121: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	114, // 122: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	69,  // 123: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
