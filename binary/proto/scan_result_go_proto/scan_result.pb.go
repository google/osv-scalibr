...
type SecretData_SendgridApiKey struct {
	SendgridApiKey *SecretData_SendGridAPIKey `protobuf:"bytes,60,opt,name=sendgrid_api_key,json=sendgridApiKey,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x84L\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x16telegram_bot_api_token\x18; \x01(\v2$.scalibr.SecretData.TelegramBotTokenH\x00R\x13telegramBotApiToken\x12N\n" +
	"\x10sendgrid_api_key\x18< \x01(\v2\".scalibr.SecretData.SendGridAPIKeyH\x00R\x0esendgridApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_SendGridAPIKey)(nil),                       // 136: scalibr.SecretData.SendGridAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	136, // 135: scalibr.SecretData.sendgrid_api_key:type_name -> scalibr.SecretData.SendGridAPIKey
