...
func (x *Inventory) GetMetadata() isInventory_Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *Inventory) GetPythonMetadata() *PythonPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_PythonMetadata); ok {
...
func (x *Inventory) GetJavascriptMetadata() *JavascriptPackageJSONMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_JavascriptMetadata); ok {
...
func (x *Inventory) GetApkMetadata() *APKPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_ApkMetadata); ok {
...
func (x *Inventory) GetDpkgMetadata() *DPKGPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_DpkgMetadata); ok {
...
func (x *Inventory) GetRpmMetadata() *RPMPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_RpmMetadata); ok {
...
func (x *Inventory) GetCosMetadata() *COSPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_CosMetadata); ok {
...
func (x *Inventory) GetDepsjsonMetadata() *DEPSJSONMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_DepsjsonMetadata); ok {
...
func (x *Inventory) GetSpdxMetadata() *SPDXPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_SpdxMetadata); ok {
...
func (x *Inventory) GetJavaArchiveMetadata() *JavaArchiveMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_JavaArchiveMetadata); ok {
...
func (x *Inventory) GetJavaLockfileMetadata() *JavaLockfileMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_JavaLockfileMetadata); ok {
...
func (x *Inventory) GetPacmanMetadata() *PACMANPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_PacmanMetadata); ok {
...
func (x *Inventory) GetNixMetadata() *NixPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_NixMetadata); ok {
...
func (x *Inventory) GetKernelModuleMetadata() *KernelModuleMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_KernelModuleMetadata); ok {
...
func (x *Inventory) GetVmlinuzMetadata() *VmlinuzMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_VmlinuzMetadata); ok {
...
func (x *Inventory) GetPortageMetadata() *PortagePackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_PortageMetadata); ok {
...
func (x *Inventory) GetOsvMetadata() *OSVPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_OsvMetadata); ok {
...
func (x *Inventory) GetPythonRequirementsMetadata() *PythonRequirementsMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_PythonRequirementsMetadata); ok {
...
func (x *Inventory) GetPythonSetupMetadata() *PythonSetupMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_PythonSetupMetadata); ok {
...
func (x *Inventory) GetContainerdContainerMetadata() *ContainerdContainerMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_ContainerdContainerMetadata); ok {
...
func (x *Inventory) GetSnapMetadata() *SNAPPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_SnapMetadata); ok {
...
func (x *Inventory) GetFlatpakMetadata() *FlatpakPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_FlatpakMetadata); ok {
...
func (x *Inventory) GetMacAppsMetadata() *MacAppsMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_MacAppsMetadata); ok {
...
func (x *Inventory) GetContainerdRuntimeContainerMetadata() *ContainerdRuntimeContainerMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_ContainerdRuntimeContainerMetadata); ok {
...
func (x *Inventory) GetCdxMetadata() *CDXPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_CdxMetadata); ok {
...
func (x *Inventory) GetWindowsOsVersionMetadata() *WindowsOSVersion {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_WindowsOsVersionMetadata); ok {
...
func (x *Inventory) GetHomebrewMetadata() *HomebrewPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_HomebrewMetadata); ok {
...
func (x *Inventory) GetChromeExtensionsMetadata() *ChromeExtensionsMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_ChromeExtensionsMetadata); ok {
...
func (x *Inventory) GetVscodeExtensionsMetadata() *VSCodeExtensionsMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Inventory_VscodeExtensionsMetadata); ok {
...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xd3, 0x15, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x6e, 0x73, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x43, 0x0a, 0x0b, 0x61, 0x6e,
	0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x1c, 0x20, 0x03, 0x28, 0x0e, 0x32,
	0x21, 0x2e, 0x73, 0x63, 0x61, 0x6c, 0x69, 0x62, 0x72, 0x2e, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74,
	0x6f, 0x72, 0x79, 0x2e, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6e,
	0x75, 0x6d, 0x52, 0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12,
	...
	0x61, 0x79, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x60, 0x0a, 0x0e, 0x41,
	...
	0x09, 0x52, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x22, 0x7b, 0x0a, 0x0c, 0x4c, 0x61, 0x79,
	...
	0x52, 0x06, 0x64, 0x69, 0x66, 0x66, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x6d,
	...
	0x65, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x22, 0xc8, 0x01, 0x0a, 0x04, 0x50, 0x75, 0x72, 0x6c, 0x12,
	...
	,
	...
	0x64, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x52, 0x02, 0x69, 0x64, 0x12, 0x2e, 0x0a,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x73, 0x63,
	0x61, 0x6c, 0x69, 0x62, 0x72, 0x2e, 0x41, 0x64, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x79, 0x2e, 0x54,
	...
	0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x23, 0x0a,
	0x03, 0x73, 0x65, 0x76, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x73, 0x63, 0x61,
	0x6c, 0x69, 0x62, 0x72, 0x2e, 0x53, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x52, 0x03, 0x73,
	0x65, 0x76, 0x22, 0x3b, 0x0a, 0x08, 0x54, 0x79, 0x70, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x12, 0x0b,
	0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x11, 0x0a, 0x0d, 0x56,
	0x55, 0x4c, 0x4e, 0x45, 0x52, 0x41, 0x42, 0x49, 0x4c, 0x49, 0x54, 0x59, 0x10, 0x01, 0x12, 0x0f,
	0x0a, 0x0b, 0x43, 0x49, 0x53, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x22,
	...
	,
	...
	0x0c, 0x0a, 0x08, 0x43, 0x52, 0x49, 0x54, 0x49, 0x43, 0x41, 0x4c, 0x10, 0x05, 0x22, 0x7d, 0x0a,
	...
	0x63, 0x6f, 0x72, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x6c,
	0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0d, 0x74, 0x65,
	0x6d, 0x70, 0x6f, 0x72, 0x61, 0x6c, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x2f, 0x0a, 0x13, 0x65,
	0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x63, 0x6f,
	0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x12, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f,
	0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x5d, 0x0a, 0x0d,
	0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x30, 0x0a,
	...
	0x70, 0x42, 0x3f, 0x50, 0x01, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	1,  // 38: scalibr.Inventory.annotations:type_name -> scalibr.Inventory.AnnotationEnum
	9,  // 39: scalibr.Inventory.layer_details:type_name -> scalibr.LayerDetails
	11, // 40: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	13, // 41: scalibr.Finding.adv:type_name -> scalibr.Advisory
	17, // 42: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	14, // 43: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	2,  // 44: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	15, // 45: scalibr.Advisory.sev:type_name -> scalibr.Severity
	3,  // 46: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	16, // 47: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	16, // 48: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	7,  // 49: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	10, // 50: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
	10, // 51: scalibr.CDXPackageMetadata.purl:type_name -> scalibr.Purl
