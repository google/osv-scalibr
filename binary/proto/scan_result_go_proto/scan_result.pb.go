...
const (
	SeverityEnum_UNSPECIFIED SeverityEnum = 0
...
func (x *GenericFindingAdvisory) GetSev() SeverityEnum {
	...
	return SeverityEnum_UNSPECIFIED
}
...
func (*SecretData_GCPSAK) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{47, 0}
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rin_base_image\x18\x04 \x01(\bR\vinBaseImage\"3\n" +
	...
	" INLINE_MITIGATION_ALREADY_EXISTS\x10\x05*Y\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*VulnIdentifiers)(nil),                    // 12: scalibr.VulnIdentifiers
	(*Purl)(nil),                               // 13: scalibr.Purl
	(*Qualifier)(nil),                          // 14: scalibr.Qualifier
	(*GenericFinding)(nil),                     // 15: scalibr.GenericFinding
	(*GenericFindingAdvisory)(nil),             // 16: scalibr.GenericFindingAdvisory
	(*AdvisoryId)(nil),                         // 17: scalibr.AdvisoryId
	(*GenericFindingTargetDetails)(nil),        // 18: scalibr.GenericFindingTargetDetails
	...
	(*Secret)(nil),                             // 51: scalibr.Secret
	(*SecretData)(nil),                         // 52: scalibr.SecretData
	(*SecretStatus)(nil),                       // 53: scalibr.SecretStatus
	(*Location)(nil),                           // 54: scalibr.Location
	(*Filepath)(nil),                           // 55: scalibr.Filepath
	(*FilepathWithLayerDetails)(nil),           // 56: scalibr.FilepathWithLayerDetails
	(*EnvironmentVariable)(nil),                // 57: scalibr.EnvironmentVariable
	(*ContainerCommand)(nil),                   // 58: scalibr.ContainerCommand
	nil,                                        // 59: scalibr.PodmanMetadata.ExposedPortsEntry
	(*SecretData_GCPSAK)(nil),                  // 60: scalibr.SecretData.GCPSAK
	(*timestamppb.Timestamp)(nil),              // 61: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	61, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	61, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	15, // 5: scalibr.ScanResult.findings_deprecated:type_name -> scalibr.GenericFinding
	6,  // 6: scalibr.ScanResult.inventory:type_name -> scalibr.Inventory
	9,  // 7: scalibr.Inventory.packages:type_name -> scalibr.Package
	15, // 8: scalibr.Inventory.generic_findings:type_name -> scalibr.GenericFinding
	51, // 9: scalibr.Inventory.secrets:type_name -> scalibr.Secret
	...
	13, // 13: scalibr.Package.purl:type_name -> scalibr.Purl
	19, // 14: scalibr.Package.python_metadata:type_name -> scalibr.PythonPackageMetadata
	20, // 15: scalibr.Package.javascript_metadata:type_name -> scalibr.JavascriptPackageJSONMetadata
	21, // 16: scalibr.Package.apk_metadata:type_name -> scalibr.APKPackageMetadata
	22, // 17: scalibr.Package.dpkg_metadata:type_name -> scalibr.DPKGPackageMetadata
	23, // 18: scalibr.Package.rpm_metadata:type_name -> scalibr.RPMPackageMetadata
	24, // 19: scalibr.Package.cos_metadata:type_name -> scalibr.COSPackageMetadata
	27, // 20: scalibr.Package.depsjson_metadata:type_name -> scalibr.DEPSJSONMetadata
	34, // 21: scalibr.Package.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	36, // 22: scalibr.Package.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	37, // 23: scalibr.Package.java_lockfile_metadata:type_name -> scalibr.JavaLockfileMetadata
	25, // 24: scalibr.Package.pacman_metadata:type_name -> scalibr.PACMANPackageMetadata
	26, // 25: scalibr.Package.nix_metadata:type_name -> scalibr.NixPackageMetadata
	31, // 26: scalibr.Package.kernel_module_metadata:type_name -> scalibr.KernelModuleMetadata
	32, // 27: scalibr.Package.vmlinuz_metadata:type_name -> scalibr.VmlinuzMetadata
	29, // 28: scalibr.Package.portage_metadata:type_name -> scalibr.PortagePackageMetadata
	38, // 29: scalibr.Package.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	39, // 30: scalibr.Package.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	40, // 31: scalibr.Package.python_setup_metadata:type_name -> scalibr.PythonSetupMetadata
	41, // 32: scalibr.Package.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	28, // 33: scalibr.Package.snap_metadata:type_name -> scalibr.SNAPPackageMetadata
	30, // 34: scalibr.Package.flatpak_metadata:type_name -> scalibr.FlatpakPackageMetadata
	33, // 35: scalibr.Package.mac_apps_metadata:type_name -> scalibr.MacAppsMetadata
	42, // 36: scalibr.Package.containerd_runtime_container_metadata:type_name -> scalibr.ContainerdRuntimeContainerMetadata
	35, // 37: scalibr.Package.cdx_metadata:type_name -> scalibr.CDXPackageMetadata
	43, // 38: scalibr.Package.windows_os_version_metadata:type_name -> scalibr.WindowsOSVersion
	44, // 39: scalibr.Package.homebrew_metadata:type_name -> scalibr.HomebrewPackageMetadata
	45, // 40: scalibr.Package.chrome_extensions_metadata:type_name -> scalibr.ChromeExtensionsMetadata
	46, // 41: scalibr.Package.vscode_extensions_metadata:type_name -> scalibr.VSCodeExtensionsMetadata
	47, // 42: scalibr.Package.podman_metadata:type_name -> scalibr.PodmanMetadata
	49, // 43: scalibr.Package.docker_containers_metadata:type_name -> scalibr.DockerContainersMetadata
	3,  // 44: scalibr.Package.annotations:type_name -> scalibr.Package.AnnotationEnum
	11, // 45: scalibr.Package.layer_details:type_name -> scalibr.LayerDetails
	14, // 46: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	16, // 47: scalibr.GenericFinding.adv:type_name -> scalibr.GenericFindingAdvisory
	18, // 48: scalibr.GenericFinding.target:type_name -> scalibr.GenericFindingTargetDetails
	17, // 49: scalibr.GenericFindingAdvisory.id:type_name -> scalibr.AdvisoryId
	1,  // 50: scalibr.GenericFindingAdvisory.sev:type_name -> scalibr.SeverityEnum
	13, // 51: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
	13, // 52: scalibr.CDXPackageMetadata.purl:type_name -> scalibr.Purl
	59, // 53: scalibr.PodmanMetadata.exposed_ports:type_name -> scalibr.PodmanMetadata.ExposedPortsEntry
	61, // 54: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	61, // 55: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	50, // 56: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	52, // 57: scalibr.Secret.secret:type_name -> scalibr.SecretData
	53, // 58: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	54, // 59: scalibr.Secret.locations:type_name -> scalibr.Location
	60, // 60: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	4,  // 61: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	61, // 62: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	55, // 63: scalibr.Location.filepath:type_name -> scalibr.Filepath
	56, // 64: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	57, // 65: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	58, // 66: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11, // 67: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	48, // 68: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[47].OneofWrappers = []any{
