...
type SecretData_HashicorpCloudPlatformCredentials struct {
	HashicorpCloudPlatformCredentials *SecretData_HashiCorpCloudPlatformCredentials `protobuf:"bytes,27,opt,name=hashicorp_cloud_platform_credentials,json=hashicorpCloudPlatformCredentials,proto3,oneof"`
}

type SecretData_HashicorpCloudPlatformToken struct {
	HashicorpCloudPlatformToken *SecretData_HashiCorpCloudPlatformToken `protobuf:"bytes,28,opt,name=hashicorp_cloud_platform_token,json=hashicorpCloudPlatformToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x9c$\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x17gcp_oauth2_access_token\x18\x1a \x01(\v2(.scalibr.SecretData.GCPOAuth2AccessTokenH\x00R\x14gcpOauth2AccessToken\x12\x88\x01\n" +
	"$hashicorp_cloud_platform_credentials\x18\x1b \x01(\v25.scalibr.SecretData.HashiCorpCloudPlatformCredentialsH\x00R!hashicorpCloudPlatformCredentials\x12v\n" +
	"\x1ehashicorp_cloud_platform_token\x18\x1c \x01(\v2/.scalibr.SecretData.HashiCorpCloudPlatformTokenH\x00R\x1bhashicorpCloudPlatformToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 95)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_HashiCorpCloudPlatformCredentials)(nil), // 93: scalibr.SecretData.HashiCorpCloudPlatformCredentials
	(*SecretData_HashiCorpCloudPlatformToken)(nil),       // 94: scalibr.SecretData.HashiCorpCloudPlatformToken
	(*SecretData_StripeSecretKey)(nil),                   // 95: scalibr.SecretData.StripeSecretKey
	(*SecretData_StripeRestrictedKey)(nil),               // 96: scalibr.SecretData.StripeRestrictedKey
	(*SecretData_StripeWebhookSecret)(nil),               // 97: scalibr.SecretData.StripeWebhookSecret
	(*SecretData_GCPOAuth2ClientCredentials)(nil),        // 98: scalibr.SecretData.GCPOAuth2ClientCredentials
	(*SecretData_GCPOAuth2AccessToken)(nil),              // 99: scalibr.SecretData.GCPOAuth2AccessToken
	(*timestamppb.Timestamp)(nil),                        // 100: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	100, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	100, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	100, // 65: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	100, // 66: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	88,  // 85: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	83,  // 86: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	89,  // 87: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	90,  // 88: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	91,  // 89: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	92,  // 90: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	87,  // 91: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	95,  // 92: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	96,  // 93: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	97,  // 94: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	98,  // 95: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	99,  // 96: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	93,  // 97: scalibr.SecretData.hashicorp_cloud_platform_credentials:type_name -> scalibr.SecretData.HashiCorpCloudPlatformCredentials
	94,  // 98: scalibr.SecretData.hashicorp_cloud_platform_token:type_name -> scalibr.SecretData.HashiCorpCloudPlatformToken
	4,   // 99: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	100, // 100: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	...
	69,  // 106: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	67,  // 107: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	68,  // 108: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	52,  // 109: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
