...
func (x *SecretData) GetGitlabOauth() *SecretData_GitlabOAuthCredentials {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GitlabOauth); ok {
			return x.GitlabOauth
		}
	}
	return nil
}
...
type SecretData_GitlabOauth struct {
	GitlabOauth *SecretData_GitlabOAuthCredentials `protobuf:"bytes,89,opt,name=gitlab_oauth,json=gitlabOauth,proto3,oneof"`
}
...
func (*SecretData_GitlabOauth) isSecretData_Secret() {}
...
type SecretData_GitlabOAuthCredentials struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SecretData_GitlabOAuthCredentials) Reset() {
	*x = SecretData_GitlabOAuthCredentials{}
	mi := &file_proto_scan_result_proto_msgTypes[97]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GitlabOAuthCredentials) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GitlabOAuthCredentials) ProtoMessage() {}

func (x *SecretData_GitlabOAuthCredentials) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[97]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GitlabOAuthCredentials.ProtoReflect.Descriptor instead.
func (*SecretData_GitlabOAuthCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 19}
}

func (x *SecretData_GitlabOAuthCredentials) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *SecretData_GitlabOAuthCredentials) GetClientSecret() string {
	if x != nil {
...
func (x *SecretData_GitlabOAuthCredentials) GetHostname() string {
	if x != nil {
		return x.Hostname
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x94s\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12O\n" +
	"\fgitlab_oauth\x18Y \x01(\v2*.scalibr.SecretData.GitlabOAuthCredentialsH\x00R\vgitlabOauth\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\tGitlabPat\x12\x10\n" +
	"\x03pat\x18\x01 \x01(\tR\x03pat\x1av\n" +
	"\x16GitlabOAuthCredentials\x12\x1b\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GitlabOAuthCredentials)(nil),               // 102: scalibr.SecretData.GitlabOAuthCredentials
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	102, // 170: scalibr.SecretData.gitlab_oauth:type_name -> scalibr.SecretData.GitlabOAuthCredentials
