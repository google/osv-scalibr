...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 93)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GCPOAuth2ClientCredentials)(nil),       // 96: scalibr.SecretData.GCPOAuth2ClientCredentials
	(*SecretData_GCPOAuth2AccessToken)(nil),             // 97: scalibr.SecretData.GCPOAuth2AccessToken
	(*timestamppb.Timestamp)(nil),                       // 98: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	98,  // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	98,  // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	98,  // 65: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	98,  // 66: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	93,  // 92: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	94,  // 93: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	95,  // 94: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	96,  // 95: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	97,  // 96: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	4,   // 97: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	98,  // 98: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	62,  // 99: scalibr.Location.filepath:type_name -> scalibr.Filepath
	63,  // 100: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	64,  // 101: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	65,  // 102: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	11,  // 103: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	69,  // 104: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	67,  // 105: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	68,  // 106: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	52,  // 107: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
