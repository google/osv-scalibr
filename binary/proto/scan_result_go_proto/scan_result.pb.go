...
func (x *SecretData_Pgpass) GetEntry() string {
	if x != nil {
		return x.Entry
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xc8\x1f\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\tGCPAPIKey\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x1a\x1e\n" +
	"\x06Pgpass\x12\x14\n" +
	"\x05entry\x18\x01 \x01(\tR\x05entry\x1ag\n" +
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	92,  // 97: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
