...
func (*SecretData_BitBucketCredentials) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{58, 56}
}
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 129)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_OpenRouterAPIKey)(nil),                     // 97: scalibr.SecretData.OpenRouterAPIKey
	...
	nil,                                                     // 133: scalibr.ContainerImageMetadata.OsInfoEntry
	(*timestamppb.Timestamp)(nil),                           // 134: google.protobuf.Timestamp
	(*osvschema.Vulnerability)(nil),                         // 135: osv.Vulnerability
}
var file_proto_scan_result_proto_depIdxs = []int32{
	134, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	134, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	135, // 58: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	134, // 69: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	134, // 70: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	98,  // 83: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	...
	107, // 89: scalibr.SecretData.tink_keyset:type_name -> scalibr.SecretData.TinkKeyset
	91,  // 90: scalibr.SecretData.gitlab_pat:type_name -> scalibr.SecretData.GitlabPat
	108, // 91: scalibr.SecretData.hashicorp_vault_token:type_name -> scalibr.SecretData.HashiCorpVaultToken
	109, // 92: scalibr.SecretData.hashicorp_vault_app_role_credentials:type_name -> scalibr.SecretData.HashiCorpVaultAppRoleCredentials
	110, // 93: scalibr.SecretData.gcp_api_key:type_name -> scalibr.SecretData.GCPAPIKey
	111, // 94: scalibr.SecretData.hugginface:type_name -> scalibr.SecretData.HuggingfaceAPIKey
	100, // 95: scalibr.SecretData.github_app_refresh_token:type_name -> scalibr.SecretData.GithubAppRefreshToken
	114, // 96: scalibr.SecretData.stripe_secret_key:type_name -> scalibr.SecretData.StripeSecretKey
	115, // 97: scalibr.SecretData.stripe_restricted_key:type_name -> scalibr.SecretData.StripeRestrictedKey
	116, // 98: scalibr.SecretData.stripe_webhook_secret:type_name -> scalibr.SecretData.StripeWebhookSecret
	117, // 99: scalibr.SecretData.gcp_oauth2_client_credentials:type_name -> scalibr.SecretData.GCPOAuth2ClientCredentials
	118, // 100: scalibr.SecretData.gcp_oauth2_access_token:type_name -> scalibr.SecretData.GCPOAuth2AccessToken
	101, // 101: scalibr.SecretData.github_app_server_to_server_token:type_name -> scalibr.SecretData.GithubAppServerToServerToken
	102, // 102: scalibr.SecretData.github_classic_personal_access_token:type_name -> scalibr.SecretData.GithubClassicPersonalAccessToken
	103, // 103: scalibr.SecretData.github_fine_grained_personal_access_token:type_name -> scalibr.SecretData.GithubFineGrainedPersonalAccessToken
	105, // 104: scalibr.SecretData.github_app_user_to_server_token:type_name -> scalibr.SecretData.GithubAppUserToServerToken
	104, // 105: scalibr.SecretData.github_oauth_token:type_name -> scalibr.SecretData.GithubOAuthToken
	97,  // 106: scalibr.SecretData.openrouter_api_key:type_name -> scalibr.SecretData.OpenRouterAPIKey
	94,  // 107: scalibr.SecretData.slack_app_config_refresh_token:type_name -> scalibr.SecretData.SlackAppConfigRefreshToken
	92,  // 108: scalibr.SecretData.slack_app_level_token:type_name -> scalibr.SecretData.SlackAppLevelToken
	93,  // 109: scalibr.SecretData.slack_app_config_access_token:type_name -> scalibr.SecretData.SlackAppConfigAccessToken
	83,  // 110: scalibr.SecretData.azure_storage_account_access_key:type_name -> scalibr.SecretData.AzureStorageAccountAccessKey
	...
	86,  // 117: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
	...
	87,  // 120: scalibr.SecretData.maria_db_credentials:type_name -> scalibr.SecretData.MariaDBCredentials
	...
	77,  // 129: scalibr.SecretData.jwt_token:type_name -> scalibr.SecretData.JWTToken
	...
	4,   // 132: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	134, // 133: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	66,  // 134: scalibr.Location.filepath:type_name -> scalibr.Filepath
	67,  // 135: scalibr.Location.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	68,  // 136: scalibr.Location.environment_variable:type_name -> scalibr.EnvironmentVariable
	69,  // 137: scalibr.Location.container_command:type_name -> scalibr.ContainerCommand
	12,  // 138: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	73,  // 139: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	71,  // 140: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	133, // 141: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	72,  // 142: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	55,  // 143: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
