...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xd9\x1c\n" +
	"\aPackage\x12\x0e\n" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x8c?\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"gcsHmacKey\x12]\n" +
	"\x15mysql_mylogin_section\x180 \x01(\v2'.scalibr.SecretData.MysqlMyloginSectionH\x00R\x13mysqlMyloginSection\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x06socket\x18\x06 \x01(\tR\x06socket\x1a\xb0\x02\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 117)
