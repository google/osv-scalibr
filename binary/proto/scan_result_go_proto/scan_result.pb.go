...
func (x *SecretData) GetGitlabFeedToken() *SecretData_GitlabFeedToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_GitlabFeedToken_); ok {
			return x.GitlabFeedToken
		}
	}
	return nil
}
...
type SecretData_GitlabFeedToken_ struct {
	GitlabFeedToken *SecretData_GitlabFeedToken `protobuf:"bytes,90,opt,name=gitlab_feed_token,json=gitlabFeedToken,proto3,oneof"`
}
...
func (*SecretData_GitlabFeedToken_) isSecretData_Secret() {}
...
type SecretData_GitlabFeedToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
...
func (x *SecretData_GitlabFeedToken) Reset() {
	*x = SecretData_GitlabFeedToken{}
	mi := &file_proto_scan_result_proto_msgTypes[152]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SecretData_GitlabFeedToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretData_GitlabFeedToken) ProtoMessage() {}

func (x *SecretData_GitlabFeedToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_scan_result_proto_msgTypes[152]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretData_GitlabFeedToken.ProtoReflect.Descriptor instead.
func (*SecretData_GitlabFeedToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{65, 74}
}

func (x *SecretData_GitlabFeedToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SecretData_GitlabFeedToken) GetHostname() string {
	if x != nil {
		return x.Hostname
	}
	return ""
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xe3r\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11discord_bot_token\x18W \x01(\v2#.scalibr.SecretData.DiscordBotTokenH\x00R\x0fdiscordBotToken\x12Q\n" +
	"\x11gitlab_feed_token\x18Z \x01(\v2#.scalibr.SecretData.GitlabFeedTokenH\x00R\x0fgitlabFeedToken\x12s\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x1aC\n" +
	"\x0fGitlabFeedToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1a\n" +
	"\bhostname\x18\x02 \x01(\tR\bhostname\x1a\xb1\x01\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_GitlabFeedToken)(nil),                      // 157: scalibr.SecretData.GitlabFeedToken
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	157, // 169: scalibr.SecretData.gitlab_feed_token:type_name -> scalibr.SecretData.GitlabFeedToken
...
func file_proto_scan_result_proto_init() {
	...
	file_proto_scan_result_proto_msgTypes[65].OneofWrappers = []any{
		...
		(*SecretData_GitlabFeedToken_)(nil),
