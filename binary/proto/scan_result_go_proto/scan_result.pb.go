...
var file_proto_scan_result_proto_rawDesc = []byte{
	...
	0xc4, 0x09, 0x0a, 0x09, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a,
	...
	0x74, 0x61, 0x42, 0x0a, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4a, 0x04,
	0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x11, 0x10, 0x12, 0x4a, 0x04, 0x08, 0x12, 0x10, 0x13,
	0x4a, 0x04, 0x08, 0x13, 0x10, 0x14, 0x22, 0xc8, 0x01, 0x0a, 0x04, 0x50, 0x75, 0x72, 0x6c, 0x12,
	...
	0x0b, 0x6f, 0x73, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0xfc, 0x01, 0x0a,
	...
	0x6f, 0x70, 0x65, 0x72, 0x22, 0x4c, 0x0a, 0x13, 0x53, 0x50, 0x44, 0x58, 0x50, 0x61, 0x63, 0x6b,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x68, 0x61, 0x31, 0x22, 0x86, 0x01, 0x0a, 0x12, 0x4f, 0x53,
	...
	0x41, 0x73, 0x22, 0x57, 0x0a, 0x1a, 0x50, 0x79, 0x74, 0x68, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	0x67, 0x4d, 0x6f, 0x64, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xca, 0x01, 0x0a, 0x1b,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x28,
	0x0a, 0x10, 0x69, 0x6e, 0x69, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x70,
	0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x69, 0x6e, 0x69, 0x74, 0x50, 0x72,
	0x6f, 0x63, 0x65, 0x73, 0x73, 0x50, 0x69, 0x64, 0x42, 0x3f, 0x50, 0x01, 0x5a, 0x3b, 0x67, 0x69,
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
...
var file_proto_scan_result_proto_depIdxs = []int32{
	28, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	28, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	8,  // 22: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	10, // 23: scalibr.Finding.adv:type_name -> scalibr.Advisory
	14, // 24: scalibr.Finding.target:type_name -> scalibr.TargetDetails
	11, // 25: scalibr.Advisory.id:type_name -> scalibr.AdvisoryId
	1,  // 26: scalibr.Advisory.type:type_name -> scalibr.Advisory.TypeEnum
	12, // 27: scalibr.Advisory.sev:type_name -> scalibr.Severity
	2,  // 28: scalibr.Severity.severity:type_name -> scalibr.Severity.SeverityEnum
	13, // 29: scalibr.Severity.cvss_v2:type_name -> scalibr.CVSS
	13, // 30: scalibr.Severity.cvss_v3:type_name -> scalibr.CVSS
	6,  // 31: scalibr.TargetDetails.inventory:type_name -> scalibr.Inventory
	7,  // 32: scalibr.SPDXPackageMetadata.purl:type_name -> scalibr.Purl
