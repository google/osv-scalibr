...
type SecretData_CloudflareApiToken struct {
	CloudflareApiToken *SecretData_CloudflareAPIToken `protobuf:"bytes,75,opt,name=cloudflare_api_token,json=cloudflareApiToken,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xd2`\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x11heroku_secret_key\x18J \x01(\v2#.scalibr.SecretData.HerokuSecretKeyH\x00R\x0fherokuSecretKey\x12Z\n" +
	"\x14cloudflare_api_token\x18K \x01(\v2&.scalibr.SecretData.CloudflareAPITokenH\x00R\x12cloudflareApiToken\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	96,  // 153: scalibr.SecretData.cloudflare_api_token:type_name -> scalibr.SecretData.CloudflareAPIToken
