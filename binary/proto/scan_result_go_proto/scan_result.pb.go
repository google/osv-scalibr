...
func (x *SecretData) GetDatabricksPat() *SecretData_DatabricksPAT {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_DatabricksPat); ok {
...
func (*SecretData_DatabricksPat) isSecretData_Secret() {}
...
type SecretData_DatabricksPAT struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Databricks PAT (prefix: dapi)
	Url           string                 `protobuf:"bytes,2,opt,name=url,proto3" json:"url,omitempty"`     // Databricks Workspace URL
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation\"\xd0r\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x0edatabricks_pat\x18Y \x01(\v2!.scalibr.SecretData.DatabricksPATH\x00R\rdatabricksPat\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_DatabricksPAT)(nil),                        // 175: scalibr.SecretData.DatabricksPAT
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	175, // 175: scalibr.SecretData.databricks_pat:type_name -> scalibr.SecretData.DatabricksPAT
