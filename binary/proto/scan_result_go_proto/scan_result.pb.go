...
type SecretData_Pgpass_ struct {
	Pgpass *SecretData_Pgpass `protobuf:"bytes,20,opt,name=pgpass,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\x9c\x18\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\vgcp_api_key\x18\x13 \x01(\v2\x1d.scalibr.SecretData.GCPAPIKeyH\x00R\tgcpApiKey\x124\n" +
	"\x06pgpass\x18\x14 \x01(\v2\x1a.scalibr.SecretData.PgpassH\x00R\x06pgpass\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_Pgpass)(nil),                           // 74: scalibr.SecretData.Pgpass
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	74, // 88: scalibr.SecretData.pgpass:type_name -> scalibr.SecretData.Pgpass
