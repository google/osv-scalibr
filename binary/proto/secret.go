...
import (
	...
	githubappservertoservertoken "github.com/google/osv-scalibr/veles/secrets/github/appservertoservertoken"
...
func velesSecretToProto(s veles.Secret) (*spb.SecretData, error) {
	...
	case githubappservertoservertoken.GithubAppServerToServerToken:
...
func velesSecretToStruct(s *spb.SecretData) (veles.Secret, error) {
	...
	case *spb.SecretData_GithubAppServerToServerToken_:
		return githubappservertoservertoken.GithubAppServerToServerToken{
			Token: s.GetGithubAppServerToServerToken().GetToken(),
		}, nil
	default:
