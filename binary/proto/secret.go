...
func velesSecretToProto(s veles.Secret) (*spb.SecretData, error) {
	...
	case velesgitlab.RunnerAuthToken:
		return gitlabRunnerAuthTokenToProto(t), nil
...
func gitlabRunnerAuthTokenToProto(s velesgitlab.RunnerAuthToken) *spb.SecretData {
	return &spb.SecretData{
		Secret: &spb.SecretData_GitlabRunnerAuthToken_{
			GitlabRunnerAuthToken: &spb.SecretData_GitlabRunnerAuthToken{
				Token:    s.Token,
				Hostname: s.Hostname,
			},
		},
...
func velesSecretToStruct(s *spb.SecretData) (veles.Secret, error) {
	...
	case *spb.SecretData_GitlabRunnerAuthToken_:
		return gitlabRunnerAuthTokenToStruct(s.GetGitlabRunnerAuthToken()), nil
...
func gitlabRunnerAuthTokenToStruct(kPB *spb.SecretData_GitlabRunnerAuthToken) velesgitlab.RunnerAuthToken {
	return velesgitlab.RunnerAuthToken{
		Token:    kPB.GetToken(),
