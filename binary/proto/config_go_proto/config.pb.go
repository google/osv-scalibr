...
func (x *PluginSpecificConfig) GetRpmfile() *RpmFileConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_Rpmfile); ok {
			return x.Rpmfile
		}
	}
	return nil
...
type PluginSpecificConfig_Rpmfile struct {
	Rpmfile *RpmFileConfig `protobuf:"bytes,79,opt,name=rpmfile,proto3,oneof"`
}
...
func (*PluginSpecificConfig_Rpmfile) isPluginSpecificConfig_Config() {}
...
func (x *RpmFileConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RpmFileConfig) ProtoMessage() {}

func (x *RpmFileConfig) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RpmFileConfig.ProtoReflect.Descriptor instead.
func (*RpmFileConfig) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{18}
}

func (x *RpmFileConfig) GetMaxFileSizeBytes() int64 {
	if x != nil {
		return x.MaxFileSizeBytes
	}
	return 0
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xa6!\n" +
	...
	"\x1adotnet_project_assets_json\x18N \x01(\v2&.scalibr.DotnetProjectAssetsJsonConfigH\x00R\x17dotnetProjectAssetsJson\x122\n" +
	"\arpmfile\x18O \x01(\v2\x16.scalibr.RpmFileConfigH\x00R\arpmfileB\b\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*RpmFileConfig)(nil),                      // 18: scalibr.RpmFileConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	18, // 65: scalibr.PluginSpecificConfig.rpmfile:type_name -> scalibr.RpmFileConfig
...
func file_proto_config_proto_init() {
	...
	file_proto_config_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*PluginSpecificConfig_Rpmfile)(nil),
	}
