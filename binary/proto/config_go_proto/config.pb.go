...
func (x *PluginSpecificConfig) GetDeb() *DebConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_Deb); ok {
			return x.Deb
		}
	}
	return nil
...
type PluginSpecificConfig_Deb struct {
	Deb *DebConfig `protobuf:"bytes,79,opt,name=deb,proto3,oneof"`
}
...
func (*PluginSpecificConfig_Deb) isPluginSpecificConfig_Config() {}
...
func (x *DebConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DebConfig) ProtoMessage() {}

func (x *DebConfig) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DebConfig.ProtoReflect.Descriptor instead.
func (*DebConfig) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{17}
}

func (x *DebConfig) GetMaxFileSizeBytes() int64 {
	if x != nil {
		return x.MaxFileSizeBytes
	}
	return 0
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\x9a!\n" +
	...
	"\x03deb\x18O \x01(\v2\x12.scalibr.DebConfigH\x00R\x03debB\b\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*DebConfig)(nil),                          // 17: scalibr.DebConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	17, // 65: scalibr.PluginSpecificConfig.deb:type_name -> scalibr.DebConfig
