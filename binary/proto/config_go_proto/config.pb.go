...
type PluginSpecificConfig_Podman struct {
	Podman *PodmanConfig `protobuf:"bytes,12,opt,name=podman,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xab\x05\n" +
	...
	"\x03rpm\x18\v \x01(\v2\x12.scalibr.RpmConfigH\x00R\x03rpm\x12/\n" +
	"\x06podman\x18\f \x01(\v2\x15.scalibr.PodmanConfigH\x00R\x06podmanB\b\n" +
	"\x06config\"B\n" +
	...
	"\tRpmConfig\x12'\n" +
	"\x0ftimeout_seconds\x18\x01 \x01(\x03R\x0etimeoutSeconds\"7\n" +
	"\fPodmanConfig\x12'\n" +
	"\x0finclude_stopped\x18\x01 \x01(\bR\x0eincludeStoppedBFB\x06ConfigP\x01Z:github.com/google/osv-scalibr/binary/proto/config_go_protob\x06proto3"
...
var file_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_config_proto_goTypes = []any{
	...
	(*PodmanConfig)(nil),                  // 13: scalibr.PodmanConfig
}
var file_proto_config_proto_depIdxs = []int32{
	...
	13, // 12: scalibr.PluginSpecificConfig.podman:type_name -> scalibr.PodmanConfig
