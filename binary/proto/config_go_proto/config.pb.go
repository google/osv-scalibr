...
type PluginSpecificConfig_PythonRequirementsTransitive struct {
	PythonRequirementsTransitive *PythonRequirementsTransitiveConfig `protobuf:"bytes,65,opt,name=python_requirements_transitive,json=pythonRequirementsTransitive,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x05qcow2\x18@ \x01(\v2\x14.scalibr.QCOW2ConfigH\x00R\x05qcow2\x12s\n" +
	"\x1epython_requirements_transitive\x18A \x01(\v2+.scalibr.PythonRequirementsTransitiveConfigH\x00R\x1cpythonRequirementsTransitiveB\b\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*PythonRequirementsTransitiveConfig)(nil), // 14: scalibr.PythonRequirementsTransitiveConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	14, // 53: scalibr.PluginSpecificConfig.python_requirements_transitive:type_name -> scalibr.PythonRequirementsTransitiveConfig
