...
type PluginSpecificConfig_HcpIdentity struct {
	HcpIdentity *HCPIdentityConfig `protobuf:"bytes,72,opt,name=hcp_identity,json=hcpIdentity,proto3,oneof"`
}

type PluginSpecificConfig_HerokuExpiration struct {
	HerokuExpiration *HerokuExpirationConfig `protobuf:"bytes,73,opt,name=heroku_expiration,json=herokuExpiration,proto3,oneof"`
}

type PluginSpecificConfig_HuggingfaceMeta struct {
	HuggingfaceMeta *HuggingfaceMetaConfig `protobuf:"bytes,74,opt,name=huggingface_meta,json=huggingfaceMeta,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xc6\x1e\n" +
	...
	"\fhcp_identity\x18H \x01(\v2\x1a.scalibr.HCPIdentityConfigH\x00R\vhcpIdentity\x12N\n" +
	"\x11heroku_expiration\x18I \x01(\v2\x1f.scalibr.HerokuExpirationConfigH\x00R\x10herokuExpiration\x12K\n" +
	"\x10huggingface_meta\x18J \x01(\v2\x1e.scalibr.HuggingfaceMetaConfigH\x00R\x0fhuggingfaceMetaB\b\n" +
...
var file_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_proto_config_proto_goTypes = []any{
	...
	(*CodeServerConfig)(nil),                   // 60: scalibr.CodeServerConfig
	(*QCOW2Config)(nil),                        // 61: scalibr.QCOW2Config
}
var file_proto_config_proto_depIdxs = []int32{
	...
	60, // 49: scalibr.PluginSpecificConfig.code_server:type_name -> scalibr.CodeServerConfig
	...
	61, // 52: scalibr.PluginSpecificConfig.qcow2:type_name -> scalibr.QCOW2Config
	...
	38, // 58: scalibr.PluginSpecificConfig.hcp_identity:type_name -> scalibr.HCPIdentityConfig
	37, // 59: scalibr.PluginSpecificConfig.heroku_expiration:type_name -> scalibr.HerokuExpirationConfig
	36, // 60: scalibr.PluginSpecificConfig.huggingface_meta:type_name -> scalibr.HuggingfaceMetaConfig
