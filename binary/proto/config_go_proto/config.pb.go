...
type PluginSpecificConfig_HaskellCabalProjectFreeze struct {
	HaskellCabalProjectFreeze *HaskellCabalProjectFreezeConfig `protobuf:"bytes,37,opt,name=haskell_cabal_project_freeze,json=haskellCabalProjectFreeze,proto3,oneof"`
}
...
type PluginSpecificConfig_HaskellCabal struct {
	HaskellCabal *HaskellCabalConfig `protobuf:"bytes,83,opt,name=haskell_cabal,json=haskellCabal,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xdb\"\n" +
	...
	"\x11haskell_stacklock\x18$ \x01(\v2\x1f.scalibr.HaskellStacklockConfigH\x00R\x10haskellStacklock\x12k\n" +
	"\x1chaskell_cabal_project_freeze\x18% \x01(\v2(.scalibr.HaskellCabalProjectFreezeConfigH\x00R\x19haskellCabalProjectFreeze\x12?\n" +
	...
	"\bruby_gem\x18R \x01(\v2\x16.scalibr.RubyGemConfigH\x00R\arubyGem\x12B\n" +
	"\rhaskell_cabal\x18S \x01(\v2\x1b.scalibr.HaskellCabalConfigH\x00R\fhaskellCabalB\b\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*HaskellCabalProjectFreezeConfig)(nil),    // 53: scalibr.HaskellCabalProjectFreezeConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	53, // 38: scalibr.PluginSpecificConfig.haskell_cabal_project_freeze:type_name -> scalibr.HaskellCabalProjectFreezeConfig
	...
	52, // 67: scalibr.PluginSpecificConfig.haskell_cabal:type_name -> scalibr.HaskellCabalConfig
