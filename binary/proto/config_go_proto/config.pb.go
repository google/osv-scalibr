...
type PluginSpecificConfig_Qcow2 struct {
	Qcow2 *QCOW2Config `protobuf:"bytes,27,opt,name=qcow2,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xf0\v\n" +
	...
	"\tk8s_image\x18\x1a \x01(\v2\x17.scalibr.K8sImageConfigH\x00R\bk8sImage\x12,\n" +
	"\x05qcow2\x18\x1b \x01(\v2\x14.scalibr.QCOW2ConfigH\x00R\x05qcow2B\b\n" +
	"\x06config\"B\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*QCOW2Config)(nil),                   // 28: scalibr.QCOW2Config
}
var file_proto_config_proto_depIdxs = []int32{
	...
	28, // 27: scalibr.PluginSpecificConfig.qcow2:type_name -> scalibr.QCOW2Config
