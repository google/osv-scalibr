...
type PluginSpecificConfig_Buildzigzon struct {
	Buildzigzon *ZigBuildZigZonConfig `protobuf:"bytes,76,opt,name=buildzigzon,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xba\x1f\n" +
	...
	"\x10huggingface_meta\x18K \x01(\v2\x1e.scalibr.HuggingfaceMetaConfigH\x00R\x0fhuggingfaceMeta\x12A\n" +
	"\vbuildzigzon\x18L \x01(\v2\x1d.scalibr.ZigBuildZigZonConfigH\x00R\vbuildzigzonB\b\n" +
	...
	"\x14include_dependencies\x18\x02 \x01(\bR\x13includeDependencies\"r\n" +
	"\x14ZigBuildZigZonConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\x12+\n" +
	"\x11scan_dependencies\x18\x02 \x01(\bR\x10scanDependencies\"P\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*ZigBuildZigZonConfig)(nil),               // 51: scalibr.ZigBuildZigZonConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	60, // 48: scalibr.PluginSpecificConfig.osvlocal:type_name -> scalibr.OSVLocalConfig
	62, // 49: scalibr.PluginSpecificConfig.code_server:type_name -> scalibr.CodeServerConfig
	...
	63, // 52: scalibr.PluginSpecificConfig.qcow2:type_name -> scalibr.QCOW2Config
	...
	61, // 58: scalibr.PluginSpecificConfig.osvdev:type_name -> scalibr.OSVDevConfig
	...
	51, // 62: scalibr.PluginSpecificConfig.buildzigzon:type_name -> scalibr.ZigBuildZigZonConfig
