...
type PluginSpecificConfig_Csproj struct {
	Csproj *CsProjConfig `protobuf:"bytes,58,opt,name=csproj,proto3,oneof"`
}

type PluginSpecificConfig_NugetCpm struct {
	NugetCpm *NugetCPMConfig `protobuf:"bytes,59,opt,name=nuget_cpm,json=nugetCpm,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xa4\x19\n" +
	...
	"\x06csproj\x18: \x01(\v2\x15.scalibr.CsProjConfigH\x00R\x06csproj\x126\n" +
	"\tnuget_cpm\x18; \x01(\v2\x17.scalibr.NugetCPMConfigH\x00R\bnugetCpmB\b\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*CsProjConfig)(nil),                    // 29: scalibr.CsProjConfig
	(*NugetCPMConfig)(nil),                  // 30: scalibr.NugetCPMConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	29, // 49: scalibr.PluginSpecificConfig.csproj:type_name -> scalibr.CsProjConfig
	30, // 50: scalibr.PluginSpecificConfig.nuget_cpm:type_name -> scalibr.NugetCPMConfig
