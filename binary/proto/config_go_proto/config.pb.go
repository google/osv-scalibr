...
func (x *PluginSpecificConfig) GetBuildzigzon() *ZigBuildZigZonConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_Buildzigzon); ok {
			return x.Buildzigzon
		}
	}
	return nil
}
...
type PluginSpecificConfig_Buildzigzon struct {
	Buildzigzon *ZigBuildZigZonConfig `protobuf:"bytes,82,opt,name=buildzigzon,proto3,oneof"`
}
...
type ZigBuildZigZonConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The maximum file size the plugin will process.
	// If set, this overrides the global max_file_size_bytes configuration
	// for this specific plugin.
	MaxFileSizeBytes int64 `protobuf:"varint,1,opt,name=max_file_size_bytes,json=maxFileSizeBytes,proto3" json:"max_file_size_bytes,omitempty"`
	ScanDependencies bool  `protobuf:"varint,2,opt,name=scan_dependencies,json=scanDependencies,proto3" json:"scan_dependencies,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *ZigBuildZigZonConfig) Reset() {
	*x = ZigBuildZigZonConfig{}
	mi := &file_proto_config_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ZigBuildZigZonConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ZigBuildZigZonConfig) ProtoMessage() {}

func (x *ZigBuildZigZonConfig) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[50]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ZigBuildZigZonConfig.ProtoReflect.Descriptor instead.
func (*ZigBuildZigZonConfig) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{50}
}

func (x *ZigBuildZigZonConfig) GetMaxFileSizeBytes() int64 {
	if x != nil {
		return x.MaxFileSizeBytes
	}
	return 0
...
func (x *ZigBuildZigZonConfig) GetScanDependencies() bool {
	if x != nil {
		return x.ScanDependencies
	}
	return false
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xfc!\n" +
	...
	"\x1adotnet_project_assets_json\x18N \x01(\v2&.scalibr.DotnetProjectAssetsJsonConfigH\x00R\x17dotnetProjectAssetsJson\x12A\n" +
	"\vbuildzigzon\x18R \x01(\v2\x1d.scalibr.ZigBuildZigZonConfigH\x00R\vbuildzigzonB\b\n" +
	...
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\"r\n" +
	"\x14ZigBuildZigZonConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\x12+\n" +
	"\x11scan_dependencies\x18\x02 \x01(\bR\x10scanDependencies\"G\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*CargoAuditableConfig)(nil),               // 46: scalibr.CargoAuditableConfig
	(*SwiftPackageResolvedConfig)(nil),         // 47: scalibr.SwiftPackageResolvedConfig
	(*SwiftPodfileLockConfig)(nil),             // 48: scalibr.SwiftPodfileLockConfig
	(*ElixirMixLockConfig)(nil),                // 49: scalibr.ElixirMixLockConfig
	(*ZigBuildZigZonConfig)(nil),               // 50: scalibr.ZigBuildZigZonConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	46, // 33: scalibr.PluginSpecificConfig.cargo_auditable:type_name -> scalibr.CargoAuditableConfig
	47, // 34: scalibr.PluginSpecificConfig.swift_package_resolved:type_name -> scalibr.SwiftPackageResolvedConfig
	48, // 35: scalibr.PluginSpecificConfig.swift_podfile_lock:type_name -> scalibr.SwiftPodfileLockConfig
	49, // 36: scalibr.PluginSpecificConfig.elixir_mix_lock:type_name -> scalibr.ElixirMixLockConfig
	...
	50, // 66: scalibr.PluginSpecificConfig.buildzigzon:type_name -> scalibr.ZigBuildZigZonConfig
