...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xff\x1b\n" +
	...
	"\x05spack\x18E \x01(\v2\x14.scalibr.SpackConfigH\x00R\x05spackB\b\n" +
