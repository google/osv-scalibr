...
type PluginSpecificConfig_Qcow2 struct {
	Qcow2 *QCOW2Config `protobuf:"bytes,58,opt,name=qcow2,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xe9\x18\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*QCOW2Config)(nil),                     // 50: scalibr.QCOW2Config
}
var file_proto_config_proto_depIdxs = []int32{
	...
	50, // 49: scalibr.PluginSpecificConfig.qcow2:type_name -> scalibr.QCOW2Config
