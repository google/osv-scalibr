...
type PluginSpecificConfig_Denojson struct {
	Denojson *DenoJsonConfig `protobuf:"bytes,58,opt,name=denojson,proto3,oneof"`
}

type PluginSpecificConfig_Denotssource struct {
	Denotssource *DenoTSSourceConfig `protobuf:"bytes,59,opt,name=denotssource,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xb5\x19\n" +
	...
	"\bosvlocal\x189 \x01(\v2\x17.scalibr.OSVLocalConfigH\x00R\bosvlocal\x125\n" +
...
var file_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
...
var file_proto_config_proto_depIdxs = []int32{
	...
	5,  // 49: scalibr.PluginSpecificConfig.denojson:type_name -> scalibr.DenoJsonConfig
	6,  // 50: scalibr.PluginSpecificConfig.denotssource:type_name -> scalibr.DenoTSSourceConfig
