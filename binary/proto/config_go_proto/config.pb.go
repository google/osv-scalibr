...
type PluginConfig struct {
	...
	// The user agent to use when running SCALIBR as a CLI binary. If specified,
	// the CLI passes this value to initialize the client factory.
	// When calling SCALIBR as a Go library, this field is ignored; instead, the
	// caller should configure the user agent directly in their ClientFactories
	// implementation.
...
type PluginSpecificConfig struct {
	...
	//	*PluginSpecificConfig_BazelAspect
...
func (x *PluginSpecificConfig) GetBazelAspect() *BazelAspectConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_BazelAspect); ok {
			return x.BazelAspect
		}
	}
	return nil
}
...
func (x *PluginSpecificConfig) GetDotnetProjectAssetsJson() *DotnetProjectAssetsJsonConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_DotnetProjectAssetsJson); ok {
			return x.DotnetProjectAssetsJson
		}
	}
	return nil
}

func (x *PluginSpecificConfig) GetRubyGem() *RubyGemConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_RubyGem); ok {
			return x.RubyGem
		}
	}
	return nil
...
type PluginSpecificConfig_BazelAspect struct {
	BazelAspect *BazelAspectConfig `protobuf:"bytes,81,opt,name=bazel_aspect,json=bazelAspect,proto3,oneof"`
}
...
type PluginSpecificConfig_DotnetProjectAssetsJson struct {
	DotnetProjectAssetsJson *DotnetProjectAssetsJsonConfig `protobuf:"bytes,78,opt,name=dotnet_project_assets_json,json=dotnetProjectAssetsJson,proto3,oneof"`
}

type PluginSpecificConfig_RubyGem struct {
	RubyGem *RubyGemConfig `protobuf:"bytes,82,opt,name=ruby_gem,json=rubyGem,proto3,oneof"`
}
...
func (*PluginSpecificConfig_BazelAspect) isPluginSpecificConfig_Config() {}
...
func (*PluginSpecificConfig_DotnetProjectAssetsJson) isPluginSpecificConfig_Config() {}
...
func (x *BazelAspectConfig) Reset() {
	*x = BazelAspectConfig{}
...
func (x *BazelAspectConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BazelAspectConfig) ProtoMessage() {}

func (x *BazelAspectConfig) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BazelAspectConfig.ProtoReflect.Descriptor instead.
func (*BazelAspectConfig) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{2}
}

func (x *BazelAspectConfig) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
func (x *BazelAspectConfig) GetKeepGoing() bool {
	if x != nil && x.KeepGoing != nil {
		return *x.KeepGoing
	}
	return false
}
...
type ArchiveConfig struct {
	...
	MaxFileSizeBytes int64 `protobuf:"varint,1,opt,name=max_file_size_bytes,json=maxFileSizeBytes,proto3" json:"max_file_size_bytes,omitempty"`
	// Maximum fraction of available free temp storage allowed for extraction
	// (e.g. 0.8 for 80%). If set, must be in the range (0.0, 1.0].
	// If unset or set to invalid value, this value defaults to 0.0, meaning free
	// space checking is disabled.
	// Note: Free space checking is only supported on Linux. This has no effect on
	// non-linux based platforms.
	MaxFreeSpaceUsageRatio float64 `protobuf:"fixed64,2,opt,name=max_free_space_usage_ratio,json=maxFreeSpaceUsageRatio,proto3" json:"max_free_space_usage_ratio,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ArchiveConfig) GetMaxFreeSpaceUsageRatio() float64 {
	if x != nil {
		return x.MaxFreeSpaceUsageRatio
	}
	return 0
}
...
func (x *OVAConfig) GetMaxFreeSpaceUsageRatio() float64 {
	if x != nil {
		return x.MaxFreeSpaceUsageRatio
	}
	return 0
...
type DotnetProjectAssetsJsonConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The maximum file size the plugin will process.
	// If set, this overrides the global max_file_size_bytes configuration
	// for this specific plugin.
...
func (x *DotnetProjectAssetsJsonConfig) Reset() {
	*x = DotnetProjectAssetsJsonConfig{}
	mi := &file_proto_config_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DotnetProjectAssetsJsonConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DotnetProjectAssetsJsonConfig) ProtoMessage() {}

func (x *DotnetProjectAssetsJsonConfig) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[44]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DotnetProjectAssetsJsonConfig.ProtoReflect.Descriptor instead.
func (*DotnetProjectAssetsJsonConfig) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{44}
}

func (x *DotnetProjectAssetsJsonConfig) GetMaxFileSizeBytes() int64 {
	if x != nil {
		return x.MaxFileSizeBytes
	}
	return 0
...
type RubyGemConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The maximum file size the plugin will process.
	// If set, this overrides the global max_file_size_bytes configuration
	// for this specific plugin.
	MaxFileSizeBytes int64 `protobuf:"varint,1,opt,name=max_file_size_bytes,json=maxFileSizeBytes,proto3" json:"max_file_size_bytes,omitempty"`
	// If set, extract additional packages for each declared runtime dependency.
...
func (x *RubyGemConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RubyGemConfig) ProtoMessage() {}

func (x *RubyGemConfig) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[46]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RubyGemConfig.ProtoReflect.Descriptor instead.
func (*RubyGemConfig) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{46}
}

func (x *RubyGemConfig) GetMaxFileSizeBytes() int64 {
	if x != nil {
		return x.MaxFileSizeBytes
	}
	return 0
...
func (x *RubyGemConfig) GetIncludeDependencies() bool {
	if x != nil {
...
type JavascriptPackageJsonConfig struct {
	...
	IncludeDevDependencies bool `protobuf:"varint,4,opt,name=include_dev_dependencies,json=includeDevDependencies,proto3" json:"include_dev_dependencies,omitempty"`
	// Specifies whether to extract optionalDependencies.
	IncludeOptionalDependencies bool `protobuf:"varint,5,opt,name=include_optional_dependencies,json=includeOptionalDependencies,proto3" json:"include_optional_dependencies,omitempty"`
	// Specifies whether to extract peerDependencies.
	IncludePeerDependencies bool `protobuf:"varint,6,opt,name=include_peer_dependencies,json=includePeerDependencies,proto3" json:"include_peer_dependencies,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xee!\n" +
	...
	"\fbazel_aspect\x18Q \x01(\v2\x1a.scalibr.BazelAspectConfigH\x00R\vbazelAspect\x12/\n" +
	...
	"\fdotnet_paket\x18M \x01(\v2\x1a.scalibr.DotnetPaketConfigH\x00R\vdotnetPaket\x125\n" +
	...
	"\bruby_gem\x18R \x01(\v2\x16.scalibr.RubyGemConfigH\x00R\arubyGemB\b\n" +
	...
	"\n" +
	"keep_going\x18\x02 \x01(\bH\x00R\tkeepGoing\x88\x01\x01B\r\n" +
	"\v_keep_going\"B\n" +
	"\x0eGoBinaryConfig\x120\n" +
	"\x14version_from_content\x18\x01 \x01(\bR\x12versionFromContent\"D\n" +
	"\x11GovulncheckConfig\x12/\n" +
	"\x14offline_vuln_db_path\x18\x01 \x01(\tR\x11offlineVulnDbPath\"z\n" +
	"\rArchiveConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\x12:\n" +
	"\x1amax_free_space_usage_ratio\x18\x02 \x01(\x01R\x16maxFreeSpaceUsageRatio\"?\n" +
	"\x0eDenoJsonConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\"\x83\x01\n" +
	"\x12DenoTSSourceConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\x12>\n" +
	"\x1cdeno_json_search_depth_level\x18\x02 \x01(\x05R\x18denoJsonSearchDepthLevel\"v\n" +
	"\tOVAConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\x12:\n" +
	"\x1amax_free_space_usage_ratio\x18\x02 \x01(\x01R\x16maxFreeSpaceUsageRatio\":\n" +
	"\tVDIConfig\x12-\n" +
	...
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\"N\n" +
	"\x1dDotnetProjectAssetsJsonConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\">\n" +
	"\rGemspecConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\"q\n" +
	"\rRubyGemConfig\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\x121\n" +
	"\x14include_dependencies\x18\x02 \x01(\bR\x13includeDependencies\"\x83\x01\n" +
	...
	"\x18include_dev_dependencies\x18\x04 \x01(\bR\x16includeDevDependencies\x12B\n" +
	"\x1dinclude_optional_dependencies\x18\x05 \x01(\bR\x1bincludeOptionalDependencies\x12:\n" +
	"\x19include_peer_dependencies\x18\x06 \x01(\bR\x17includePeerDependenciesJ\x04\b\x03\x10\x04\"P\n" +
...
var file_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 68)
var file_proto_config_proto_goTypes = []any{
	...
	(*BazelAspectConfig)(nil),                  // 2: scalibr.BazelAspectConfig
	...
	(*DenoJsonConfig)(nil),                     // 6: scalibr.DenoJsonConfig
	(*DenoTSSourceConfig)(nil),                 // 7: scalibr.DenoTSSourceConfig
	(*OVAConfig)(nil),                          // 8: scalibr.OVAConfig
	(*VDIConfig)(nil),                          // 9: scalibr.VDIConfig
	(*VMDKConfig)(nil),                         // 10: scalibr.VMDKConfig
	(*ChocolateyConfig)(nil),                   // 11: scalibr.ChocolateyConfig
	(*PerlCPANConfig)(nil),                     // 12: scalibr.PerlCPANConfig
	(*HashiCorpVaultValidatorConfig)(nil),      // 13: scalibr.HashiCorpVaultValidatorConfig
	(*SDPInspectConfig)(nil),                   // 14: scalibr.SDPInspectConfig
	(*POMXMLNetConfig)(nil),                    // 15: scalibr.POMXMLNetConfig
	(*PythonRequirementsTransitiveConfig)(nil), // 16: scalibr.PythonRequirementsTransitiveConfig
	(*DpkgConfig)(nil),                         // 17: scalibr.DpkgConfig
	(*RpmConfig)(nil),                          // 18: scalibr.RpmConfig
	(*ApkConfig)(nil),                          // 19: scalibr.ApkConfig
	(*CosConfig)(nil),                          // 20: scalibr.CosConfig
	(*SnapConfig)(nil),                         // 21: scalibr.SnapConfig
	(*KernelModuleConfig)(nil),                 // 22: scalibr.KernelModuleConfig
	(*VmlinuzConfig)(nil),                      // 23: scalibr.VmlinuzConfig
	(*PacmanConfig)(nil),                       // 24: scalibr.PacmanConfig
	(*PortageConfig)(nil),                      // 25: scalibr.PortageConfig
	(*FlatpakConfig)(nil),                      // 26: scalibr.FlatpakConfig
	(*SpackConfig)(nil),                        // 27: scalibr.SpackConfig
	(*MacAppsConfig)(nil),                      // 28: scalibr.MacAppsConfig
	(*PodmanConfig)(nil),                       // 29: scalibr.PodmanConfig
	(*DockerBaseImageConfig)(nil),              // 30: scalibr.DockerBaseImageConfig
	(*ContainerdConfig)(nil),                   // 31: scalibr.ContainerdConfig
	(*DockerComposeImageConfig)(nil),           // 32: scalibr.DockerComposeImageConfig
	(*K8SImageConfig)(nil),                     // 33: scalibr.K8sImageConfig
	(*DotnetDepsJsonConfig)(nil),               // 34: scalibr.DotnetDepsJsonConfig
	(*CsProjConfig)(nil),                       // 35: scalibr.CsProjConfig
	(*NugetCPMConfig)(nil),                     // 36: scalibr.NugetCPMConfig
	(*HuggingfaceMetaConfig)(nil),              // 37: scalibr.HuggingfaceMetaConfig
	(*HerokuExpirationConfig)(nil),             // 38: scalibr.HerokuExpirationConfig
	(*HCPIdentityConfig)(nil),                  // 39: scalibr.HCPIdentityConfig
	(*DotnetPackagesConfigConfig)(nil),         // 40: scalibr.DotnetPackagesConfigConfig
	(*DotnetPackagesLockJsonConfig)(nil),       // 41: scalibr.DotnetPackagesLockJsonConfig
	(*DotnetPeConfig)(nil),                     // 42: scalibr.DotnetPeConfig
	(*DotnetPaketConfig)(nil),                  // 43: scalibr.DotnetPaketConfig
	(*DotnetProjectAssetsJsonConfig)(nil),      // 44: scalibr.DotnetProjectAssetsJsonConfig
	(*GemspecConfig)(nil),                      // 45: scalibr.GemspecConfig
	(*RubyGemConfig)(nil),                      // 46: scalibr.RubyGemConfig
	(*CargoAuditableConfig)(nil),               // 47: scalibr.CargoAuditableConfig
	(*SwiftPackageResolvedConfig)(nil),         // 48: scalibr.SwiftPackageResolvedConfig
	(*SwiftPodfileLockConfig)(nil),             // 49: scalibr.SwiftPodfileLockConfig
	(*ElixirMixLockConfig)(nil),                // 50: scalibr.ElixirMixLockConfig
	(*HaskellStacklockConfig)(nil),             // 51: scalibr.HaskellStacklockConfig
	(*HaskellCabalConfig)(nil),                 // 52: scalibr.HaskellCabalConfig
	(*JavaArchiveConfig)(nil),                  // 53: scalibr.JavaArchiveConfig
	(*JavascriptPackageJsonConfig)(nil),        // 54: scalibr.JavascriptPackageJsonConfig
	(*JavascriptPackageLockJsonConfig)(nil),    // 55: scalibr.JavascriptPackageLockJsonConfig
	(*PythonRequirementsConfig)(nil),           // 56: scalibr.PythonRequirementsConfig
	(*PythonSetupConfig)(nil),                  // 57: scalibr.PythonSetupConfig
	(*PythonCondametaConfig)(nil),              // 58: scalibr.PythonCondametaConfig
	(*PythonWheelEggConfig)(nil),               // 59: scalibr.PythonWheelEggConfig
	(*GoModConfig)(nil),                        // 60: scalibr.GoModConfig
	(*WordpressPluginsConfig)(nil),             // 61: scalibr.WordpressPluginsConfig
	(*MariadbConfig)(nil),                      // 62: scalibr.MariadbConfig
	(*OSVLocalConfig)(nil),                     // 63: scalibr.OSVLocalConfig
	(*OSVDevConfig)(nil),                       // 64: scalibr.OSVDevConfig
	(*CodeServerConfig)(nil),                   // 65: scalibr.CodeServerConfig
	(*QCOW2Config)(nil),                        // 66: scalibr.QCOW2Config
	(*ContainerdRuntimeConfig)(nil),            // 67: scalibr.ContainerdRuntimeConfig
}
var file_proto_config_proto_depIdxs = []int32{
	...
	8,  // 4: scalibr.PluginSpecificConfig.ova:type_name -> scalibr.OVAConfig
	9,  // 5: scalibr.PluginSpecificConfig.vdi:type_name -> scalibr.VDIConfig
	10, // 6: scalibr.PluginSpecificConfig.vmdk:type_name -> scalibr.VMDKConfig
	13, // 7: scalibr.PluginSpecificConfig.hashicorp_vault_validator:type_name -> scalibr.HashiCorpVaultValidatorConfig
	14, // 8: scalibr.PluginSpecificConfig.sdp_inspect:type_name -> scalibr.SDPInspectConfig
	15, // 9: scalibr.PluginSpecificConfig.pom_xml_net:type_name -> scalibr.POMXMLNetConfig
	11, // 10: scalibr.PluginSpecificConfig.chocolatey:type_name -> scalibr.ChocolateyConfig
	17, // 11: scalibr.PluginSpecificConfig.dpkg:type_name -> scalibr.DpkgConfig
	18, // 12: scalibr.PluginSpecificConfig.rpm:type_name -> scalibr.RpmConfig
	19, // 13: scalibr.PluginSpecificConfig.apk:type_name -> scalibr.ApkConfig
	20, // 14: scalibr.PluginSpecificConfig.cos:type_name -> scalibr.CosConfig
	21, // 15: scalibr.PluginSpecificConfig.snap:type_name -> scalibr.SnapConfig
	22, // 16: scalibr.PluginSpecificConfig.kernel_module:type_name -> scalibr.KernelModuleConfig
	23, // 17: scalibr.PluginSpecificConfig.vmlinuz:type_name -> scalibr.VmlinuzConfig
	2,  // 18: scalibr.PluginSpecificConfig.bazel_aspect:type_name -> scalibr.BazelAspectConfig
	24, // 19: scalibr.PluginSpecificConfig.pacman:type_name -> scalibr.PacmanConfig
	25, // 20: scalibr.PluginSpecificConfig.portage:type_name -> scalibr.PortageConfig
	26, // 21: scalibr.PluginSpecificConfig.flatpak:type_name -> scalibr.FlatpakConfig
	28, // 22: scalibr.PluginSpecificConfig.macapps:type_name -> scalibr.MacAppsConfig
	29, // 23: scalibr.PluginSpecificConfig.podman:type_name -> scalibr.PodmanConfig
	30, // 24: scalibr.PluginSpecificConfig.docker_base_image:type_name -> scalibr.DockerBaseImageConfig
	31, // 25: scalibr.PluginSpecificConfig.containerd:type_name -> scalibr.ContainerdConfig
	32, // 26: scalibr.PluginSpecificConfig.docker_compose_image:type_name -> scalibr.DockerComposeImageConfig
	33, // 27: scalibr.PluginSpecificConfig.k8s_image:type_name -> scalibr.K8sImageConfig
	34, // 28: scalibr.PluginSpecificConfig.dotnet_deps_json:type_name -> scalibr.DotnetDepsJsonConfig
	40, // 29: scalibr.PluginSpecificConfig.dotnet_packages_config:type_name -> scalibr.DotnetPackagesConfigConfig
	41, // 30: scalibr.PluginSpecificConfig.dotnet_packages_lock_json:type_name -> scalibr.DotnetPackagesLockJsonConfig
	42, // 31: scalibr.PluginSpecificConfig.dotnet_pe:type_name -> scalibr.DotnetPeConfig
	45, // 32: scalibr.PluginSpecificConfig.gemspec:type_name -> scalibr.GemspecConfig
	47, // 33: scalibr.PluginSpecificConfig.cargo_auditable:type_name -> scalibr.CargoAuditableConfig
	48, // 34: scalibr.PluginSpecificConfig.swift_package_resolved:type_name -> scalibr.SwiftPackageResolvedConfig
	49, // 35: scalibr.PluginSpecificConfig.swift_podfile_lock:type_name -> scalibr.SwiftPodfileLockConfig
	50, // 36: scalibr.PluginSpecificConfig.elixir_mix_lock:type_name -> scalibr.ElixirMixLockConfig
	51, // 37: scalibr.PluginSpecificConfig.haskell_stacklock:type_name -> scalibr.HaskellStacklockConfig
	52, // 38: scalibr.PluginSpecificConfig.haskell_cabal:type_name -> scalibr.HaskellCabalConfig
	53, // 39: scalibr.PluginSpecificConfig.java_archive:type_name -> scalibr.JavaArchiveConfig
	54, // 40: scalibr.PluginSpecificConfig.javascript_package_json:type_name -> scalibr.JavascriptPackageJsonConfig
	55, // 41: scalibr.PluginSpecificConfig.javascript_package_lock_json:type_name -> scalibr.JavascriptPackageLockJsonConfig
	56, // 42: scalibr.PluginSpecificConfig.python_requirements:type_name -> scalibr.PythonRequirementsConfig
	57, // 43: scalibr.PluginSpecificConfig.python_setup:type_name -> scalibr.PythonSetupConfig
	58, // 44: scalibr.PluginSpecificConfig.python_condameta:type_name -> scalibr.PythonCondametaConfig
	59, // 45: scalibr.PluginSpecificConfig.python_wheel_egg:type_name -> scalibr.PythonWheelEggConfig
	60, // 46: scalibr.PluginSpecificConfig.go_mod:type_name -> scalibr.GoModConfig
	61, // 47: scalibr.PluginSpecificConfig.wordpress_plugins:type_name -> scalibr.WordpressPluginsConfig
	62, // 48: scalibr.PluginSpecificConfig.mariadb:type_name -> scalibr.MariadbConfig
	43, // 49: scalibr.PluginSpecificConfig.dotnet_paket:type_name -> scalibr.DotnetPaketConfig
	63, // 50: scalibr.PluginSpecificConfig.osvlocal:type_name -> scalibr.OSVLocalConfig
	65, // 51: scalibr.PluginSpecificConfig.code_server:type_name -> scalibr.CodeServerConfig
	...
	66, // 54: scalibr.PluginSpecificConfig.qcow2:type_name -> scalibr.QCOW2Config
	...
	64, // 60: scalibr.PluginSpecificConfig.osvdev:type_name -> scalibr.OSVDevConfig
	...
	67, // 64: scalibr.PluginSpecificConfig.containerd_runtime:type_name -> scalibr.ContainerdRuntimeConfig
...
func file_proto_config_proto_init() {
	...
	file_proto_config_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*PluginSpecificConfig_BazelAspect)(nil),
	...
	file_proto_config_proto_msgTypes[53].OneofWrappers = []any{}
	file_proto_config_proto_msgTypes[62].OneofWrappers = []any{}
	type x struct{}
