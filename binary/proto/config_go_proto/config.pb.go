...
type PluginSpecificConfig_Osvlocal struct {
	Osvlocal *OSVLocalConfig `protobuf:"bytes,22,opt,name=osvlocal,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xae\t\n" +
	...
	"\amacapps\x18\x15 \x01(\v2\x16.scalibr.MacAppsConfigH\x00R\amacapps\x125\n" +
	"\bosvlocal\x18\x16 \x01(\v2\x17.scalibr.OSVLocalConfigH\x00R\bosvlocalB\b\n" +
	"\x06config\"B\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*OSVLocalConfig)(nil),                // 23: scalibr.OSVLocalConfig
}
var file_proto_config_proto_depIdxs = []int32{
	...
	23, // 22: scalibr.PluginSpecificConfig.osvlocal:type_name -> scalibr.OSVLocalConfig
