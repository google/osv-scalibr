...
func (x *PluginSpecificConfig) GetSbt() *SBT {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_Sbt); ok {
			return x.Sbt
		}
	}
	return nil
...
type PluginSpecificConfig_Sbt struct {
	Sbt *SBT `protobuf:"bytes,58,opt,name=sbt,proto3,oneof"`
}
...
func (*PluginSpecificConfig_Sbt) isPluginSpecificConfig_Config() {}
...
func (x *SBT) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SBT) ProtoMessage() {}

func (x *SBT) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[49]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SBT.ProtoReflect.Descriptor instead.
func (*SBT) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{49}
}

func (x *SBT) GetMaxFileSizeBytes() int64 {
	if x != nil {
		return x.MaxFileSizeBytes
	}
	return 0
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xdd\x18\n" +
	...
	"\x03sbt\x18: \x01(\v2\f.scalibr.SBTH\x00R\x03sbtB\b\n" +
	...
	"\x0f_follow_include\"4\n" +
	"\x03SBT\x12-\n" +
	"\x13max_file_size_bytes\x18\x01 \x01(\x03R\x10maxFileSizeBytes\"l\n" +
...
var file_proto_config_proto_depIdxs = []int32{
	...
	49, // 49: scalibr.PluginSpecificConfig.sbt:type_name -> scalibr.SBT
