...
type PluginSpecificConfig_Cpan struct {
	Cpan *PerlCPANConfig `protobuf:"bytes,48,opt,name=cpan,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xe4\x18\n" +
	...
	"\x04cpan\x180 \x01(\v2\x17.scalibr.PerlCPANConfigH\x00R\x04cpan\x125\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*PerlCPANConfig)(nil),                  // 9: scalibr.PerlCPANConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	9,  // 48: scalibr.PluginSpecificConfig.cpan:type_name -> scalibr.PerlCPANConfig
	50, // 49: scalibr.PluginSpecificConfig.osvlocal:type_name -> scalibr.OSVLocalConfig
