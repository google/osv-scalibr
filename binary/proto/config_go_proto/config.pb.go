...
type PluginSpecificConfig_DotnetPaket struct {
	DotnetPaket *DotnetPaketConfig `protobuf:"bytes,58,opt,name=dotnet_paket,json=dotnetPaket,proto3,oneof"`
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xfc\x18\n" +
	...
	"\fdotnet_paket\x18: \x01(\v2\x1a.scalibr.DotnetPaketConfigH\x00R\vdotnetPaket\x125\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*DotnetPaketConfig)(nil),               // 32: scalibr.DotnetPaketConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	32, // 48: scalibr.PluginSpecificConfig.dotnet_paket:type_name -> scalibr.DotnetPaketConfig
