...
func TestGetSourceCodePURL(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repoURL: "https://gitlab.com/jrbeverly.labs/uwaterloo?sort=created_asc",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGeneric,
				Namespace: "gitlab.com/jrbeverly.labs",
				Name:      "uwaterloo",
				Version:   "4984568367caaf359b82c452bd28b5e192824d1c",
			},
		},
		{
			name:    "github_url_without_repo_return_nil",
		...
		{
			name:    "github_scp_url",
			repoURL: "git@github.com:square/okhttp.git",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGithub,
				Namespace: "square",
		...
		{
			name:    "sso_url",
			repoURL: "sso://kokoro-internal/tbi-e2e-fe-test",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGeneric,
				Namespace: "kokoro-internal",
				Name:      "tbi-e2e-fe-test",
				Version:   "4984568367caaf359b82c452bd28b5e192824d1c",
			},
		},
		{
			name:    "rpc_url",
			repoURL: "rpc://kokoro-internal/tbi-e2e-fe-test",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGeneric,
				Namespace: "kokoro-internal",
		...
		{
			name:    "bare_url",
			repoURL: "kokoro-internal/tbi-e2e-fe-test",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGeneric,
				Namespace: "kokoro-internal",
		...
		{
			name:    "github_url_with_credentials",
			repoURL: "https://oauth2:ghp_1234567890abcdef@github.com/square/okhttp.git",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGithub,
				Namespace: "square",
		...
		{
			name:    "github_ssh_url_with_git_user",
			repoURL: "ssh://git@github.com/square/okhttp.git",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGithub,
				Namespace: "square",
		...
		{
			name:    "github_url_with_vcs_query_and_fragment",
			repoURL: "https://github.com/square/okhttp.git?vcs=git&branch=main#readme",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGithub,
				Namespace: "square",
		...
		{
			name:    "generic_url_with_credentials_and_git",
			repoURL: "https://token:secret123@gitlab.gnome.org/GNOME/libxml2.git",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGeneric,
				Namespace: "gitlab.gnome.org/GNOME",
				Name:      "libxml2",
				Version:   "4984568367caaf359b82c452bd28b5e192824d1c",
			},
		},
		{
			name:    "sso_url_with_query_and_fragment",
			repoURL: "sso://kokoro-internal/tbi-e2e-fe-test?branch=main#head",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGeneric,
				Namespace: "kokoro-internal",
		...
		{
			name:    "url_with_trailing_slash_and_whitespace",
			repoURL: "   https://github.com/square/okhttp/   ",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGithub,
		...
		{
			name:    "github_url_with_git_suffix_and_trailing_slash",
			repoURL: "https://github.com/square/okhttp.git/",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGithub,
				Namespace: "square",
		...
		{
			name:    "github_golang_with_semantic_version",
		...
		{
			name:    "github_enterprise_as_generic",
			repoURL: "https://github.utexas.edu/department/repo.git",
			commit:  "4984568367caaf359b82c452bd28b5e192824d1c",
			want: &purl.PackageURL{
				Type:      purl.TypeGeneric,
				Namespace: "github.utexas.edu/department",
				Name:      "repo",
				Version:   "4984568367caaf359b82c452bd28b5e192824d1c",
			},
		},
